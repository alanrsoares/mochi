...
// Builtin variant types the ctor annotations reference (Option, Result), plus
// the public lazy-effect shape shared by host binding packages.
const typeDecls = builtinTypeDecls.map((b) => typeDecl(b.name, b.params, b.ctors));
const taskType = "export type Task<A, E> = () => Promise<Result<A, E>>;";
