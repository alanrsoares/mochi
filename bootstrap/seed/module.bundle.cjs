// @bun
import { Err as Err10, None as None17, Ok as Ok12, Some as Some17, _Array_append as _Array_append14, _Array_concat as _Array_concat10, _Array_flatMap as _Array_flatMap4, _Array_get as _Array_get15, _Array_sort as _Array_sort3, _Map_get as _Map_get12, _Map_getOr as _Map_getOr8, _Map_keys as _Map_keys7, _Map_set as _Map_set11, _Option_mapOr, _Option_unwrapOr as _Option_unwrapOr10, _Result_flatMap as _Result_flatMap8, _Set_add as _Set_add8, _Set_fromArray as _Set_fromArray8, _Set_has as _Set_has8, _Str_codeAt as _Str_codeAt7, _Str_get as _Str_get3, _Str_join as _Str_join9, _Str_length as _Str_length5, _Str_split as _Str_split4, _Str_startsWith as _Str_startsWith6, _Str_trim, _curry as _curry19, and as and11, eq as eq16, filter as filter6, length as length14, map as map14, not as not12, or as or10, reduce as reduce5 } from "@mochi/compiler/runtime";
...
var crossModuleTypeImports = _curry19(4, (ts, importer, localTypes, typeOwner) => {
  ...
  return map14((spec) => `import type { ${_Str_join9(", ", _Array_sort3(_Map_getOr8([], spec, byOwner)))} } from "${spec}";`, _Map_keys7(byOwner));
});
...
var externOutputs = (externs) => map14((dp) => ({ path: dp, js: externModuleDts(_Map_getOr8([], dp, externs), noAliases) }), _Map_keys7(externs));
