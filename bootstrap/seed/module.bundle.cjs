// @bun
import { Err as Err11, None as None22, Ok as Ok13, Some as Some22, _Array_append as _Array_append15, _Array_concat as _Array_concat10, _Array_flatMap as _Array_flatMap4, _Array_get as _Array_get18, _Array_sort as _Array_sort3, _Map_get as _Map_get12, _Map_getOr as _Map_getOr8, _Map_has as _Map_has6, _Map_keys as _Map_keys9, _Map_set as _Map_set11, _Option_mapOr, _Option_unwrapOr as _Option_unwrapOr11, _Result_flatMap as _Result_flatMap9, _Result_mapErr as _Result_mapErr2, _Set_add as _Set_add9, _Set_fromArray as _Set_fromArray9, _Set_has as _Set_has8, _Str_codeAt as _Str_codeAt8, _Str_get as _Str_get6, _Str_join as _Str_join9, _Str_length as _Str_length7, _Str_split as _Str_split5, _Str_startsWith as _Str_startsWith8, _Str_trim as _Str_trim2, _curry as _curry23, and as and14, eq as eq19, filter as filter6, length as length16, map as map14, not as not13, or as or12, reduce as reduce5 } from "@mochi/compiler/runtime";
...
var parseRecordDestructure = _curry9(5, (toks, start, pos, tmp, hooks) => {
  ...
  return _Result_flatMap4((p) => _Result_flatMap4(([fields, p1]) => ((closeSp) => _Result_flatMap4((p2) => _Result_flatMap4((p3) => _Result_flatMap4(([value, p4]) => ((whole) => ((patSpan) => ((tmpName) => ((header) => ((access) => Ok6(_tuple5(_Array_prepend2(header, map3(access, fields)), p4, tmp + 1)))((f) => SLet(f.name, f.span, None8, EField(ERef(tmpName, f.span), f.name, false, f.span), false, None8, f.span)))(SLet(tmpName, patSpan, None8, value, false, None8, whole)))(`$d${show2(tmp)}`))(spanning(openSp, closeSp)))(toEnd(start, toks, p4)), parseExpr(toks, p3, hooks)), expectTok(TEq, toks, p2)), expectTok(TRbrace, toks, p1)))(spanOf(tokAt(toks, p1))), listUntil(TRbrace, expectId, toks, p)), expectTok(TLbrace, toks, pos));
});
...
import { Err as Err7, None as None11, Ok as Ok8, Some as Some11, _Array_append as _Array_append8, _Array_contains as _Array_contains2, _Array_flatMap as _Array_flatMap2, _Array_get as _Array_get9, _Array_head as _Array_head3, _Map_get as _Map_get4, _Map_getOr as _Map_getOr2, _Map_has as _Map_has2, _Map_keys as _Map_keys4, _Map_set as _Map_set3, _Option_isNone, _Option_isSome as _Option_isSome2, _Option_orElse, _Option_unwrapOr as _Option_unwrapOr6, _Result_flatMap as _Result_flatMap6, _Set_add, _Set_fromArray, _Set_has, _Str_codeAt as _Str_codeAt5, _Str_join as _Str_join4, _curry as _curry12, _done as _done5, _recur as _recur5, _tuple as _tuple6, and as and8, eq as eq11, filter as filter3, length as length9, map as map6, not as not7, or as or6, show as show5 } from "@mochi/compiler/runtime";
import { match as match11 } from "@onrails/pattern";

import { Err as Err6, Ok as Ok7, Some as Some9, _Array_get as _Array_get7, _Array_prepend as _Array_prepend3, _Map_has, _Map_set as _Map_set2, _Option_unwrapOr as _Option_unwrapOr4, _Result_flatMap as _Result_flatMap5, _Result_map as _Result_map5, _curry as _curry10, _done as _done4, _recur as _recur4, eq as eq9, filter, length as length7, map as map4, not as not5, show as show3 } from "@mochi/compiler/runtime";
...
var keysOfFrom = _curry10(2, (fields, i) => match9(_Array_get7(i, fields)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: f }) => _Array_prepend3(_Option_unwrapOr4(`_${show3(i)}`, f.name), keysOfFrom(fields, i + 1))).exhaustive());
var keysOf = (fields) => keysOfFrom(fields, 0);
var builtinSpan = { start: 0, end: 0 };
var builtinTypeDecls = [{ name: "Option", params: ["a"], ctors: [{ name: "Some", fields: [{ name: Some9("value"), fieldType: TyName("a", builtinSpan) }], span: builtinSpan }, { name: "None", fields: [], span: builtinSpan }] }, { name: "Result", params: ["a", "e"], ctors: [{ name: "Ok", fields: [{ name: Some9("value"), fieldType: TyName("a", builtinSpan) }], span: builtinSpan }, { name: "Err", fields: [{ name: Some9("error"), fieldType: TyName("e", builtinSpan) }], span: builtinSpan }] }];
var declaresType = _curry10(3, (stmts, i, name) => match9(_Array_get7(i, stmts)).with({ _tag: "None" }, () => false).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SType";
}, ({ value: { name: n } }) => eq9(n, name) ? true : declaresType(stmts, i + 1, name)).with({ _tag: "Some" }, () => declaresType(stmts, i + 1, name)).exhaustive());
var builtinDeclsFor = (stmts) => filter((bt) => not5(declaresType(stmts, 0, bt.name)), builtinTypeDecls);
var seedRegCtorsFrom = _curry10(4, (ctors, i, owner, acc) => match9(_Array_get7(i, ctors)).with({ _tag: "None" }, () => acc).with({ _tag: "Some" }, ({ value: c }) => seedRegCtorsFrom(ctors, i + 1, owner, _Map_has(c.name, acc) ? acc : _Map_set2(c.name, { owner, arity: length7(c.fields) }, acc))).exhaustive());
var seedRegDeclsFrom = _curry10(3, (decls, i, reg) => match9(_Array_get7(i, decls)).with({ _tag: "None" }, () => reg).with({ _tag: "Some" }, ({ value: bt }) => seedRegDeclsFrom(decls, i + 1, { ctors: seedRegCtorsFrom(bt.ctors, 0, bt.name, reg.ctors), types: _Map_set2(bt.name, map4((c) => c.name, bt.ctors), reg.types) })).exhaustive());
var ctorErr = _curry10(2, (message, sp) => ({ message, start: sp.start, end: sp.end }));
var ctorsInto = _curry10(5, (ctors, i, owner, sp, acc) => match9(_Array_get7(i, ctors)).with({ _tag: "None" }, () => Ok7(acc)).with({ _tag: "Some" }, ({ value: c }) => _Map_has(c.name, acc) ? Err6(ctorErr(`duplicate constructor '${c.name}'`, sp)) : ctorsInto(ctors, i + 1, owner, sp, _Map_set2(c.name, { owner, arity: length7(c.fields) }, acc))).exhaustive());
var buildLoop = _curry10(3, (stmts, i, reg) => match9(_Array_get7(i, stmts)).with({ _tag: "None" }, () => Ok7(reg)).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SType";
...
var exportedRegLoop = _curry10(3, (stmts, i0, reg0) => {
  let i = i0;
  let reg = reg0;
  while (true) {
    const _step = match9(_Array_get7(i, stmts)).with({ _tag: "None" }, () => _done4(reg)).with((_v) => {
      const _g = _v;
...
var ctorKeysInto = _curry10(3, (ctors, i, m) => match9(_Array_get7(i, ctors)).with({ _tag: "None" }, () => m).with((_v) => _v._tag === "Some", ({ value: { name, fields } }) => ctorKeysInto(ctors, i + 1, _Map_set2(name, keysOf(fields), m))).exhaustive());
var ctorKeysFrom = _curry10(3, (stmts, i, m) => match9(_Array_get7(i, stmts)).with({ _tag: "None" }, () => m).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SType";
}, ({ value: { ctors } }) => ctorKeysFrom(stmts, i + 1, ctorKeysInto(ctors, 0, m))).with({ _tag: "Some" }, () => ctorKeysFrom(stmts, i + 1, m)).exhaustive());
var ctorKeysFromStmts = _curry10(2, (stmts, m) => ctorKeysFrom(stmts, 0, m));
var seedKeyCtorsFrom = _curry10(3, (ctors, i, m) => match9(_Array_get7(i, ctors)).with({ _tag: "None" }, () => m).with((_v) => _v._tag === "Some", ({ value: { name, fields } }) => seedKeyCtorsFrom(ctors, i + 1, _Map_has(name, m) ? m : _Map_set2(name, keysOf(fields), m))).exhaustive());
var seedKeyDeclsFrom = _curry10(3, (decls, i, m) => match9(_Array_get7(i, decls)).with({ _tag: "None" }, () => m).with((_v) => _v._tag === "Some", ({ value: { ctors } }) => seedKeyDeclsFrom(decls, i + 1, seedKeyCtorsFrom(ctors, 0, m))).exhaustive());
var seedBuiltinCtorKeys = _curry10(2, (stmts, m) => seedKeyDeclsFrom(builtinDeclsFor(stmts), 0, m));
var exportedCtorKeysFrom = _curry10(3, (stmts, i, m) => match9(_Array_get7(i, stmts)).with({ _tag: "None" }, () => m).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SType" && _g.value.exported === true;
...
import { None as None10, Some as Some10, _Array_append as _Array_append7, _Array_concat as _Array_concat3, _Array_contains, _Array_drop as _Array_drop2, _Array_flatMap, _Array_get as _Array_get8, _Array_head as _Array_head2, _Array_prepend as _Array_prepend4, _Array_tail as _Array_tail2, _Array_take, _Map_get as _Map_get3, _Map_getOr, _Map_keys as _Map_keys3, _Option_isSome, _Option_unwrapOr as _Option_unwrapOr5, _Str_concat, _Str_endsWith, _Str_join as _Str_join3, _curry as _curry11, and as and7, eq as eq10, filter as filter2, length as length8, map as map5, not as not6, reduce, show as show4 } from "@mochi/compiler/runtime";
import { match as match10 } from "@onrails/pattern";
var MWild = { _tag: "MWild" };
var MCtor = _curry11(2, (name, args) => ({ _tag: "MCtor", name, args }));
...
var MRecord = _curry11(2, (labels, pats) => ({ _tag: "MRecord", labels, pats }));
var MArr = _curry11(2, (elems, rest) => ({ _tag: "MArr", elems, rest }));
...
var USome = _curry11(2, (row, fuel) => ({ _tag: "USome", row, fuel }));
...
var isWildMP = (mp) => match10(mp).with({ _tag: "MWild" }, () => true).otherwise(() => false);
var explodePat = (p) => match10(p).with({ _tag: "PAs" }, ({ pat }) => explodePat(pat)).with({ _tag: "POr" }, ({ alts }) => _Array_flatMap(explodePat, alts)).otherwise(() => [p]);
var toMP = (p) => match10(p).with({ _tag: "PAs" }, ({ pat }) => toMP(pat)).with({ _tag: "PWild" }, () => MWild).with({ _tag: "PUnit" }, () => MWild).with({ _tag: "PBind" }, () => MWild).with({ _tag: "PLit" }, ({ value: v }) => MNum(v)).with({ _tag: "PBool" }, ({ value: v }) => MBool(v)).with({ _tag: "PStr" }, ({ value: v }) => MStr(v)).with({ _tag: "PTuple" }, ({ elems }) => MTuple(map5(toMP, elems))).with({ _tag: "PCtor" }, ({ ctor: name, args }) => MCtor(name, map5(toMP, args))).with({ _tag: "PRecord" }, ({ fields }) => MRecord(map5((f) => f.label, fields), map5((f) => toMP(f.pat), fields))).with({ _tag: "PArr" }, ({ elems, rest }) => MArr(map5(toMP, elems), _Option_isSome(rest))).with({ _tag: "PList" }, () => MOpaque).with({ _tag: "POr" }, () => MOpaque).exhaustive();
var headOf = (mp) => match10(mp).with({ _tag: "MWild" }, () => None10).with({ _tag: "MOpaque" }, () => None10).with({ _tag: "MCtor" }, ({ name: n }) => Some10(HCtor(n))).with({ _tag: "MBool" }, ({ value: v }) => Some10(HBool(v))).with({ _tag: "MNum" }, ({ value: v }) => Some10(HNum(v))).with({ _tag: "MStr" }, ({ value: v }) => Some10(HStr(v))).with({ _tag: "MTuple" }, ({ elems }) => Some10(HTuple(length8(elems)))).with({ _tag: "MRecord" }, () => Some10(HRecord)).with({ _tag: "MArr" }, ({ elems }) => Some10(HArr(length8(elems)))).exhaustive();
var colOf = (m) => _Array_flatMap((row) => match10(_Array_head2(row)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: hd }) => [hd]).exhaustive(), m);
var headsOf = (col) => _Array_flatMap((mp) => match10(headOf(mp)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: h }) => [h]).exhaustive(), col);
var addLabel = _curry11(2, (acc, l) => _Array_contains(l, acc) ? acc : _Array_append7(l, acc));
var labelsOfMP = _curry11(2, (acc, mp) => match10(mp).with({ _tag: "MRecord" }, ({ labels: ls }) => reduce(addLabel, acc, ls)).otherwise(() => acc));
var recordLabelsOf = (col) => reduce(labelsOfMP, [], col);
var indexOfLabel = _curry11(3, (l, labels, i) => match10(_Array_get8(i, labels)).with({ _tag: "None" }, () => 0 - 1).with({ _tag: "Some" }, ({ value: x }) => eq10(x, l) ? i : indexOfLabel(l, labels, i + 1)).exhaustive());
var fieldOf = _curry11(3, (l, labels, pats) => {
  const i = indexOfLabel(l, labels, 0);
  return i < 0 ? MWild : _Option_unwrapOr5(MWild, _Array_get8(i, pats));
});
var arrShapeStep = _curry11(2, (acc, mp) => match10(mp).with({ _tag: "MArr" }, ({ elems, rest }) => ((n) => rest ? { fixed: acc.fixed, restFrom: match10(acc.restFrom).with({ _tag: "None" }, () => Some10(n)).with({ _tag: "Some" }, ({ value: m }) => Some10(m < n ? m : n)).exhaustive() } : { fixed: _Array_contains(n, acc.fixed) ? acc.fixed : _Array_append7(n, acc.fixed), restFrom: acc.restFrom })(length8(elems))).otherwise(() => acc));
var arrShapeOf = (col) => reduce(arrShapeStep, { fixed: [], restFrom: None10 }, col);
var rangeCovered = _curry11(3, (shape, i, n) => i >= n ? true : and7(_Array_contains(i, shape.fixed), rangeCovered(shape, i + 1, n)));
var arrComplete = (shape) => match10(shape.restFrom).with({ _tag: "None" }, () => false).with({ _tag: "Some" }, ({ value: r }) => rangeCovered(shape, 0, r)).exhaustive();
var arrMissingLen = _curry11(2, (shape, n) => and7(not6(_Array_contains(n, shape.fixed)), match10(shape.restFrom).with({ _tag: "None" }, () => true).with({ _tag: "Some" }, ({ value: r }) => n < r).exhaustive()) ? n : arrMissingLen(shape, n + 1));
var rangeArr = _curry11(2, (i, top) => i > top ? [] : _Array_prepend4(i, rangeArr(i + 1, top)));
var arrLengths = (shape) => {
  const top = reduce(_curry11(2, (a, x) => x > a ? x : a), _Option_unwrapOr5(0, shape.restFrom), shape.fixed);
  return rangeArr(0, top);
};
var specializeRow = _curry11(3, (h, mp, labels) => match10(h).with({ _tag: "HCtor" }, ({ name }) => match10(mp).with({ _tag: "MCtor" }, ({ name: n, args }) => eq10(n, name) ? Some10(args) : None10).otherwise(() => None10)).with({ _tag: "HBool" }, ({ value: v }) => match10(mp).with({ _tag: "MBool" }, ({ value: b }) => eq10(b, v) ? Some10([]) : None10).otherwise(() => None10)).with({ _tag: "HNum" }, ({ value: v }) => match10(mp).with({ _tag: "MNum" }, ({ value: x }) => eq10(x, v) ? Some10([]) : None10).otherwise(() => None10)).with({ _tag: "HStr" }, ({ value: v }) => match10(mp).with({ _tag: "MStr" }, ({ value: x }) => eq10(x, v) ? Some10([]) : None10).otherwise(() => None10)).with({ _tag: "HTuple" }, () => match10(mp).with({ _tag: "MTuple" }, ({ elems }) => Some10(elems)).otherwise(() => None10)).with({ _tag: "HRecord" }, () => match10(mp).with({ _tag: "MRecord" }, ({ labels: ls, pats: ps }) => Some10(map5((l) => fieldOf(l, ls, ps), labels))).otherwise(() => None10)).with({ _tag: "HArr" }, ({ len }) => match10(mp).with({ _tag: "MArr" }, ({ elems, rest }) => ((k) => rest ? k <= len ? Some10(_Array_concat3(elems, mWilds(len - k))) : None10 : eq10(k, len) ? Some10(elems) : None10)(length8(elems))).otherwise(() => None10)).exhaustive());
var specializeOne = _curry11(4, (h, arity, labels, row) => match10(_Array_head2(row)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: hd }) => ((rest) => isWildMP(hd) ? [_Array_concat3(mWilds(arity), rest)] : match10(specializeRow(h, hd, labels)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: sub }) => [_Array_concat3(sub, rest)]).exhaustive())(_Array_tail2(row))).exhaustive());
var specializeM = _curry11(4, (m, h, arity, labels) => _Array_flatMap((row) => specializeOne(h, arity, labels, row), m));
var defaultM = (m) => _Array_flatMap((row) => match10(_Array_head2(row)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: hd }) => isWildMP(hd) ? [_Array_tail2(row)] : []).exhaustive(), m);
var rebuild = _curry11(3, (h, args, labels) => match10(h).with({ _tag: "HCtor" }, ({ name }) => MCtor(name, args)).with({ _tag: "HTuple" }, () => MTuple(args)).with({ _tag: "HRecord" }, () => MRecord(labels, args)).with({ _tag: "HArr" }, () => MArr(args, false)).with({ _tag: "HBool" }, ({ value: v }) => MBool(v)).with({ _tag: "HNum" }, ({ value: v }) => MNum(v)).with({ _tag: "HStr" }, ({ value: v }) => MStr(v)).exhaustive());
var takenNums = (heads) => _Array_flatMap((h) => match10(h).with({ _tag: "HNum" }, ({ value: v }) => [v]).otherwise(() => []), heads);
var freshNum = _curry11(2, (taken, i) => _Array_contains(i, taken) ? freshNum(taken, i + 1) : i);
var takenStrs = (heads) => _Array_flatMap((h) => match10(h).with({ _tag: "HStr" }, ({ value: v }) => [v]).otherwise(() => []), heads);
var starsOf = (n) => n <= 0 ? "" : _Str_concat("*", starsOf(n - 1));
var freshStr = _curry11(2, (taken, i) => {
  const s = starsOf(i);
  return _Array_contains(s, taken) ? freshStr(taken, i + 1) : s;
});
var ctorNames = (heads) => _Array_flatMap((h) => match10(h).with({ _tag: "HCtor" }, ({ name: n }) => [n]).otherwise(() => []), heads);
var boolVals = (heads) => _Array_flatMap((h) => match10(h).with({ _tag: "HBool" }, ({ value: v }) => [v]).otherwise(() => []), heads);
var ctorInfoSuffixed = _curry11(3, (keys, reg, n) => match10(keys).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => None10).with((_v) => {
  const _g = _v;
...
var ctorInfoOf = _curry11(2, (reg, n) => match10(_Map_get3(n, reg.ctors)).with({ _tag: "Some" }, ({ value: info }) => Some10(info)).with({ _tag: "None" }, () => ctorInfoSuffixed(_Map_keys3(reg.ctors), reg, n)).exhaustive());
var arityOfCtor = _curry11(2, (reg, n) => match10(ctorInfoOf(reg, n)).with({ _tag: "None" }, () => 0).with({ _tag: "Some" }, ({ value: info }) => info.arity).exhaustive());
var ownerOfCtor = _curry11(2, (reg, n) => match10(ctorInfoOf(reg, n)).with({ _tag: "None" }, () => None10).with({ _tag: "Some" }, ({ value: info }) => Some10(info.owner)).exhaustive());
var allNamesIn = _curry11(2, (all, names) => reduce(_curry11(2, (acc, n) => and7(acc, _Array_contains(n, names))), true, all));
var useful = _curry11(4, (m, width, reg, fuel) => fuel <= 0 ? UFuel : eq10(width, 0) ? eq10(length8(m), 0) ? USome([], fuel - 1) : UNone(fuel - 1) : eq10(length8(m), 0) ? USome(mWilds(width), fuel - 1) : usefulSplit(m, width, reg, fuel - 1));
var usefulSplit = _curry11(4, (m, width, reg, fuel) => {
  const col = colOf(m);
  const heads = headsOf(col);
  return match10(_Array_head2(heads)).with({ _tag: "None" }, () => prependWitness(MWild, useful(defaultM(m), width - 1, reg, fuel))).with({ _tag: "Some" }, ({ value: h0 }) => usefulHead(m, col, heads, h0, width, reg, fuel)).exhaustive();
});
var prependWitness = _curry11(2, (mp, r) => match10(r).with({ _tag: "UFuel" }, () => UFuel).with({ _tag: "UNone" }, ({ fuel: f }) => UNone(f)).with({ _tag: "USome" }, ({ row, fuel: f }) => USome(_Array_prepend4(mp, row), f)).exhaustive());
var tryHeads = _curry11(8, (m, heads, arities, labels, width, reg, fuel, i) => match10(_Array_get8(i, heads)).with({ _tag: "None" }, () => UNone(fuel)).with({ _tag: "Some" }, ({ value: h }) => ((arity) => match10(useful(specializeM(m, h, arity, labels), arity + width - 1, reg, fuel)).with({ _tag: "UFuel" }, () => UFuel).with({ _tag: "UNone" }, ({ fuel: f2 }) => tryHeads(m, heads, arities, labels, width, reg, f2, i + 1)).with({ _tag: "USome" }, ({ row, fuel: f2 }) => USome(_Array_prepend4(rebuild(h, _Array_take(arity, row), labels), _Array_drop2(arity, row)), f2)).exhaustive())(_Option_unwrapOr5(0, _Array_get8(i, arities)))).exhaustive());
var usefulHead = _curry11(7, (m, col, heads, h0, width, reg, fuel) => match10(h0).with({ _tag: "HTuple" }, ({ arity }) => tryHeads(m, [HTuple(arity)], [arity], [], width, reg, fuel, 0)).with({ _tag: "HRecord" }, () => ((labels) => tryHeads(m, [HRecord], [length8(labels)], labels, width, reg, fuel, 0))(recordLabelsOf(col))).with({ _tag: "HCtor" }, () => usefulCtor(m, heads, width, reg, fuel)).with({ _tag: "HBool" }, () => usefulBool(m, heads, width, reg, fuel)).with({ _tag: "HArr" }, () => usefulArr(m, col, width, reg, fuel)).with({ _tag: "HNum" }, () => prependWitness(MNum(freshNum(takenNums(heads), 0)), useful(defaultM(m), width - 1, reg, fuel))).with({ _tag: "HStr" }, () => prependWitness(MStr(freshStr(takenStrs(heads), 0)), useful(defaultM(m), width - 1, reg, fuel))).exhaustive());
var usefulCtor = _curry11(5, (m, heads, width, reg, fuel) => {
  const names = ctorNames(heads);
  const ownerOpt = match10(_Array_head2(names)).with({ _tag: "None" }, () => None10).with({ _tag: "Some" }, ({ value: n }) => ownerOfCtor(reg, n)).exhaustive();
  const all = match10(ownerOpt).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: o }) => _Map_getOr([], o, reg.types)).exhaustive();
  return and7(length8(all) > 0, allNamesIn(all, names)) ? tryHeads(m, map5((n) => HCtor(n), all), map5((n) => arityOfCtor(reg, n), all), [], width, reg, fuel, 0) : prependWitness(match10(_Array_head2(filter2((n) => not6(_Array_contains(n, names)), all))).with({ _tag: "None" }, () => MWild).with({ _tag: "Some" }, ({ value: n }) => MCtor(n, mWilds(arityOfCtor(reg, n)))).exhaustive(), useful(defaultM(m), width - 1, reg, fuel));
});
var usefulBool = _curry11(5, (m, heads, width, reg, fuel) => {
  const vs = boolVals(heads);
  const hasTrue = _Array_contains(true, vs);
  return and7(hasTrue, _Array_contains(false, vs)) ? tryHeads(m, [HBool(true), HBool(false)], [0, 0], [], width, reg, fuel, 0) : prependWitness(MBool(not6(hasTrue)), useful(defaultM(m), width - 1, reg, fuel));
});
var usefulArr = _curry11(5, (m, col, width, reg, fuel) => {
...
var showFields = _curry11(3, (labels, pats, i) => match10(_Array_get8(i, labels)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: l }) => _Array_prepend4(`${l}: ${showWitness(_Option_unwrapOr5(MWild, _Array_get8(i, pats)))}`, showFields(labels, pats, i + 1))).exhaustive());
var showWitness = (mp) => match10(mp).with({ _tag: "MWild" }, () => "_").with({ _tag: "MOpaque" }, () => "_").with({ _tag: "MBool" }, ({ value: v }) => show4(v)).with({ _tag: "MNum" }, ({ value: v }) => show4(v)).with({ _tag: "MStr" }, ({ value: v }) => show4(v)).with({ _tag: "MCtor" }, ({ name: n, args }) => eq10(length8(args), 0) ? n : `${n}(${_Str_join3(", ", map5(showWitness, args))})`).with({ _tag: "MTuple" }, ({ elems }) => `(${_Str_join3(", ", map5(showWitness, elems))})`).with({ _tag: "MRecord" }, ({ labels, pats }) => `{ ${_Str_join3(", ", showFields(labels, pats, 0))} }`).with({ _tag: "MArr" }, ({ elems, rest }) => `[${_Str_join3(", ", _Array_concat3(map5(showWitness, elems), rest ? ["..."] : []))}]`).exhaustive();
var isWideWitnessM = (mp) => match10(mp).with({ _tag: "MWild" }, () => true).with({ _tag: "MCtor" }, ({ args }) => reduce(_curry11(2, (acc, a) => and7(acc, isWildMP(a))), true, args)).otherwise(() => false);
var checkExhaustiveM = _curry11(2, (patterns, reg) => {
  const rows = _Array_flatMap((p) => map5((alt) => [toMP(alt)], explodePat(p)), patterns);
  return match10(useful(rows, 1, reg, 20000)).with({ _tag: "UFuel" }, () => ExFuel).with({ _tag: "UNone" }, () => ExOk).with({ _tag: "USome" }, ({ row }) => ExWitness(_Option_unwrapOr5(MWild, _Array_head2(row)))).exhaustive();
});

var checkErr = _curry12(2, (message, sp) => ({ message, start: sp.start, end: sp.end }));
var firstSomeFrom = _curry12(3, (f, xs, i0) => {
  let i = i0;
  while (true) {
    const _step = match11(_Array_get9(i, xs)).with({ _tag: "None" }, () => _done5(None11)).with({ _tag: "Some" }, ({ value: x }) => match11(f(x)).with({ _tag: "Some" }, ({ value: e }) => _done5(Some11(e))).with({ _tag: "None" }, () => _recur5(i + 1)).exhaustive()).exhaustive();
    if (_step._tag === "recur") {
      i = _step.args[0];
      continue;
    }
...
var firstSome = _curry12(2, (f, xs) => firstSomeFrom(f, xs, 0));
var allOfFrom = _curry12(3, (f, xs, i0) => {
  let i = i0;
  while (true) {
    const _step = match11(_Array_get9(i, xs)).with({ _tag: "None" }, () => _done5(true)).with({ _tag: "Some" }, ({ value: x }) => f(x) ? _recur5(i + 1) : _done5(false)).exhaustive();
    if (_step._tag === "recur") {
      i = _step.args[0];
      continue;
    }
...
var allOf = _curry12(2, (f, xs) => allOfFrom(f, xs, 0));
var someOfFrom2 = _curry12(3, (f, xs, i0) => {
  let i = i0;
  while (true) {
    const _step = match11(_Array_get9(i, xs)).with({ _tag: "None" }, () => _done5(false)).with({ _tag: "Some" }, ({ value: x }) => f(x) ? _done5(true) : _recur5(i + 1)).exhaustive();
    if (_step._tag === "recur") {
      i = _step.args[0];
      continue;
    }
...
var someOf2 = _curry12(2, (f, xs) => someOfFrom2(f, xs, 0));
var exprSpan2 = (e) => match11(e).with({ _tag: "ENum" }, ({ span: sp }) => sp).with({ _tag: "EUnit" }, ({ span: sp }) => sp).with({ _tag: "EBool" }, ({ span: sp }) => sp).with({ _tag: "EStr" }, ({ span: sp }) => sp).with({ _tag: "ERef" }, ({ span: sp }) => sp).with({ _tag: "ECall" }, ({ span: sp }) => sp).with({ _tag: "ELambda" }, ({ span: sp }) => sp).with({ _tag: "ELetIn" }, ({ span: sp }) => sp).with({ _tag: "ELetBind" }, ({ span: sp }) => sp).with({ _tag: "EPipe" }, ({ span: sp }) => sp).with({ _tag: "EDo" }, ({ span: sp }) => sp).with({ _tag: "ETernary" }, ({ span: sp }) => sp).with({ _tag: "EMatch" }, ({ span: sp }) => sp).with({ _tag: "ELoop" }, ({ span: sp }) => sp).with({ _tag: "ERecur" }, ({ span: sp }) => sp).with({ _tag: "ERecord" }, ({ span: sp }) => sp).with({ _tag: "EField" }, ({ span: sp }) => sp).with({ _tag: "ETuple" }, ({ span: sp }) => sp).with({ _tag: "EArr" }, ({ span: sp }) => sp).with({ _tag: "EList" }, ({ span: sp }) => sp).with({ _tag: "ESet" }, ({ span: sp }) => sp).with({ _tag: "EMap" }, ({ span: sp }) => sp).with({ _tag: "EInterp" }, ({ span: sp }) => sp).exhaustive();
var patSpan2 = (p) => match11(p).with({ _tag: "PWild" }, ({ span: sp }) => sp).with({ _tag: "PUnit" }, ({ span: sp }) => sp).with({ _tag: "PBind" }, ({ span: sp }) => sp).with({ _tag: "PAs" }, ({ span: sp }) => sp).with({ _tag: "PLit" }, ({ span: sp }) => sp).with({ _tag: "PBool" }, ({ span: sp }) => sp).with({ _tag: "PStr" }, ({ span: sp }) => sp).with({ _tag: "PTuple" }, ({ span: sp }) => sp).with({ _tag: "PRecord" }, ({ span: sp }) => sp).with({ _tag: "PCtor" }, ({ span: sp }) => sp).with({ _tag: "PArr" }, ({ span: sp }) => sp).with({ _tag: "PList" }, ({ span: sp }) => sp).with({ _tag: "POr" }, ({ span: sp }) => sp).exhaustive();
var isCatchAll = (p) => match11(p).with({ _tag: "PWild" }, () => true).with({ _tag: "PUnit" }, () => true).with({ _tag: "PBind" }, () => true).with({ _tag: "PAs" }, ({ pat }) => isCatchAll(pat)).with({ _tag: "PRecord" }, ({ fields }) => allOf((f) => isCatchAll(f.pat), fields)).with({ _tag: "PTuple" }, ({ elems }) => allOf(isCatchAll, elems)).with({ _tag: "PArr" }, ({ elems, rest }) => and8(eq11(length9(elems), 0), _Option_isSome2(rest))).with({ _tag: "PList" }, ({ elems, rest }) => and8(eq11(length9(elems), 0), _Option_isSome2(rest))).otherwise(() => false);
var isPList = (p) => match11(p).with({ _tag: "PList" }, () => true).otherwise(() => false);
var isPCtor = (p) => match11(p).with({ _tag: "PCtor" }, () => true).otherwise(() => false);
var ctorNameOf = (p) => match11(p).with({ _tag: "PCtor" }, ({ ctor: name }) => name).otherwise(() => "");
var patCtorKey = _curry12(2, (ctor, ns) => match11(ns).with({ _tag: "Some" }, ({ value: alias }) => `${alias}.${ctor}`).with({ _tag: "None" }, () => ctor).exhaustive());
var seqElemsRest = (p) => match11(p).with({ _tag: "PArr" }, ({ elems, rest }) => Some11(_tuple6(elems, rest))).with({ _tag: "PList" }, ({ elems, rest }) => Some11(_tuple6(elems, rest))).otherwise(() => None11);
var checkPattern = _curry12(3, (p, reg, top) => match11(p).with({ _tag: "PAs" }, ({ pat }) => checkPattern(pat, reg, top)).with({ _tag: "PCtor" }, ({ ctor, args, ns, span: sp }) => ((key) => match11(_Map_get4(key, reg.ctors)).with({ _tag: "None" }, () => Some11(checkErr(`unknown constructor '${key}'`, sp))).with({ _tag: "Some" }, ({ value: info }) => eq11(length9(args), info.arity) ? firstSome((a) => checkPattern(a, reg, false), args) : Some11(checkErr(`constructor '${ctor}' expects ${show5(info.arity)} arg(s), got ${show5(length9(args))}`, sp))).exhaustive())(patCtorKey(ctor, ns))).with({ _tag: "PRecord" }, ({ fields }) => firstSome((f) => checkPattern(f.pat, reg, false), fields)).with({ _tag: "PTuple" }, ({ elems }) => firstSome((el) => checkPattern(el, reg, false), elems)).with({ _tag: "PArr" }, ({ elems, rest }) => _Option_orElse(match11(rest).with({ _tag: "Some" }, ({ value: r }) => checkPattern(r, reg, false)).with({ _tag: "None" }, () => None11).exhaustive(), firstSome((el) => checkPattern(el, reg, false), elems))).with({ _tag: "PList" }, ({ elems, rest, span: sp }) => top ? _Option_orElse(match11(rest).with({ _tag: "Some" }, ({ value: r }) => checkPattern(r, reg, false)).with({ _tag: "None" }, () => None11).exhaustive(), firstSome((el) => checkPattern(el, reg, false), elems)) : Some11(checkErr("lazy-List pattern cannot nest inside another pattern (matching pulls from the sequence)", sp))).with({ _tag: "POr" }, ({ alts, span: sp }) => checkOrPattern(alts, sp, reg)).otherwise(() => None11));
var binderPathsArgs = _curry12(4, (args, i, at, acc) => match11(_Array_get9(i, args)).with({ _tag: "None" }, () => Ok8(acc)).with({ _tag: "Some" }, ({ value: a }) => _Result_flatMap6((acc2) => binderPathsArgs(args, i + 1, at, acc2), binderPaths(a, `${at}.a${show5(i)}`, acc))).exhaustive());
var binderPathsFields = _curry12(4, (fields, i, at, acc) => match11(_Array_get9(i, fields)).with({ _tag: "None" }, () => Ok8(acc)).with({ _tag: "Some" }, ({ value: f }) => _Result_flatMap6((acc2) => binderPathsFields(fields, i + 1, at, acc2), binderPaths(f.pat, `${at}.${f.label}`, acc))).exhaustive());
var binderPathsElems = _curry12(4, (elems, i, at, acc) => match11(_Array_get9(i, elems)).with({ _tag: "None" }, () => Ok8(acc)).with({ _tag: "Some" }, ({ value: e }) => _Result_flatMap6((acc2) => binderPathsElems(elems, i + 1, at, acc2), binderPaths(e, `${at}.t${show5(i)}`, acc))).exhaustive());
var binderPaths = _curry12(3, (p, at, acc) => match11(p).with({ _tag: "PAs" }, ({ pat, name, nameSpan: nameSp }) => _Result_flatMap6((acc1) => _Map_has2(name, acc1) ? Err7(checkErr(`pattern binds '${name}' more than once`, nameSp)) : Ok8(_Map_set3(name, at, acc1)), binderPaths(pat, at, acc))).with({ _tag: "PBind" }, ({ name, span: sp }) => _Map_has2(name, acc) ? Err7(checkErr(`pattern binds '${name}' more than once`, sp)) : Ok8(_Map_set3(name, at, acc))).with({ _tag: "PCtor" }, ({ args }) => binderPathsArgs(args, 0, at, acc)).with({ _tag: "PRecord" }, ({ fields }) => binderPathsFields(fields, 0, at, acc)).with({ _tag: "PTuple" }, ({ elems }) => binderPathsElems(elems, 0, at, acc)).otherwise(() => Ok8(acc)));
var altMapsFrom = _curry12(4, (alts, i, reg, acc) => match11(_Array_get9(i, alts)).with({ _tag: "None" }, () => Ok8(acc)).with({ _tag: "Some" }, ({ value: alt }) => isCatchAll(alt) ? Err7(checkErr("an or-pattern alternative can't be a catch-all (`_` or a bare binding)", patSpan2(alt))) : _Option_isSome2(seqElemsRest(alt)) ? Err7(checkErr("array/list patterns can't appear as an or-pattern alternative", patSpan2(alt))) : match11(checkPattern(alt, reg, false)).with({ _tag: "Some" }, ({ value: e }) => Err7(e)).with({ _tag: "None" }, () => _Result_flatMap6((m) => altMapsFrom(alts, i + 1, reg, _Array_append8(m, acc)), binderPaths(alt, "", new Map))).exhaustive()).exhaustive());
var missingNameErr = _curry12(2, (name, sp) => checkErr(`or-pattern alternatives must bind the same names ('${name}' is missing in an alternative)`, sp));
var consistentBindsFrom = _curry12(4, (maps, i, ref, sp) => match11(_Array_get9(i, maps)).with({ _tag: "None" }, () => None11).with({ _tag: "Some" }, ({ value: m }) => _Option_orElse(consistentBindsFrom(maps, i + 1, ref, sp), _Option_orElse(firstSome((name) => _Map_has2(name, ref) ? eq11(_Map_getOr2("", name, ref), _Map_getOr2("", name, m)) ? None11 : Some11(checkErr(`or-pattern binds '${name}' at a differing position across alternatives`, sp)) : Some11(missingNameErr(name, sp)), _Map_keys4(m)), firstSome((name) => _Map_has2(name, m) ? None11 : Some11(missingNameErr(name, sp)), _Map_keys4(ref))))).exhaustive());
var checkOrPattern = _curry12(3, (alts, sp, reg) => match11(altMapsFrom(alts, 0, reg, [])).with({ _tag: "Err" }, ({ error: e }) => Some11(e)).with({ _tag: "Ok" }, ({ value: maps }) => match11(_Array_head3(maps)).with({ _tag: "None" }, () => None11).with({ _tag: "Some" }, ({ value: ref }) => consistentBindsFrom(maps, 1, ref, sp)).exhaustive()).exhaustive());
var armUnguardedCatchAll = (a) => and8(isCatchAll(a.pattern), _Option_isNone(a.guard));
var guardErrs = _curry12(2, (arms, listSwitch) => firstSome((a) => match11(a.guard).with({ _tag: "None" }, () => None11).with({ _tag: "Some" }, ({ value: g }) => or6(isPList(a.pattern), listSwitch) ? Some11(checkErr("`when` guards are unsupported in a lazy-List switch (matching pulls from the sequence)", exprSpan2(g))) : None11).exhaustive(), arms));
var firstCatchIdx = _curry12(2, (arms, i0) => {
  let i = i0;
  while (true) {
    const _step = match11(_Array_get9(i, arms)).with({ _tag: "None" }, () => _done5(None11)).with({ _tag: "Some" }, ({ value: a }) => armUnguardedCatchAll(a) ? _done5(Some11(i)) : _recur5(i + 1)).exhaustive();
    if (_step._tag === "recur") {
      i = _step.args[0];
      continue;
    }
...
var unreachableAfterCatch = (arms) => match11(firstCatchIdx(arms, 0)).with({ _tag: "None" }, () => None11).with({ _tag: "Some" }, ({ value: i }) => match11(_Array_get9(i + 1, arms)).with({ _tag: "None" }, () => None11).with({ _tag: "Some" }, ({ value: a }) => Some11(checkErr("unreachable arm: a catch-all arm above it matches first", patSpan2(a.pattern)))).exhaustive()).exhaustive();
var SeqNotSeq = { _tag: "SeqNotSeq" };
var SeqTotal = { _tag: "SeqTotal" };
var SeqFail = (e) => ({ _tag: "SeqFail", e });
var checkSeqExhaustive = _curry12(2, (arms, mSpan) => {
  const seqs = map6((a) => a.pattern, filter3((a) => and8(_Option_isNone(a.guard), _Option_isSome2(seqElemsRest(a.pattern))), arms));
  return eq11(length9(seqs), 0) ? SeqNotSeq : ((hasEmpty) => ((hasCons) => and8(hasEmpty, hasCons) ? SeqTotal : SeqFail(checkErr("non-exhaustive list switch: cover `[]` and `[x, ...xs]` (or add `_`)", mSpan)))(someOf2((p) => match11(seqElemsRest(p)).with((_v) => {
    const _g = _v;
    return _g._tag === "Some";
  }, ({ value: [elems, rest] }) => and8(eq11(length9(elems), 1), _Option_isSome2(rest))).with({ _tag: "None" }, () => false).exhaustive(), seqs)))(someOf2((p) => match11(seqElemsRest(p)).with((_v) => {
    const _g = _v;
    return _g._tag === "Some";
  }, ({ value: [elems, rest] }) => and8(eq11(length9(elems), 0), _Option_isNone(rest))).with({ _tag: "None" }, () => false).exhaustive(), seqs));
});
var ctorLoop = _curry12(5, (arms, i, reg, owner, covered) => match11(_Array_get9(i, arms)).with({ _tag: "None" }, () => Ok8(_tuple6(owner, covered))).with({ _tag: "Some" }, ({ value: a }) => match11(a.pattern).with({ _tag: "PCtor" }, ({ ctor, args, ns, span: sp }) => ((key) => match11(_Map_get4(key, reg.ctors)).with({ _tag: "None" }, () => Err7(checkErr(`unknown constructor '${key}'`, sp))).with({ _tag: "Some" }, ({ value: info }) => not7(eq11(length9(args), info.arity)) ? Err7(checkErr(`constructor '${ctor}' expects ${show5(info.arity)} arg(s), got ${show5(length9(args))}`, sp)) : match11(owner).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && (({ value: own }) => not7(eq11(own, info.owner)))(_g);
}, ({ value: own }) => Err7(checkErr(`switch mixes variants of '${own}' and '${info.owner}'`, sp))).otherwise(() => ((covered2) => ctorLoop(arms, i + 1, reg, Some11(info.owner), covered2))(and8(allOf(isCatchAll, args), _Option_isNone(a.guard)) ? _Set_add(ctor, covered) : covered))).exhaustive())(patCtorKey(ctor, ns))).otherwise(() => ctorLoop(arms, i + 1, reg, owner, covered))).exhaustive());
var seqVerdict = _curry12(2, (arms, mSpan) => match11(checkSeqExhaustive(arms, mSpan)).with({ _tag: "SeqTotal" }, () => None11).with({ _tag: "SeqFail" }, ({ e }) => Some11(e)).with({ _tag: "SeqNotSeq" }, () => None11).exhaustive());
var unguardedPatterns = (arms) => _Array_flatMap2((a) => _Option_isNone(a.guard) ? [a.pattern] : [], arms);
var namedUnguarded = (leaves) => _Set_fromArray(_Array_flatMap2((a) => and8(isPCtor(a.pattern), _Option_isNone(a.guard)) ? [ctorNameOf(a.pattern)] : [], leaves));
var matrixVerdict = _curry12(5, (arms, leaves, ownerOpt, mSpan, reg) => match11(checkExhaustiveM(unguardedPatterns(arms), reg)).with({ _tag: "ExOk" }, () => None11).with({ _tag: "ExFuel" }, () => Some11(checkErr("switch too complex to prove exhaustive \u2014 add a `_` catch-all arm", mSpan))).with({ _tag: "ExWitness" }, ({ witness: w }) => ((own) => ((named) => ((absent) => and8(and8(isWideWitnessM(w), not7(eq11(own, ""))), length9(absent) > 0) ? Some11(checkErr(`non-exhaustive switch on '${own}': missing ${_Str_join4(", ", absent)}`, mSpan)) : Some11(checkErr(`non-exhaustive switch: '${showWitness(w)}' is not matched`, mSpan)))(filter3((c) => not7(_Set_has(c, named)), _Map_getOr2([], own, reg.types))))(namedUnguarded(leaves)))(_Option_unwrapOr6("", ownerOpt))).exhaustive());
var leavesOfArm = (a) => match11(a.pattern).with({ _tag: "POr" }, ({ alts }) => map6((alt) => ({ pattern: alt, guard: a.guard }), alts)).otherwise(() => [{ pattern: a.pattern, guard: a.guard }]);
var checkMatch = _curry12(3, (arms, mSpan, reg) => match11(firstSome((a) => checkPattern(a.pattern, reg, true), arms)).with({ _tag: "Some" }, ({ value: e }) => Some11(e)).with({ _tag: "None" }, () => ((listSwitch) => match11(guardErrs(arms, listSwitch)).with({ _tag: "Some" }, ({ value: e }) => Some11(e)).with({ _tag: "None" }, () => match11(unreachableAfterCatch(arms)).with({ _tag: "Some" }, ({ value: e }) => Some11(e)).with({ _tag: "None" }, () => ((hasCatchAll) => ((leaves) => ((ctorArms) => someOf2((a) => isPList(a.pattern), arms) ? hasCatchAll ? None11 : seqVerdict(arms, mSpan) : match11(ctorLoop(ctorArms, 0, reg, None11, _Set_fromArray([]))).with({ _tag: "Err" }, ({ error: e }) => Some11(e)).with((_v) => {
  const _g = _v;
  return _g._tag === "Ok";
}, ({ value: [ownerOpt] }) => matrixVerdict(arms, leaves, ownerOpt, mSpan, reg)).exhaustive())(filter3((a) => isPCtor(a.pattern), leaves)))(_Array_flatMap2(leavesOfArm, arms)))(someOf2(armUnguardedCatchAll, arms))).exhaustive()).exhaustive())(someOf2((a) => and8(isPList(a.pattern), not7(isCatchAll(a.pattern))), arms))).exhaustive());
var checkExpr = _curry12(2, (e, reg) => match11(e).with({ _tag: "ENum" }, () => None11).with({ _tag: "EUnit" }, () => None11).with({ _tag: "EBool" }, () => None11).with({ _tag: "EStr" }, () => None11).with({ _tag: "ERef" }, () => None11).with({ _tag: "ECall" }, ({ fn, args }) => _Option_orElse(firstSome((a) => checkExpr(a, reg), args), checkExpr(fn, reg))).with({ _tag: "ELambda" }, ({ body }) => checkExpr(body, reg)).with({ _tag: "ELetIn" }, ({ value, body }) => _Option_orElse(checkExpr(body, reg), checkExpr(value, reg))).with({ _tag: "ELetBind" }, ({ value, body }) => _Option_orElse(checkExpr(body, reg), checkExpr(value, reg))).with({ _tag: "EPipe" }, ({ left, right }) => _Option_orElse(checkExpr(right, reg), checkExpr(left, reg))).with({ _tag: "EDo" }, ({ exprs }) => firstSome((x) => checkExpr(x, reg), exprs)).with({ _tag: "ETernary" }, ({ cond, thenE, elseE }) => _Option_orElse(checkExpr(elseE, reg), _Option_orElse(checkExpr(thenE, reg), checkExpr(cond, reg)))).with({ _tag: "EMatch" }, ({ scrutinee, arms, span: sp }) => _Option_orElse(checkMatch(arms, sp, reg), _Option_orElse(firstSome((a) => _Option_orElse(checkExpr(a.body, reg), match11(a.guard).with({ _tag: "Some" }, ({ value: g }) => checkExpr(g, reg)).with({ _tag: "None" }, () => None11).exhaustive()), arms), checkExpr(scrutinee, reg)))).with({ _tag: "ERecord" }, ({ fields, spread }) => _Option_orElse(firstSome((f) => checkExpr(f.value, reg), fields), match11(spread).with({ _tag: "Some" }, ({ value: s }) => checkExpr(s, reg)).with({ _tag: "None" }, () => None11).exhaustive())).with({ _tag: "EField" }, ({ target }) => checkExpr(target, reg)).with({ _tag: "ELoop" }, ({ params, body }) => _Option_orElse(checkExpr(body, reg), firstSome((p) => checkExpr(p.init, reg), params))).with({ _tag: "ERecur" }, ({ args }) => firstSome((a) => checkExpr(a, reg), args)).with({ _tag: "ETuple" }, ({ elements }) => firstSome((el) => checkExpr(el, reg), elements)).with({ _tag: "EArr" }, ({ elements }) => firstSome((el) => checkExpr(match11(el).with({ _tag: "SEExpr" }, ({ expr: e }) => e).with({ _tag: "SESpread" }, ({ expr: e }) => e).exhaustive(), reg), elements)).with({ _tag: "EList" }, ({ elements }) => firstSome((el) => checkExpr(match11(el).with({ _tag: "SEExpr" }, ({ expr: e }) => e).with({ _tag: "SESpread" }, ({ expr: e }) => e).exhaustive(), reg), elements)).with({ _tag: "ESet" }, ({ elements }) => firstSome((el) => checkExpr(match11(el).with({ _tag: "SEExpr" }, ({ expr: e }) => e).with({ _tag: "SESpread" }, ({ expr: e }) => e).exhaustive(), reg), elements)).with({ _tag: "EMap" }, ({ entries }) => firstSome((en) => _Option_orElse(checkExpr(en.value, reg), checkExpr(en.key, reg)), entries)).with({ _tag: "EInterp" }, ({ parts }) => firstSome((p) => match11(p).with({ _tag: "IPLit" }, () => None11).with({ _tag: "IPExpr" }, ({ expr: ex }) => checkExpr(ex, reg)).exhaustive(), parts)).exhaustive());
var checkExprs = _curry12(2, (e, reg) => match11(e).with({ _tag: "ENum" }, () => []).with({ _tag: "EUnit" }, () => []).with({ _tag: "EBool" }, () => []).with({ _tag: "EStr" }, () => []).with({ _tag: "ERef" }, () => []).with({ _tag: "ECall" }, ({ fn, args }) => [...checkExprs(fn, reg), ..._Array_flatMap2((a) => checkExprs(a, reg), args)]).with({ _tag: "ELambda" }, ({ body }) => checkExprs(body, reg)).with({ _tag: "ELetIn" }, ({ value, body }) => [...checkExprs(value, reg), ...checkExprs(body, reg)]).with({ _tag: "ELetBind" }, ({ value, body }) => [...checkExprs(value, reg), ...checkExprs(body, reg)]).with({ _tag: "EPipe" }, ({ left, right }) => [...checkExprs(left, reg), ...checkExprs(right, reg)]).with({ _tag: "EDo" }, ({ exprs }) => _Array_flatMap2((x) => checkExprs(x, reg), exprs)).with({ _tag: "ETernary" }, ({ cond, thenE, elseE }) => [...checkExprs(cond, reg), ...checkExprs(thenE, reg), ...checkExprs(elseE, reg)]).with({ _tag: "EMatch" }, ({ scrutinee, arms, span: sp }) => [...checkExprs(scrutinee, reg), ..._Array_flatMap2((a) => [...match11(a.guard).with({ _tag: "Some" }, ({ value: g }) => checkExprs(g, reg)).with({ _tag: "None" }, () => []).exhaustive(), ...checkExprs(a.body, reg)], arms), ...match11(checkMatch(arms, sp, reg)).with({ _tag: "Some" }, ({ value: e }) => [e]).with({ _tag: "None" }, () => []).exhaustive()]).with({ _tag: "ERecord" }, ({ fields, spread }) => [...match11(spread).with({ _tag: "Some" }, ({ value: s }) => checkExprs(s, reg)).with({ _tag: "None" }, () => []).exhaustive(), ..._Array_flatMap2((f) => checkExprs(f.value, reg), fields)]).with({ _tag: "EField" }, ({ target }) => checkExprs(target, reg)).with({ _tag: "ELoop" }, ({ params, body }) => [..._Array_flatMap2((p) => checkExprs(p.init, reg), params), ...checkExprs(body, reg)]).with({ _tag: "ERecur" }, ({ args }) => _Array_flatMap2((a) => checkExprs(a, reg), args)).with({ _tag: "ETuple" }, ({ elements }) => _Array_flatMap2((el) => checkExprs(el, reg), elements)).with({ _tag: "EArr" }, ({ elements }) => _Array_flatMap2((el) => match11(el).with({ _tag: "SEExpr" }, ({ expr: value }) => checkExprs(value, reg)).with({ _tag: "SESpread" }, ({ expr: value }) => checkExprs(value, reg)).exhaustive(), elements)).with({ _tag: "EList" }, ({ elements }) => _Array_flatMap2((el) => match11(el).with({ _tag: "SEExpr" }, ({ expr: value }) => checkExprs(value, reg)).with({ _tag: "SESpread" }, ({ expr: value }) => checkExprs(value, reg)).exhaustive(), elements)).with({ _tag: "ESet" }, ({ elements }) => _Array_flatMap2((el) => match11(el).with({ _tag: "SEExpr" }, ({ expr: value }) => checkExprs(value, reg)).with({ _tag: "SESpread" }, ({ expr: value }) => checkExprs(value, reg)).exhaustive(), elements)).with({ _tag: "EMap" }, ({ entries }) => _Array_flatMap2((entry) => [...checkExprs(entry.key, reg), ...checkExprs(entry.value, reg)], entries)).with({ _tag: "EInterp" }, ({ parts }) => _Array_flatMap2((part) => match11(part).with({ _tag: "IPLit" }, () => []).with({ _tag: "IPExpr" }, ({ expr: value }) => checkExprs(value, reg)).exhaustive(), parts)).exhaustive());
var reservedNames = ["Array", "List", "Set", "Map", "Option", "Result", "Task", "Str"];
var redeclarableTypes = ["Option", "Result"];
var reservedErr = _curry12(2, (name, sp) => checkErr(`'${name}' is a reserved collection namespace and cannot be bound`, sp));
var checkReservedNames = (stmts) => firstSome((s) => match11(s).with({ _tag: "SType" }, ({ name, span: sp }) => _Array_contains2(name, redeclarableTypes) ? None11 : _Array_contains2(name, reservedNames) ? Some11(reservedErr(name, sp)) : None11).with({ _tag: "SLet" }, ({ name, span: sp }) => _Array_contains2(name, reservedNames) ? Some11(reservedErr(name, sp)) : None11).with({ _tag: "SExtern" }, ({ name, span: sp }) => _Array_contains2(name, reservedNames) ? Some11(reservedErr(name, sp)) : None11).with({ _tag: "SImport" }, ({ names }) => firstSome((n) => _Array_contains2(n.name, reservedNames) ? Some11(checkErr(`'${n.name}' is a reserved collection namespace and cannot be imported`, n.span)) : None11, names)).with({ _tag: "SImportNs" }, ({ alias }) => _Array_contains2(alias.name, reservedNames) ? Some11(checkErr(`'${alias.name}' is a reserved collection namespace and cannot be imported`, alias.span)) : None11).with({ _tag: "SError" }, () => None11).with({ _tag: "SExpr" }, () => None11).exhaustive(), stmts);
var checkReservedNamesAll = (stmts) => _Array_flatMap2((s) => match11(s).with({ _tag: "SType" }, ({ name, span: sp }) => _Array_contains2(name, redeclarableTypes) ? [] : _Array_contains2(name, reservedNames) ? [reservedErr(name, sp)] : []).with({ _tag: "SLet" }, ({ name, span: sp }) => _Array_contains2(name, reservedNames) ? [reservedErr(name, sp)] : []).with({ _tag: "SExtern" }, ({ name, span: sp }) => _Array_contains2(name, reservedNames) ? [reservedErr(name, sp)] : []).with({ _tag: "SImport" }, ({ names }) => _Array_flatMap2((n) => _Array_contains2(n.name, reservedNames) ? [checkErr(`'${n.name}' is a reserved collection namespace and cannot be imported`, n.span)] : [], names)).with({ _tag: "SImportNs" }, ({ alias }) => _Array_contains2(alias.name, reservedNames) ? [checkErr(`'${alias.name}' is a reserved collection namespace and cannot be imported`, alias.span)] : []).otherwise(() => []), stmts);
...
var reservedWord = _curry12(2, (name, sp) => _Array_contains2(name, jsReserved) ? [checkErr(`'${name}' is a JavaScript reserved word and can't be used as a binding name; rename it`, sp)] : []);
var typeExprSpan = (te) => match11(te).with({ _tag: "TyName" }, ({ span: sp }) => sp).with({ _tag: "TyArrow" }, ({ span: sp }) => sp).with({ _tag: "TyApp" }, ({ span: sp }) => sp).with({ _tag: "TyTuple" }, ({ span: sp }) => sp).with({ _tag: "TyList" }, ({ span: sp }) => sp).with({ _tag: "TyQual" }, ({ span: sp }) => sp).with({ _tag: "TyLit" }, ({ span: sp }) => sp).with({ _tag: "TyUnion" }, ({ span: sp }) => sp).exhaustive();
var checkReservedParam = _curry12(2, (param, sp) => match11(param).with({ _tag: "LPName" }, ({ name }) => reservedWord(name, sp)).with({ _tag: "LPRecord" }, ({ fields }) => _Array_flatMap2((name) => reservedWord(name, sp), fields)).with({ _tag: "LPTuple" }, ({ names }) => _Array_flatMap2((name) => reservedWord(name, sp), names)).with({ _tag: "LPLabeled" }, ({ name, defaultValue }) => [...reservedWord(name, sp), ...match11(defaultValue).with({ _tag: "Some" }, ({ value }) => checkReservedExpr(value)).with({ _tag: "None" }, () => []).exhaustive()]).with({ _tag: "LPSpanned" }, ({ param: inner }) => checkReservedParam(inner, sp)).exhaustive());
var checkReservedPattern = (pat) => match11(pat).with({ _tag: "PAs" }, ({ pat: inner, name, nameSpan: nameSp }) => [...checkReservedPattern(inner), ...reservedWord(name, nameSp)]).with({ _tag: "PBind" }, ({ name, span: sp }) => reservedWord(name, sp)).with({ _tag: "PTuple" }, ({ elems }) => _Array_flatMap2(checkReservedPattern, elems)).with({ _tag: "PRecord" }, ({ fields }) => _Array_flatMap2((field) => checkReservedPattern(field.pat), fields)).with({ _tag: "PCtor" }, ({ args }) => _Array_flatMap2(checkReservedPattern, args)).with({ _tag: "PArr" }, ({ elems, rest }) => [..._Array_flatMap2(checkReservedPattern, elems), ...match11(rest).with({ _tag: "Some" }, ({ value }) => checkReservedPattern(value)).with({ _tag: "None" }, () => []).exhaustive()]).with({ _tag: "PList" }, ({ elems, rest }) => [..._Array_flatMap2(checkReservedPattern, elems), ...match11(rest).with({ _tag: "Some" }, ({ value }) => checkReservedPattern(value)).with({ _tag: "None" }, () => []).exhaustive()]).with({ _tag: "POr" }, ({ alts }) => _Array_flatMap2(checkReservedPattern, alts)).otherwise(() => []);
var checkReservedSeqElem = (el) => match11(el).with({ _tag: "SEExpr" }, ({ expr: value }) => checkReservedExpr(value)).with({ _tag: "SESpread" }, ({ expr: value }) => checkReservedExpr(value)).exhaustive();
var checkReservedExpr = (expr) => match11(expr).with({ _tag: "ECall" }, ({ fn, args }) => [...checkReservedExpr(fn), ..._Array_flatMap2(checkReservedExpr, args)]).with({ _tag: "ELambda" }, ({ params, body, span: sp }) => [..._Array_flatMap2((param) => checkReservedParam(param, sp), params), ...checkReservedExpr(body)]).with({ _tag: "ELetIn" }, ({ name, nameSpan: nameSp, value, body }) => [...reservedWord(name, nameSp), ...checkReservedExpr(value), ...checkReservedExpr(body)]).with({ _tag: "ELetBind" }, ({ param, paramSpan: paramSp, value, body }) => [...checkReservedParam(param, paramSp), ...checkReservedExpr(value), ...checkReservedExpr(body)]).with({ _tag: "EPipe" }, ({ left, right }) => [...checkReservedExpr(left), ...checkReservedExpr(right)]).with({ _tag: "EDo" }, ({ exprs }) => _Array_flatMap2(checkReservedExpr, exprs)).with({ _tag: "ETernary" }, ({ cond, thenE, elseE }) => [...checkReservedExpr(cond), ...checkReservedExpr(thenE), ...checkReservedExpr(elseE)]).with({ _tag: "EMatch" }, ({ scrutinee, arms }) => [...checkReservedExpr(scrutinee), ..._Array_flatMap2((arm) => [...checkReservedPattern(arm.pattern), ...match11(arm.guard).with({ _tag: "Some" }, ({ value: guard }) => checkReservedExpr(guard)).with({ _tag: "None" }, () => []).exhaustive(), ...checkReservedExpr(arm.body)], arms)]).with({ _tag: "ERecord" }, ({ fields, spread }) => [...match11(spread).with({ _tag: "Some" }, ({ value }) => checkReservedExpr(value)).with({ _tag: "None" }, () => []).exhaustive(), ..._Array_flatMap2((field) => checkReservedExpr(field.value), fields)]).with({ _tag: "EField" }, ({ target }) => checkReservedExpr(target)).with({ _tag: "ELoop" }, ({ params, body }) => [..._Array_flatMap2((param) => reservedWord(param.name, param.nameSpan), params), ..._Array_flatMap2((param) => checkReservedExpr(param.init), params), ...checkReservedExpr(body)]).with({ _tag: "ERecur" }, ({ args }) => _Array_flatMap2(checkReservedExpr, args)).with({ _tag: "ETuple" }, ({ elements }) => _Array_flatMap2(checkReservedExpr, elements)).with({ _tag: "EArr" }, ({ elements }) => _Array_flatMap2(checkReservedSeqElem, elements)).with({ _tag: "EList" }, ({ elements }) => _Array_flatMap2(checkReservedSeqElem, elements)).with({ _tag: "ESet" }, ({ elements }) => _Array_flatMap2(checkReservedSeqElem, elements)).with({ _tag: "EMap" }, ({ entries }) => _Array_flatMap2((entry) => [...checkReservedExpr(entry.key), ...checkReservedExpr(entry.value)], entries)).with({ _tag: "EInterp" }, ({ parts }) => _Array_flatMap2((part) => match11(part).with({ _tag: "IPLit" }, () => []).with({ _tag: "IPExpr" }, ({ expr: value }) => checkReservedExpr(value)).exhaustive(), parts)).otherwise(() => []);
var checkReservedWordsAll = (stmts) => _Array_flatMap2((stmt) => match11(stmt).with({ _tag: "SLet" }, ({ name, nameSpan: nameSp, value }) => [...reservedWord(name, nameSp), ...checkReservedExpr(value)]).with({ _tag: "SExpr" }, ({ value }) => checkReservedExpr(value)).with({ _tag: "SExtern" }, ({ name, nameSpan: nameSp }) => reservedWord(name, nameSp)).with({ _tag: "SType" }, ({ ctors }) => _Array_flatMap2((ctor) => _Array_flatMap2((field) => match11(field.name).with({ _tag: "Some" }, ({ value: name }) => reservedWord(name, typeExprSpan(field.fieldType))).with({ _tag: "None" }, () => []).exhaustive(), ctor.fields), ctors)).otherwise(() => []), stmts);
var checkReservedWords = (stmts) => _Array_head3(checkReservedWordsAll(stmts));
var isUpperStart = (s) => match11(_Str_codeAt5(0, s)).with({ _tag: "Some" }, ({ value: c }) => and8(c >= 65, c <= 90)).with({ _tag: "None" }, () => false).exhaustive();
var strayTypeVar = _curry12(2, (params, te) => match11(te).with({ _tag: "TyName" }, ({ name, span: sp }) => or6(isUpperStart(name), or6(_Array_contains2(name, primTypeNames), _Array_contains2(name, params))) ? None11 : Some11(_tuple6(name, sp))).with({ _tag: "TyArrow" }, ({ from, to }) => _Option_orElse(strayTypeVar(params, to), strayTypeVar(params, from))).with({ _tag: "TyApp" }, ({ args }) => firstSome(strayTypeVar(params), args)).with({ _tag: "TyTuple" }, ({ elems }) => firstSome(strayTypeVar(params), elems)).with({ _tag: "TyList" }, ({ elem }) => strayTypeVar(params, elem)).with({ _tag: "TyQual" }, ({ args }) => firstSome(strayTypeVar(params), args)).with({ _tag: "TyLit" }, () => None11).with({ _tag: "TyUnion" }, ({ members }) => firstSome(strayTypeVar(params), members)).exhaustive());
var checkCtorFieldVars = (stmts) => firstSome((s) => match11(s).with({ _tag: "SType" }, ({ name, params, ctors }) => firstSome((c) => firstSome((f) => match11(strayTypeVar(params, f.fieldType)).with((_v) => {
  const _g = _v;
  return _g._tag === "Some";
}, ({ value: [vn, vsp] }) => Some11(checkErr(`unknown type parameter '${vn}' in constructor '${c.name}' \u2014 declare it: type ${name} ${_Str_join4(" ", _Array_append8(vn, params))} = ...`, vsp))).with({ _tag: "None" }, () => None11).exhaustive(), c.fields), ctors)).otherwise(() => None11), stmts);
var checkCtorFieldVarsAll = (stmts) => _Array_flatMap2((s) => match11(s).with({ _tag: "SType" }, ({ name, params, ctors }) => _Array_flatMap2((c) => _Array_flatMap2((f) => match11(strayTypeVar(params, f.fieldType)).with((_v) => {
  const _g = _v;
  return _g._tag === "Some";
}, ({ value: [vn, vsp] }) => [checkErr(`unknown type parameter '${vn}' in constructor '${c.name}' \u2014 declare it: type ${name} ${_Str_join4(" ", _Array_append8(vn, params))} = ...`, vsp)]).with({ _tag: "None" }, () => []).exhaustive(), c.fields), ctors)).otherwise(() => []), stmts);
var qualRefsFrom = (te) => match11(te).with({ _tag: "TyName" }, () => []).with({ _tag: "TyArrow" }, ({ from, to }) => [...qualRefsFrom(from), ...qualRefsFrom(to)]).with({ _tag: "TyApp" }, ({ args }) => _Array_flatMap2(qualRefsFrom, args)).with({ _tag: "TyTuple" }, ({ elems }) => _Array_flatMap2(qualRefsFrom, elems)).with({ _tag: "TyList" }, ({ elem }) => qualRefsFrom(elem)).with({ _tag: "TyQual" }, ({ alias, name, nameSpan, args, span: sp }) => [{ alias, name, nameSpan, qualSpan: sp }, ..._Array_flatMap2(qualRefsFrom, args)]).with({ _tag: "TyLit" }, () => []).with({ _tag: "TyUnion" }, ({ members }) => _Array_flatMap2(qualRefsFrom, members)).exhaustive();
var letInAnnots = (e) => match11(e).with({ _tag: "ENum" }, () => []).with({ _tag: "EUnit" }, () => []).with({ _tag: "EBool" }, () => []).with({ _tag: "EStr" }, () => []).with({ _tag: "ERef" }, () => []).with({ _tag: "ECall" }, ({ fn, args }) => [...letInAnnots(fn), ..._Array_flatMap2(letInAnnots, args)]).with({ _tag: "ELambda" }, ({ params, body }) => [...letInAnnots(body), ..._Array_flatMap2((p) => match11(p).with((_v) => {
  const _g = _v;
...
}, ({ defaultValue: { value: d } }) => letInAnnots(d)).otherwise(() => []), params)]).with({ _tag: "ELetIn" }, ({ annot, value, body }) => [...letInAnnots(value), ...letInAnnots(body), ...match11(annot).with({ _tag: "Some" }, ({ value: te }) => [te]).with({ _tag: "None" }, () => []).exhaustive()]).with({ _tag: "ELetBind" }, ({ value, body }) => [...letInAnnots(value), ...letInAnnots(body)]).with({ _tag: "EPipe" }, ({ left, right }) => [...letInAnnots(left), ...letInAnnots(right)]).with({ _tag: "EDo" }, ({ exprs }) => _Array_flatMap2(letInAnnots, exprs)).with({ _tag: "ETernary" }, ({ cond, thenE, elseE }) => [...letInAnnots(cond), ...letInAnnots(thenE), ...letInAnnots(elseE)]).with({ _tag: "EMatch" }, ({ scrutinee, arms }) => [...letInAnnots(scrutinee), ..._Array_flatMap2((a) => [...match11(a.guard).with({ _tag: "Some" }, ({ value: g }) => letInAnnots(g)).with({ _tag: "None" }, () => []).exhaustive(), ...letInAnnots(a.body)], arms)]).with({ _tag: "ERecord" }, ({ fields, spread }) => [...match11(spread).with({ _tag: "Some" }, ({ value: sp }) => letInAnnots(sp)).with({ _tag: "None" }, () => []).exhaustive(), ..._Array_flatMap2((f) => letInAnnots(f.value), fields)]).with({ _tag: "EField" }, ({ target }) => letInAnnots(target)).with({ _tag: "ELoop" }, ({ params, body }) => [..._Array_flatMap2((prm) => letInAnnots(prm.init), params), ...letInAnnots(body)]).with({ _tag: "ERecur" }, ({ args }) => _Array_flatMap2(letInAnnots, args)).with({ _tag: "ETuple" }, ({ elements }) => _Array_flatMap2(letInAnnots, elements)).with({ _tag: "EArr" }, ({ elements }) => _Array_flatMap2(seqElemAnnots, elements)).with({ _tag: "EList" }, ({ elements }) => _Array_flatMap2(seqElemAnnots, elements)).with({ _tag: "ESet" }, ({ elements }) => _Array_flatMap2(seqElemAnnots, elements)).with({ _tag: "EMap" }, ({ entries }) => _Array_flatMap2((en) => [...letInAnnots(en.key), ...letInAnnots(en.value)], entries)).with({ _tag: "EInterp" }, ({ parts }) => _Array_flatMap2((prt) => match11(prt).with({ _tag: "IPLit" }, () => []).with({ _tag: "IPExpr" }, ({ expr: ex }) => letInAnnots(ex)).exhaustive(), parts)).exhaustive();
var seqElemAnnots = (el) => match11(el).with({ _tag: "SEExpr" }, ({ expr: e }) => letInAnnots(e)).with({ _tag: "SESpread" }, ({ expr: e }) => letInAnnots(e)).exhaustive();
var writtenTypeExprs = (stmts) => _Array_flatMap2((s) => match11(s).with({ _tag: "SExtern" }, ({ typeExpr: te }) => [te]).with({ _tag: "SLet" }, ({ annot, value }) => [...match11(annot).with({ _tag: "Some" }, ({ value: te }) => [te]).with({ _tag: "None" }, () => []).exhaustive(), ...letInAnnots(value)]).with({ _tag: "SExpr" }, ({ value }) => letInAnnots(value)).with({ _tag: "SType" }, ({ ctors, alias, aliasType }) => [..._Array_flatMap2((c) => map6((f) => f.fieldType, c.fields), ctors), ...match11(alias).with({ _tag: "Some" }, ({ value: fields }) => map6((f) => f.fieldType, fields)).with({ _tag: "None" }, () => []).exhaustive(), ...match11(aliasType).with({ _tag: "Some" }, ({ value: te }) => [te]).with({ _tag: "None" }, () => []).exhaustive()]).otherwise(() => []), stmts);
var emptyQuals = new Map;
var checkQualifiedTypeNames = _curry12(2, (stmts, quals) => {
  const nsAliases = _Set_fromArray(_Array_flatMap2((s) => match11(s).with({ _tag: "SImportNs" }, ({ alias }) => [alias.name]).otherwise(() => []), stmts));
  return firstSome((q) => _Set_has(q.alias, nsAliases) ? match11(_Map_get4(q.alias, quals)).with({ _tag: "None" }, () => None11).with({ _tag: "Some" }, ({ value: dep }) => _Set_has(q.name, dep.types) ? None11 : Some11(checkErr(`module alias '${q.alias}' has no exported type '${q.name}' \u2014 export it from the imported module ('export type ${q.name} = \u2026')`, q.nameSpan))).exhaustive() : Some11(checkErr(`unknown module alias '${q.alias}' in type '${q.alias}.${q.name}' \u2014 a qualified type name needs a matching 'import * as ${q.alias} from "\u2026"'`, q.qualSpan)), _Array_flatMap2(qualRefsFrom, writtenTypeExprs(stmts)));
});
var checkQualifiedTypeNamesAll = _curry12(2, (stmts, quals) => {
  const nsAliases = _Set_fromArray(_Array_flatMap2((s) => match11(s).with({ _tag: "SImportNs" }, ({ alias }) => [alias.name]).otherwise(() => []), stmts));
  return _Array_flatMap2((q) => _Set_has(q.alias, nsAliases) ? match11(_Map_get4(q.alias, quals)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: dep }) => _Set_has(q.name, dep.types) ? [] : [checkErr(`module alias '${q.alias}' has no exported type '${q.name}' \u2014 export it from the imported module ('export type ${q.name} = \u2026')`, q.nameSpan)]).exhaustive() : [checkErr(`unknown module alias '${q.alias}' in type '${q.alias}.${q.name}' \u2014 a qualified type name needs a matching 'import * as ${q.alias} from "\u2026"'`, q.qualSpan)], _Array_flatMap2(qualRefsFrom, writtenTypeExprs(stmts)));
});
var duplicateLoopParam = (params) => {
  let i = 0;
  let seen = _Set_fromArray([]);
  while (true) {
    const _step = match11(_Array_get9(i, params)).with({ _tag: "None" }, () => _done5(None11)).with({ _tag: "Some" }, ({ value: p }) => _Set_has(p.name, seen) ? _done5(Some11(checkErr(`duplicate loop param '${p.name}'`, p.nameSpan))) : _recur5(i + 1, _Set_add(p.name, seen))).exhaustive();
    if (_step._tag === "recur") {
      [i, seen] = _step.args;
      continue;
    }
...
var checkLoopDo = _curry12(3, (exprs, frame, tail) => {
  let i = 0;
  while (true) {
    const _step = match11(_Array_get9(i, exprs)).with({ _tag: "None" }, () => _done5(None11)).with({ _tag: "Some" }, ({ value: expr }) => _Option_isNone(_Array_get9(i + 1, exprs)) ? _done5(checkLoopExpr(expr, frame, tail)) : match11(checkLoopExpr(expr, frame, false)).with({ _tag: "Some" }, ({ value: error }) => _done5(Some11(error))).with({ _tag: "None" }, () => _recur5(i + 1)).exhaustive()).exhaustive();
    if (_step._tag === "recur") {
      i = _step.args[0];
      continue;
    }
...
var checkLoopExpr = _curry12(3, (e, frame, tail) => match11(e).with({ _tag: "ELoop" }, ({ params, body }) => _Option_orElse(checkLoopExpr(body, Some11({ arity: length9(params), names: _Set_fromArray(map6((p) => p.name, params)) }), true), _Option_orElse(firstSome((p) => checkLoopExpr(p.init, frame, false), params), duplicateLoopParam(params)))).with({ _tag: "ERecur" }, ({ args, span: sp }) => match11(frame).with({ _tag: "None" }, () => Some11(checkErr("'recur' is only legal inside a loop body", sp))).with({ _tag: "Some" }, ({ value: current }) => not7(tail) ? Some11(checkErr("'recur' must be in tail position of its enclosing loop", sp)) : not7(eq11(length9(args), current.arity)) ? Some11(checkErr(`'recur' takes ${show5(current.arity)} argument${eq11(current.arity, 1) ? "" : "s"} (one per loop param), got ${show5(length9(args))}`, sp)) : firstSome((a) => checkLoopExpr(a, frame, false), args)).exhaustive()).with({ _tag: "ETernary" }, ({ cond, thenE, elseE }) => _Option_orElse(checkLoopExpr(elseE, frame, tail), _Option_orElse(checkLoopExpr(thenE, frame, tail), checkLoopExpr(cond, frame, false)))).with({ _tag: "EMatch" }, ({ scrutinee, arms }) => _Option_orElse(firstSome((arm) => match11(arm.guard).with({ _tag: "Some" }, ({ value: guard }) => _Option_orElse(checkLoopExpr(arm.body, frame, tail), checkLoopExpr(guard, frame, false))).with({ _tag: "None" }, () => checkLoopExpr(arm.body, frame, tail)).exhaustive(), arms), checkLoopExpr(scrutinee, frame, false))).with({ _tag: "ELetIn" }, ({ name, nameSpan: nameSp, value, body }) => _Option_orElse(checkLoopExpr(body, frame, tail), _Option_orElse(match11(frame).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && (({ value: current }) => _Set_has(name, current.names))(_g);
}, ({ value: current }) => Some11(checkErr(`'${name}' shadows a loop param inside the loop body; rename it`, nameSp))).otherwise(() => None11), checkLoopExpr(value, frame, false)))).with({ _tag: "ELetBind" }, ({ value, body }) => _Option_orElse(checkLoopExpr(body, None11, false), checkLoopExpr(value, frame, false))).with({ _tag: "ELambda" }, ({ body }) => checkLoopExpr(body, None11, false)).with({ _tag: "ECall" }, ({ fn, args }) => _Option_orElse(firstSome((a) => checkLoopExpr(a, frame, false), args), checkLoopExpr(fn, frame, false))).with({ _tag: "EPipe" }, ({ left, right }) => _Option_orElse(checkLoopExpr(right, frame, false), checkLoopExpr(left, frame, false))).with({ _tag: "EDo" }, ({ exprs }) => checkLoopDo(exprs, frame, tail)).with({ _tag: "ERecord" }, ({ fields, spread }) => _Option_orElse(firstSome((field) => checkLoopExpr(field.value, frame, false), fields), match11(spread).with({ _tag: "Some" }, ({ value }) => checkLoopExpr(value, frame, false)).with({ _tag: "None" }, () => None11).exhaustive())).with({ _tag: "EField" }, ({ target }) => checkLoopExpr(target, frame, false)).with({ _tag: "ETuple" }, ({ elements }) => firstSome((el) => checkLoopExpr(el, frame, false), elements)).with({ _tag: "EArr" }, ({ elements }) => firstSome((el) => match11(el).with({ _tag: "SEExpr" }, ({ expr: value }) => checkLoopExpr(value, frame, false)).with({ _tag: "SESpread" }, ({ expr: value }) => checkLoopExpr(value, frame, false)).exhaustive(), elements)).with({ _tag: "EList" }, ({ elements }) => firstSome((el) => match11(el).with({ _tag: "SEExpr" }, ({ expr: value }) => checkLoopExpr(value, frame, false)).with({ _tag: "SESpread" }, ({ expr: value }) => checkLoopExpr(value, frame, false)).exhaustive(), elements)).with({ _tag: "ESet" }, ({ elements }) => firstSome((el) => match11(el).with({ _tag: "SEExpr" }, ({ expr: value }) => checkLoopExpr(value, frame, false)).with({ _tag: "SESpread" }, ({ expr: value }) => checkLoopExpr(value, frame, false)).exhaustive(), elements)).with({ _tag: "EMap" }, ({ entries }) => firstSome((entry) => _Option_orElse(checkLoopExpr(entry.value, frame, false), checkLoopExpr(entry.key, frame, false)), entries)).with({ _tag: "EInterp" }, ({ parts }) => firstSome((part) => match11(part).with({ _tag: "IPLit" }, () => None11).with({ _tag: "IPExpr" }, ({ expr: value }) => checkLoopExpr(value, frame, false)).exhaustive(), parts)).otherwise(() => None11));
var checkLoops = (stmts) => firstSome((stmt) => match11(stmt).with({ _tag: "SLet" }, ({ value }) => checkLoopExpr(value, None11, false)).with({ _tag: "SExpr" }, ({ value }) => checkLoopExpr(value, None11, false)).otherwise(() => None11), stmts);
var loopParamErrors = (params) => {
  let i = 0;
  let seen = _Set_fromArray([]);
  let errors = [];
  while (true) {
    const _step = match11(_Array_get9(i, params)).with({ _tag: "None" }, () => _done5(errors)).with({ _tag: "Some" }, ({ value: p }) => _recur5(i + 1, _Set_add(p.name, seen), _Set_has(p.name, seen) ? [...errors, checkErr(`duplicate loop param '${p.name}'`, p.nameSpan)] : errors)).exhaustive();
    if (_step._tag === "recur") {
...
var checkLoopDoAll = _curry12(3, (exprs, frame, tail) => {
  let i = 0;
  let errors = [];
  while (true) {
    const _step = match11(_Array_get9(i, exprs)).with({ _tag: "None" }, () => _done5(errors)).with({ _tag: "Some" }, ({ value: expr }) => ((isLast) => _recur5(i + 1, [...errors, ...checkLoopExprs(expr, frame, isLast ? tail : false)]))(_Option_isNone(_Array_get9(i + 1, exprs)))).exhaustive();
    if (_step._tag === "recur") {
      [i, errors] = _step.args;
      continue;
    }
...
var checkLoopExprs = _curry12(3, (e, frame, tail) => match11(e).with({ _tag: "ELoop" }, ({ params, body }) => [...loopParamErrors(params), ..._Array_flatMap2((p) => checkLoopExprs(p.init, frame, false), params), ...checkLoopExprs(body, Some11({ arity: length9(params), names: _Set_fromArray(map6((p) => p.name, params)) }), true)]).with({ _tag: "ERecur" }, ({ args, span: sp }) => ((siteErrors) => [...siteErrors, ..._Array_flatMap2((a) => checkLoopExprs(a, frame, false), args)])(match11(frame).with({ _tag: "None" }, () => [checkErr("'recur' is only legal inside a loop body", sp)]).with({ _tag: "Some" }, ({ value: current }) => [...not7(tail) ? [checkErr("'recur' must be in tail position of its enclosing loop", sp)] : [], ...not7(eq11(length9(args), current.arity)) ? [checkErr(`'recur' takes ${show5(current.arity)} argument${eq11(current.arity, 1) ? "" : "s"} (one per loop param), got ${show5(length9(args))}`, sp)] : []]).exhaustive())).with({ _tag: "ETernary" }, ({ cond, thenE, elseE }) => [...checkLoopExprs(cond, frame, false), ...checkLoopExprs(thenE, frame, tail), ...checkLoopExprs(elseE, frame, tail)]).with({ _tag: "EMatch" }, ({ scrutinee, arms }) => [...checkLoopExprs(scrutinee, frame, false), ..._Array_flatMap2((arm) => [...match11(arm.guard).with({ _tag: "Some" }, ({ value: guard }) => checkLoopExprs(guard, frame, false)).with({ _tag: "None" }, () => []).exhaustive(), ...checkLoopExprs(arm.body, frame, tail)], arms)]).with({ _tag: "ELetIn" }, ({ name, nameSpan: nameSp, value, body }) => [...match11(frame).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && (({ value: current }) => _Set_has(name, current.names))(_g);
}, ({ value: current }) => [checkErr(`'${name}' shadows a loop param inside the loop body; rename it`, nameSp)]).otherwise(() => []), ...checkLoopExprs(value, frame, false), ...checkLoopExprs(body, frame, tail)]).with({ _tag: "ELetBind" }, ({ value, body }) => [...checkLoopExprs(value, frame, false), ...checkLoopExprs(body, None11, false)]).with({ _tag: "ELambda" }, ({ body }) => checkLoopExprs(body, None11, false)).with({ _tag: "ECall" }, ({ fn, args }) => [...checkLoopExprs(fn, frame, false), ..._Array_flatMap2((a) => checkLoopExprs(a, frame, false), args)]).with({ _tag: "EPipe" }, ({ left, right }) => [...checkLoopExprs(left, frame, false), ...checkLoopExprs(right, frame, false)]).with({ _tag: "EDo" }, ({ exprs }) => checkLoopDoAll(exprs, frame, tail)).with({ _tag: "ERecord" }, ({ fields, spread }) => [...match11(spread).with({ _tag: "Some" }, ({ value }) => checkLoopExprs(value, frame, false)).with({ _tag: "None" }, () => []).exhaustive(), ..._Array_flatMap2((field) => checkLoopExprs(field.value, frame, false), fields)]).with({ _tag: "EField" }, ({ target }) => checkLoopExprs(target, frame, false)).with({ _tag: "ETuple" }, ({ elements }) => _Array_flatMap2((el) => checkLoopExprs(el, frame, false), elements)).with({ _tag: "EArr" }, ({ elements }) => _Array_flatMap2((el) => match11(el).with({ _tag: "SEExpr" }, ({ expr: value }) => checkLoopExprs(value, frame, false)).with({ _tag: "SESpread" }, ({ expr: value }) => checkLoopExprs(value, frame, false)).exhaustive(), elements)).with({ _tag: "EList" }, ({ elements }) => _Array_flatMap2((el) => match11(el).with({ _tag: "SEExpr" }, ({ expr: value }) => checkLoopExprs(value, frame, false)).with({ _tag: "SESpread" }, ({ expr: value }) => checkLoopExprs(value, frame, false)).exhaustive(), elements)).with({ _tag: "ESet" }, ({ elements }) => _Array_flatMap2((el) => match11(el).with({ _tag: "SEExpr" }, ({ expr: value }) => checkLoopExprs(value, frame, false)).with({ _tag: "SESpread" }, ({ expr: value }) => checkLoopExprs(value, frame, false)).exhaustive(), elements)).with({ _tag: "EMap" }, ({ entries }) => _Array_flatMap2((entry) => [...checkLoopExprs(entry.key, frame, false), ...checkLoopExprs(entry.value, frame, false)], entries)).with({ _tag: "EInterp" }, ({ parts }) => _Array_flatMap2((part) => match11(part).with({ _tag: "IPLit" }, () => []).with({ _tag: "IPExpr" }, ({ expr: value }) => checkLoopExprs(value, frame, false)).exhaustive(), parts)).otherwise(() => []));
var checkLoopsAll = (stmts) => _Array_flatMap2((stmt) => match11(stmt).with({ _tag: "SLet" }, ({ value }) => checkLoopExprs(value, None11, false)).with({ _tag: "SExpr" }, ({ value }) => checkLoopExprs(value, None11, false)).otherwise(() => []), stmts);
var mergeMissing = _curry12(3, (keys, from, into) => match11(keys).with((_v) => _v.length === 0, () => into).with((_v) => _v.length >= 1, ([k, ...rest]) => match11(_Map_get4(k, from)).with({ _tag: "Some" }, ({ value: v }) => mergeMissing(rest, from, _Map_has2(k, into) ? into : _Map_set3(k, v, into))).with({ _tag: "None" }, () => mergeMissing(rest, from, into)).exhaustive()).otherwise(() => {
  throw new Error("non-exhaustive match");
}));
var checkWith = _curry12(3, (stmts, imported, quals) => match11(checkReservedNames(stmts)).with({ _tag: "Some" }, ({ value: e }) => Err7(e)).with({ _tag: "None" }, () => match11(checkReservedWords(stmts)).with({ _tag: "Some" }, ({ value: e }) => Err7(e)).with({ _tag: "None" }, () => match11(checkCtorFieldVars(stmts)).with({ _tag: "Some" }, ({ value: e }) => Err7(e)).with({ _tag: "None" }, () => match11(checkQualifiedTypeNames(stmts, quals)).with({ _tag: "Some" }, ({ value: e }) => Err7(e)).with({ _tag: "None" }, () => match11(checkLoops(stmts)).with({ _tag: "Some" }, ({ value: e }) => Err7(e)).with({ _tag: "None" }, () => _Result_flatMap6((reg0) => ((reg) => match11(firstSome((s) => match11(s).with({ _tag: "SLet" }, ({ value }) => checkExpr(value, reg)).with({ _tag: "SExpr" }, ({ value }) => checkExpr(value, reg)).otherwise(() => None11), stmts)).with({ _tag: "Some" }, ({ value: e }) => Err7(e)).with({ _tag: "None" }, () => Ok8(stmts)).exhaustive())({ ctors: mergeMissing(_Map_keys4(imported.ctors), imported.ctors, reg0.ctors), types: mergeMissing(_Map_keys4(imported.types), imported.types, reg0.types) }), buildRegistry(stmts))).exhaustive()).exhaustive()).exhaustive()).exhaustive()).exhaustive());
var checkAllWith = _curry12(3, (stmts, imported, quals) => match11(buildRegistry(stmts)).with({ _tag: "Err" }, ({ error: e }) => ((errors) => eq11(length9(errors), 0) ? Ok8(stmts) : Err7(errors))([...checkReservedNamesAll(stmts), ...checkReservedWordsAll(stmts), ...checkCtorFieldVarsAll(stmts), ...checkQualifiedTypeNamesAll(stmts, quals), ...checkLoopsAll(stmts), e])).with({ _tag: "Ok" }, ({ value: reg0 }) => ((reg) => ((errors) => eq11(length9(errors), 0) ? Ok8(stmts) : Err7(errors))([...checkReservedNamesAll(stmts), ...checkReservedWordsAll(stmts), ...checkCtorFieldVarsAll(stmts), ...checkQualifiedTypeNamesAll(stmts, quals), ...checkLoopsAll(stmts), ..._Array_flatMap2((stmt) => match11(stmt).with({ _tag: "SLet" }, ({ value }) => checkExprs(value, reg)).with({ _tag: "SExpr" }, ({ value }) => checkExprs(value, reg)).otherwise(() => []), stmts)]))({ ctors: mergeMissing(_Map_keys4(imported.ctors), imported.ctors, reg0.ctors), types: mergeMissing(_Map_keys4(imported.types), imported.types, reg0.types) })).exhaustive());
var checkAll = (stmts) => checkAllWith(stmts, { ctors: new Map, types: new Map }, emptyQuals);

import { Err as Err8, None as None15, Ok as Ok9, Some as Some15, _Array_append as _Array_append10, _Array_concat as _Array_concat4, _Array_flatMap as _Array_flatMap3, _Array_get as _Array_get12, _Array_head as _Array_head4, _Array_prepend as _Array_prepend6, _Array_reverse, _Map_delete, _Map_get as _Map_get6, _Map_getOr as _Map_getOr5, _Map_has as _Map_has4, _Map_keys as _Map_keys5, _Map_set as _Map_set6, _Option_map, _Option_unwrapOr as _Option_unwrapOr7, _Result_flatMap as _Result_flatMap7, _Result_map as _Result_map6, _Set_add as _Set_add5, _Set_fromArray as _Set_fromArray5, _Set_has as _Set_has4, _Set_size, _Set_toArray as _Set_toArray2, _Str_length as _Str_length4, _Str_replace, _Str_split as _Str_split2, _Str_startsWith as _Str_startsWith3, _curry as _curry16, _done as _done7, _recur as _recur7, _tuple as _tuple8, and as and10, eq as eq14, length as length11, map as map8, not as not8, or as or7, reduce as reduce2 } from "@mochi/compiler/runtime";
import { match as match15 } from "@onrails/pattern";

import { _Array_get as _Array_get10, _Set_add as _Set_add2, _Set_fromArray as _Set_fromArray2, _curry as _curry13 } from "@mochi/compiler/runtime";
import { match as match12 } from "@onrails/pattern";
var addNames = _curry13(2, (names, out) => match12(names).with((_v) => _v.length === 0, () => out).with((_v) => _v.length >= 1, ([n, ...rest]) => addNames(rest, _Set_add2(n, out))).otherwise(() => {
  throw new Error("non-exhaustive match");
}));
var patternNamesOpt = _curry13(2, (p, out) => match12(p).with({ _tag: "None" }, () => out).with({ _tag: "Some" }, ({ value: pat }) => patternNames(pat, out)).exhaustive());
var patternNamesAll = _curry13(2, (pats, out) => match12(pats).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => out).with((_v) => {
  const _g = _v;
...
var patternNamesFields = _curry13(2, (fields, out) => match12(fields).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => out).with((_v) => {
  const _g = _v;
...
var exprNamesOpt = _curry13(2, (e, out) => match12(e).with({ _tag: "None" }, () => out).with({ _tag: "Some" }, ({ value: ex }) => exprNames(ex, out)).exhaustive());
var seqNames = _curry13(2, (elems, out) => match12(elems).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => out).with((_v) => {
  const _g = _v;
...
var fieldNames = _curry13(2, (fields, out) => match12(fields).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => out).with((_v) => {
  const _g = _v;
...
var entryNames = _curry13(2, (entries, out) => match12(entries).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => out).with((_v) => {
  const _g = _v;
...
var interpNames = _curry13(2, (parts, out) => match12(parts).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => out).with((_v) => {
  const _g = _v;
...
var armNames = _curry13(2, (arms, out) => match12(arms).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => out).with((_v) => {
  const _g = _v;
...
var loopParamNames = _curry13(2, (params, out) => match12(params).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => out).with((_v) => {
  const _g = _v;
  return _g.length >= 1;
}, ([p, ...rest]) => loopParamNames(rest, exprNames(p.init, _Set_add2(p.name, out)))).otherwise(() => {
  throw new Error("non-exhaustive match");
}));
var paramNames = _curry13(2, (p, out) => match12(p).with({ _tag: "LPSpanned" }, ({ param: inner }) => paramNames(inner, out)).with({ _tag: "LPName" }, ({ name }) => _Set_add2(name, out)).with({ _tag: "LPTuple" }, ({ names }) => addNames(names, out)).with({ _tag: "LPRecord" }, ({ fields }) => addNames(fields, out)).with({ _tag: "LPLabeled" }, ({ name, defaultValue }) => exprNamesOpt(defaultValue, _Set_add2(name, out))).exhaustive());
var paramNamesAll = _curry13(2, (params, out) => match12(params).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => out).with((_v) => {
  const _g = _v;
...
var localBinderNames = (stmts) => namesFromStmts(stmts, 0, _Set_fromArray2([]));

import { _Array_contains as _Array_contains3, _Array_prepend as _Array_prepend5, _Map_get as _Map_get5, _Map_getOr as _Map_getOr3, _Map_set as _Map_set4, _Map_values, _Set_add as _Set_add3, _Set_diff, _Set_fromArray as _Set_fromArray3, _Set_has as _Set_has2, _Set_toArray, _Str_codeAt as _Str_codeAt6, _curry as _curry14, _tuple as _tuple7, and as and9, map as map7 } from "@mochi/compiler/runtime";
...
var collectRow = _curry14(2, (row, acc) => match13(row).with({ _tag: "RowVar" }, ({ id }) => ({ tv: acc.tv, rv: _Set_add3(id, acc.rv) })).with({ _tag: "RowExtend" }, ({ fieldType, rest }) => collectRow(rest, collect(fieldType, acc))).with({ _tag: "RowEmpty" }, () => acc).exhaustive());
var freeInType = (t) => collect(t, emptyVarSets);
var collectFree = _curry14(4, (t, bound, st, acc) => match13(t).with({ _tag: "TyVar" }, ({ id }) => _Set_has2(id, bound.tv) ? acc : match13(_Map_get5(id, st.tv)).with({ _tag: "Some" }, ({ value: next }) => collectFree(next, bound, st, acc)).with({ _tag: "None" }, () => ({ tv: _Set_add3(id, acc.tv), rv: acc.rv })).exhaustive()).with({ _tag: "TyCon" }, ({ args }) => collectFreeArgs(args, bound, st, acc)).with({ _tag: "TyFn" }, ({ from: fromT, to: toT }) => collectFree(toT, bound, st, collectFree(fromT, bound, st, acc))).with({ _tag: "TyRecord" }, ({ row }) => collectFreeRow(row, bound, st, acc)).with({ _tag: "TySingleton" }, () => acc).with({ _tag: "TyOneOf" }, ({ members }) => collectFreeArgs(members, bound, st, acc)).exhaustive());
...
var collectFreeRow = _curry14(4, (row, bound, st, acc) => match13(row).with({ _tag: "RowVar" }, ({ id }) => _Set_has2(id, bound.rv) ? acc : match13(_Map_get5(id, st.rv)).with({ _tag: "Some" }, ({ value: next }) => collectFreeRow(next, bound, st, acc)).with({ _tag: "None" }, () => ({ tv: acc.tv, rv: _Set_add3(id, acc.rv) })).exhaustive()).with({ _tag: "RowExtend" }, ({ fieldType, rest }) => collectFreeRow(rest, bound, st, collectFree(fieldType, bound, st, acc))).with({ _tag: "RowEmpty" }, () => acc).exhaustive());
var freeInScheme = _curry14(3, (sc, st, acc) => collectFree(sc.ty, { tv: _Set_fromArray3(sc.vars), rv: _Set_fromArray3(sc.rvars) }, st, acc));
...
var isUpperStart2 = (s) => match13(_Str_codeAt6(0, s)).with({ _tag: "Some" }, ({ value: c }) => and9(c >= 65, c <= 90)).with({ _tag: "None" }, () => false).exhaustive();
...
var typeExprName = _curry14(5, (name, vars, st, aliases, expanding) => _Array_contains3(name, primTypeNames) ? _tuple7(primType(name), vars, st) : match13(_Map_get5(name, vars)).with({ _tag: "Some" }, ({ value: v }) => _tuple7(v, vars, st)).with({ _tag: "None" }, () => match13(_Map_get5(name, aliases)).with({ _tag: "Some" }, ({ value: info }) => (([t, st1]) => _tuple7(t, vars, st1))(aliasRow(name, info, [], st, aliases, expanding))).with({ _tag: "None" }, () => isUpperStart2(name) ? _tuple7(tPrim(name), vars, st) : (([v, st1]) => _tuple7(v, _Map_set4(name, v, vars), st1))(freshVar(st))).exhaustive()).exhaustive());
var typeExprToType = _curry14(5, (te, vars, st, aliases, expanding) => match13(te).with({ _tag: "TyArrow" }, ({ from: fromTe, to: toTe }) => (([fromT, vars1, st1]) => (([toT, vars2, st2]) => _tuple7(tArrow(fromT, toT), vars2, st2))(typeExprToType(toTe, vars1, st1, aliases, expanding)))(typeExprToType(fromTe, vars, st, aliases, expanding))).with({ _tag: "TyApp" }, ({ ctor, args: argTes }) => (([args, vars1, st1]) => match13(_Map_get5(ctor, aliases)).with({ _tag: "Some" }, ({ value: info }) => (([t, st2]) => _tuple7(t, vars1, st2))(aliasRow(ctor, info, args, st1, aliases, expanding))).with({ _tag: "None" }, () => _tuple7(tCon(ctor, args), vars1, st1)).exhaustive())(typeExprListToType(argTes, vars, st, aliases, expanding))).with({ _tag: "TyTuple" }, ({ elems: elemTes }) => (([elems, vars1, st1]) => _tuple7(tTuple(elems), vars1, st1))(typeExprListToType(elemTes, vars, st, aliases, expanding))).with({ _tag: "TyList" }, ({ elem: elemTe }) => (([elemT, vars1, st1]) => _tuple7(tCon("Array", [elemT]), vars1, st1))(typeExprToType(elemTe, vars, st, aliases, expanding))).with({ _tag: "TyName" }, ({ name }) => typeExprName(name, vars, st, aliases, expanding)).with({ _tag: "TyQual" }, ({ alias, name, args: argTes }) => (([args, vars1, st1]) => match13(_Map_get5(`${alias}.${name}`, aliases)).with({ _tag: "Some" }, ({ value: info }) => (([t, st2]) => _tuple7(t, vars1, st2))(aliasRow(name, info, args, st1, aliases, expanding))).with({ _tag: "None" }, () => _tuple7(tCon(name, args), vars1, st1)).exhaustive())(typeExprListToType(argTes, vars, st, aliases, expanding))).with({ _tag: "TyLit" }, ({ value }) => _tuple7(tLit(value), vars, st)).with({ _tag: "TyUnion" }, ({ members }) => (([ts, vars1, st1]) => _tuple7(tUnion(ts), vars1, st1))(typeExprListToType(members, vars, st, aliases, expanding))).exhaustive());
...
var aliasRow = _curry14(6, (name, info, args, st, aliases, expanding) => _Set_has2(name, expanding) ? _tuple7(tCon(name, args), st) : match13(info.expr).with({ _tag: "Some" }, ({ value: te }) => (([local, st1]) => (([t, _, st2]) => _tuple7(t, st2))(typeExprToType(te, local, st1, aliases, _Set_add3(name, expanding))))(aliasLocalVarsFrom(info.params, args, st))).with({ _tag: "None" }, () => (([local, st1]) => {
  const next = _Set_add3(name, expanding);
...
var ctorFieldsArrowFrom = _curry14(5, (fields, pvars, st, aliases, result) => match13(fields).with((_v) => {
  ...
  const _g = _v;
  return _g.length >= 1;
}, ([fld, ...rest]) => (([ft, _, st1]) => (([restT, st2]) => _tuple7(tArrow(ft, restT), st2))(ctorFieldsArrowFrom(rest, pvars, st1, aliases, result)))(typeExprToType(fld.fieldType, pvars, st, aliases, _Set_fromArray3([])))).otherwise(() => {
  throw new Error("non-exhaustive match");
}));
...
var connect = _curry15(3, (v, adj, st) => {
  ...
  return eq13(lowOfV(v, st2), indexOfV(v, st2)) ? ((start) => ((comp) => ({ ...st2, onStack: _Set_diff2(st2.onStack, _Set_fromArray4(comp)), stack: _Array_take2(start, st2.stack), sccs: _Array_append9(comp, st2.sccs) }))(_Array_drop3(start, st2.stack)))(indexOfFrom(v, st2.stack, 0)) : st2;
});
...
var shownOfAlias = _curry16(2, (info, aliases) => not8(eq14(length11(info.params), 0)) ? None15 : match15(info.expr).with({ _tag: "Some" }, () => None15).with({ _tag: "None" }, () => eq14(length11(info.fields), 0) ? None15 : Some15(showType(tRecord(aliasRowFrom(info.fields, aliases, 0))))).exhaustive());
...
var u = _curry16(5, (ctx, left, right, st, sp) => match15(unify(left, right, st)).with({ _tag: "Ok" }, ({ value: newSt }) => Ok9(newSt)).with({ _tag: "Err" }, ({ error: e }) => Err8(typeErr(nameAliases(e.message, ctx.aliasMap), sp))).exhaustive());
var checkFits = _curry16(5, (ctx, actual, expected, st, sp) => match15(fits(actual, expected, st)).with({ _tag: "Ok" }, ({ value: newSt }) => Ok9(newSt)).with({ _tag: "Err" }, ({ error: e }) => Err8(typeErr(nameAliases(e.message, ctx.aliasMap), sp))).exhaustive());
...
var inferNormalCall = _curry16(4, (ctx, fn, args, st) => _Result_flatMap7(([fnT, st1]) => match15(args).with((_v) => {
  const _g = _v;
  return _g.length === 0;
...
var inferQuestionBind = _curry16(8, (ctx, bind, param, paramSpan, value, body, valT, st) => match15(resolve(valT, st)).with({ _tag: "TyVar" }, () => (($written) => inferTwoSlotBind(ctx, param, paramSpan, value, body, valT, "Result", st))(setLetBindMonad(bind, "Result"))).with({ _tag: "TyCon" }, ({ name }) => eq14(name, "Option") ? (($written) => (([payloadT, st1]) => _Result_flatMap7((st2) => inferBindBody(ctx, param, paramSpan, body, payloadT, (resT) => tCon("Option", [resT]), st2), u(ctx, valT, tCon("Option", [payloadT]), st1, exprSpan3(value))))(freshVar(st)))(setLetBindMonad(bind, "Option")) : eq14(name, "Result") ? (($written) => inferTwoSlotBind(ctx, param, paramSpan, value, body, valT, "Result", st))(setLetBindMonad(bind, "Result")) : Err8(typeErr(`let? requires Option or Result, got ${showType(zonk(valT, st))}`, exprSpan3(value)))).otherwise(() => Err8(typeErr(`let? requires Option or Result, got ${showType(zonk(valT, st))}`, exprSpan3(value)))));
...
var inferFieldAccess = _curry16(6, (ctx, field, target, name, sp, st) => _Result_flatMap7(([targetT, st1]) => ((zonked) => match15(zonked).with({ _tag: "TyRecord" }, ({ row }) => match15(lookupField(row, name)).with((_v) => {
  const _g = _v;
  return _g._tag === "Some";
}, ({ value: [ft, optional] }) => optional ? (($written) => Ok9(_tuple8(tCon("Option", [ft]), st1)))(setFieldOptional(field, true)) : Ok9(_tuple8(ft, st1))).with({ _tag: "None" }, () => rowEndsEmpty(row) ? Err8(typeErr(`record missing field '${name}'`, sp)) : inferDuckField(ctx, targetT, name, sp, st1)).exhaustive()).otherwise(() => inferDuckField(ctx, targetT, name, sp, st1)))(zonk(targetT, st1)), inferExpr(ctx, target, st)));
...
var inferNsField = _curry16(5, (ctx, tname, name, sp, st) => match15(_Map_get6(name, _Map_getOr5(new Map, tname, ctx.ns))).with({ _tag: "Some" }, ({ value: sc }) => (([t, st1]) => Ok9(_tuple8(t, st1)))(instantiate(sc, st))).with({ _tag: "None" }, () => Err8(typeErr(`'${tname}' has no member '${name}'`, sp))).exhaustive());
...
var patternBinds = (p) => match15(p).with({ _tag: "PAs" }, ({ pat, name }) => _Array_append10(name, patternBinds(pat))).with({ _tag: "PBind" }, ({ name }) => [name]).with({ _tag: "PRecord" }, ({ fields }) => _Array_flatMap3((f) => patternBinds(f.pat), fields)).with({ _tag: "PCtor" }, ({ args }) => _Array_flatMap3(patternBinds, args)).with({ _tag: "PTuple" }, ({ elems }) => _Array_flatMap3(patternBinds, elems)).with({ _tag: "PArr" }, ({ elems, rest }) => _Array_concat4(_Array_flatMap3(patternBinds, elems), patternBindsOpt(rest))).with({ _tag: "PList" }, ({ elems, rest }) => _Array_concat4(_Array_flatMap3(patternBinds, elems), patternBindsOpt(rest))).with({ _tag: "POr" }, ({ alts }) => match15(_Array_head4(alts)).with({ _tag: "Some" }, ({ value: first }) => patternBinds(first)).with({ _tag: "None" }, () => []).exhaustive()).otherwise(() => []);
...
var noteGroupLets = _curry16(3, (group, letOwner, st) => match15(group).with((_v) => {
  ...
  const _g = _v;
  return _g._tag === "SLet" && (({ name, value }) => not8(_Str_startsWith3("$", name)))(_g);
...
import { None as None16, Some as Some16, _Array_append as _Array_append11, _Array_concat as _Array_concat5, _Array_get as _Array_get13, _Array_head as _Array_head5, _Array_prepend as _Array_prepend7, _Map_get as _Map_get7, _Map_getOr as _Map_getOr6, _Map_keys as _Map_keys6, _Option_contains as _Option_contains3, _Option_exists as _Option_exists4, _Option_isSome as _Option_isSome3, _Option_unwrapOr as _Option_unwrapOr8, _Set_add as _Set_add6, _Set_fromArray as _Set_fromArray6, _Set_has as _Set_has5, _Set_toArray as _Set_toArray3, _Set_union, _Str_chars, _Str_codeAt as _Str_codeAt7, _Str_concat as _Str_concat2, _Str_endsWith as _Str_endsWith2, _Str_join as _Str_join5, _Str_length as _Str_length5, _Str_replace as _Str_replace2, _Str_slice as _Str_slice3, _Str_split as _Str_split3, _Str_startsWith as _Str_startsWith4, _curry as _curry17, _done as _done8, _recur as _recur8, _tuple as _tuple9, and as and11, concat, eq as eq15, filter as filter4, length as length12, map as map9, not as not9, or as or8, reduce as reduce3, show as show6 } from "@mochi/compiler/runtime";
...
var keyAt = _curry17(3, (ctx, ctor, i) => match16(_Map_get7(ctor, ctx.keys)).with({ _tag: "Some" }, ({ value: ks }) => _Option_unwrapOr8(`_${show6(i)}`, _Array_get13(i, ks))).with({ _tag: "None" }, () => `_${show6(i)}`).exhaustive());
...
var absorbParams = _curry17(4, (params, acc, fills, labN) => (([positional, labeled]) => {
  ...
  return match16(labeled).with((_v) => {
    const _g = _v;
    return _g.length === 0;
  }, () => _tuple9(acc1, fills, labN)).otherwise(() => ((labVar) => _tuple9(_Array_append11(LPName(labVar, None16), acc1), _Array_append11({ labVar, labs: labeled }, fills), labN + 1))(eq15(labN, 0) ? "$lab" : `$lab${show6(labN)}`));
...
var tsInfix = _curry17(3, (ctx, fn, args) => not9(ctx.preserveInfix) ? None16 : match16(_tuple9(fn, args)).with((_v) => {
  const _g = _v;
...
var genExpr = _curry17(2, (ctx, e) => match16(e).with({ _tag: "ENum" }, ({ raw }) => raw).with({ _tag: "EUnit" }, () => "undefined").with({ _tag: "EBool" }, ({ value }) => value ? "true" : "false").with({ _tag: "EStr" }, ({ value }) => jsStringLit(value)).with({ _tag: "ERef" }, ({ name }) => castOr(name, isNullaryCtor(name, ctx.keys) ? hook1(ctx.annotateEmpty, e) : None16)).with({ _tag: "ECall" }, ({ fn, args, origin }) => match16(tsxCall(ctx, fn, args, origin)).with({ _tag: "Some" }, ({ value: jsx }) => jsx).with({ _tag: "None" }, () => match16(tsInfix(ctx, fn, args)).with({ _tag: "Some" }, ({ value: infix }) => infix).with({ _tag: "None" }, () => ((inner) => castOr(inner, isCtorRef(fn) ? hook1(ctx.annotateCall, e) : None16))(`${genCallee(ctx, fn)}(${_Str_join5(", ", map9((a) => genExpr(ctx, a), args))})`)).exhaustive()).exhaustive()).with({ _tag: "ELambda" }, ({ params, body, span: sp }) => (([cparams, cbody, fills]) => {
  ...
  return length12(cparams) >= 2 ? `_curry(${show6(length12(cparams))}, ${arrow})` : arrow;
...
}, ({ fn: rfn, args: rargs }) => `${genCallee(ctx, rfn)}(${_Str_join5(", ", map9((a) => genExpr(ctx, a), _Array_append11(left, rargs)))})`).otherwise(() => `${genCallee(ctx, right)}(${genExpr(ctx, left)})`)).with({ _tag: "EDo" }, ({ exprs }) => genDo(ctx, exprs)).with({ _tag: "ETernary" }, ({ cond, thenE, elseE }) => `(${genExpr(ctx, cond)} ? ${genExpr(ctx, thenE)} : ${genExpr(ctx, elseE)})`).with({ _tag: "EMatch" }, ({ scrutinee, arms }) => genMatch(ctx, scrutinee, arms)).with({ _tag: "ELoop" }, ({ params, body }) => `(() => { ${genLoopBlock(ctx, params, body)} })()`).with({ _tag: "ERecur" }, ({ args }) => `_recur(${_Str_join5(", ", map9((a) => genExpr(ctx, a), args))})`).with({ _tag: "ERecord" }, ({ fields, spread }) => ((fieldStrs) => match16(spread).with({ _tag: "None" }, () => eq15(length12(fields), 0) ? "{}" : `{ ${fieldStrs} }`).with({ _tag: "Some" }, ({ value: s }) => ((spreadStr) => eq15(length12(fields), 0) ? `{ ${spreadStr} }` : `{ ${spreadStr}, ${fieldStrs} }`)(`...${genExpr(ctx, s)}`)).exhaustive())(_Str_join5(", ", map9((f) => `${isJsIdent(f.name) ? f.name : jsStringLit(f.name)}: ${genExpr(ctx, f.value)}`, fields)))).with({ _tag: "EField" }, ({ target, name, optional }) => match16(emptyNsEmit(target, name, hook1(ctx.annotateEmpty, e))).with({ _tag: "Some" }, ({ value: js }) => js).with({ _tag: "None" }, () => match16(nsRuntimeId(ctx, target, name)).with({ _tag: "Some" }, ({ value: rt }) => rt).with({ _tag: "None" }, () => ((member) => optional ? `((v) => v != null ? { _tag: "Some", value: v } : { _tag: "None" })(${member})` : member)(`${genMember(ctx, target)}.${name}`)).exhaustive()).exhaustive()).with({ _tag: "ETuple" }, ({ elements }) => ((elems) => ctx.tupleHelper ? `_tuple(${elems})` : `[${elems}]`)(_Str_join5(", ", map9((el) => genExpr(ctx, el), elements)))).with({ _tag: "EArr" }, ({ elements }) => ((body) => castOr(body, eq15(length12(elements), 0) ? hook1(ctx.annotateEmpty, e) : None16))(`[${_Str_join5(", ", map9((el) => genSeqSlot(ctx, el), elements))}]`)).with({ _tag: "EList" }, ({ elements }) => genList(ctx, elements)).with({ _tag: "ESet" }, ({ elements }) => `new Set([${_Str_join5(", ", map9((el) => genSeqSlot(ctx, el), elements))}])`).with({ _tag: "EMap" }, ({ entries }) => match16(eq15(length12(entries), 0) ? hook1(ctx.annotateEmpty, e) : None16).with({ _tag: "Some" }, ({ value: t }) => `new ${t}()`).with({ _tag: "None" }, () => `new Map([${_Str_join5(", ", map9((en) => `[${genExpr(ctx, en.key)}, ${genExpr(ctx, en.value)}]`, entries))}])`).exhaustive()).with({ _tag: "EInterp" }, ({ parts }) => ((body) => `\`${body}\``)(_Str_join5("", map9((p) => match16(p).with({ _tag: "IPLit" }, ({ value }) => escapeTemplateLiteral(value)).with({ _tag: "IPExpr" }, ({ expr: ex }) => `\${${genExpr(ctx, ex)}}`).exhaustive(), parts)))).exhaustive());
...
var genList = _curry17(2, (ctx, elements) => {
  const yields = _Str_join5(" ", map9((el) => match16(el).with({ _tag: "SEExpr" }, ({ expr: ex }) => `yield (${genExpr(ctx, ex)});`).with({ _tag: "SESpread" }, ({ expr: ex }) => `yield* (${genExpr(ctx, ex)});`).exhaustive(), elements));
  return `_list(function* () {${eq15(yields, "") ? "" : ` ${yields} `}})`;
});
var genParam = (p) => match16(p).with({ _tag: "LPSpanned" }, ({ param: inner }) => genParam(inner)).with({ _tag: "LPName" }, ({ name }) => name).with({ _tag: "LPTuple" }, ({ names }) => `[${_Str_join5(", ", names)}]`).with({ _tag: "LPRecord" }, ({ fields }) => `{ ${_Str_join5(", ", fields)} }`).with({ _tag: "LPLabeled" }, ({ name }) => name).exhaustive();
...
var loopParamNames2 = (params) => _Str_join5(", ", map9((p) => p.name, params));
...
}, ([[p], [a]]) => `${p.name} = ${genExpr(ctx, a)}; continue;`).otherwise(() => `[${loopParamNames2(params)}] = [${_Str_join5(", ", map9((a) => genExpr(ctx, a), args))}]; continue;`)).with({ _tag: "ETernary" }, ({ cond, thenE, elseE }) => hasRecur(e) ? `if (${genExpr(ctx, cond)}) { ${genLoopTail(ctx, thenE, params)} } else { ${genLoopTail(ctx, elseE, params)} }` : `return ${genExpr(ctx, e)};`).with({ _tag: "ELetIn" }, ({ name, value, body }) => hasRecur(e) ? `{ const ${suffixOr(name, hook1(ctx.annotateLetin, value))} = ${genExpr(ctx, value)}; ${genLoopTail(ctx, body, params)} }` : `return ${genExpr(ctx, e)};`).with({ _tag: "EDo" }, ({ exprs }) => hasRecur(e) ? `{ ${genDoLoopTail(ctx, exprs, params)} }` : `return ${genExpr(ctx, e)};`).with({ _tag: "EMatch" }, ({ span: sp }) => hasRecur(e) ? ((step) => ((rebind) => `const _step = ${step}; if (_step._tag === ${jsStringLit("recur")}) { ${rebind} continue; } return _step.value;`)(match16(params).with((_v) => {
  const _g = _v;
  return _g.length === 1;
...
var isCatchAll2 = (p) => match16(p).with({ _tag: "PAs" }, ({ pat }) => isCatchAll2(pat)).with({ _tag: "PWild" }, () => true).with({ _tag: "PUnit" }, () => true).with({ _tag: "PBind" }, () => true).with({ _tag: "PRecord" }, ({ fields }) => allOf2((f) => isCatchAll2(f.pat), fields)).with({ _tag: "PTuple" }, ({ elems }) => allOf2(isCatchAll2, elems)).with({ _tag: "PArr" }, ({ elems, rest }) => and11(eq15(length12(elems), 0), _Option_isSome3(rest))).with({ _tag: "PList" }, ({ elems, rest }) => and11(eq15(length12(elems), 0), _Option_isSome3(rest))).otherwise(() => false);
...
var patSlot = _curry17(2, (ctx, p) => match16(p).with({ _tag: "PAs" }, ({ pat, name }) => ((inner) => eq15(inner, "") ? name : `${inner}, ${name}`)(patSlot(ctx, pat))).with({ _tag: "PBind" }, ({ name }) => name).with({ _tag: "PWild" }, () => "").with({ _tag: "PUnit" }, () => "").with({ _tag: "PLit" }, () => "").with({ _tag: "PBool" }, () => "").with({ _tag: "PStr" }, () => "").with({ _tag: "PList" }, () => "").with({ _tag: "PCtor" }, ({ ctor, args }) => ((entries) => eq15(length12(entries), 0) ? "" : `{ ${_Str_join5(", ", entries)} }`)(pctorEntries(ctx, ctor, args, 0))).with({ _tag: "PRecord" }, ({ fields }) => ((entries) => eq15(length12(entries), 0) ? "" : `{ ${_Str_join5(", ", entries)} }`)(precordEntries(ctx, fields, 0))).with({ _tag: "PTuple" }, ({ elems }) => ((slots) => someOf3((s) => not9(eq15(s, "")), slots) ? `[${_Str_join5(", ", slots)}]` : "")(map9((el) => patSlot(ctx, el), elems))).with({ _tag: "PArr" }, ({ elems, rest }) => ((slots) => ((slots2) => someOf3((s) => not9(eq15(s, "")), slots2) ? `[${_Str_join5(", ", slots2)}]` : "")(match16(rest).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "PBind";
...
var pctorConds = _curry17(5, (ctx, ctor, args, i, path) => match16(_Array_get13(i, args)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: a }) => _Array_concat5(patConds(ctx, a, `${path}.${keyAt(ctx, ctor, i)}`), pctorConds(ctx, ctor, args, i + 1, path))).exhaustive());
var precordConds = _curry17(4, (ctx, fields, i, path) => match16(_Array_get13(i, fields)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: f }) => _Array_concat5(patConds(ctx, f.pat, `${path}.${f.label}`), precordConds(ctx, fields, i + 1, path))).exhaustive());
var ptupleConds = _curry17(4, (ctx, elems, i, path) => match16(_Array_get13(i, elems)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: el }) => _Array_concat5(patConds(ctx, el, `${path}[${show6(i)}]`), ptupleConds(ctx, elems, i + 1, path))).exhaustive());
var parrConds = _curry17(4, (ctx, elems, i, path) => match16(_Array_get13(i, elems)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: el }) => _Array_concat5(patConds(ctx, el, `${path}[${show6(i)}]`), parrConds(ctx, elems, i + 1, path))).exhaustive());
var patConds = _curry17(3, (ctx, p, path) => match16(p).with({ _tag: "PAs" }, ({ pat }) => patConds(ctx, pat, path)).with({ _tag: "PWild" }, () => []).with({ _tag: "PUnit" }, () => []).with({ _tag: "PBind" }, () => []).with({ _tag: "PList" }, () => []).with({ _tag: "PLit" }, () => [`${path} === ${litValue(p)}`]).with({ _tag: "PBool" }, () => [`${path} === ${litValue(p)}`]).with({ _tag: "PStr" }, () => [`${path} === ${litValue(p)}`]).with({ _tag: "PCtor" }, ({ ctor, args }) => _Array_prepend7(`${path}._tag === ${jsStringLit(ctor)}`, pctorConds(ctx, ctor, args, 0, path))).with({ _tag: "PRecord" }, ({ fields }) => precordConds(ctx, fields, 0, path)).with({ _tag: "PTuple" }, ({ elems }) => ptupleConds(ctx, elems, 0, path)).with({ _tag: "PArr" }, ({ elems, rest }) => _Array_prepend7(`${path}.length ${_Option_isSome3(rest) ? ">=" : "==="} ${show6(length12(elems))}`, parrConds(ctx, elems, 0, path))).with({ _tag: "POr" }, ({ alts }) => ((altCond) => [_Str_join5(" || ", map9((alt) => `(${altCond(alt)})`, alts))])((alt) => {
  const conds = patConds(ctx, alt, path);
  return eq15(length12(conds), 0) ? "true" : _Str_join5(" && ", map9((c) => `(${c})`, conds));
})).exhaustive());
...
var isListMatch = (arms) => someOf3((a) => and11(isPList2(a.pattern), not9(isCatchAll2(a.pattern))), arms);
...
var listArmGuards = _curry17(3, (ctx, elems, i) => match16(_Array_get13(i, elems)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: el }) => _Array_concat5(patConds(ctx, el, `_b[${show6(i)}]`), listArmGuards(ctx, elems, i + 1))).exhaustive());
var listArmBinds = _curry17(3, (ctx, elems, i) => match16(_Array_get13(i, elems)).with({ _tag: "None" }, () => _tuple9([], [])).with({ _tag: "Some" }, ({ value: el }) => (([restParams, restArgs]) => {
  ...
  return eq15(slot, "") ? _tuple9(restParams, restArgs) : _tuple9(_Array_prepend7(slot, restParams), _Array_prepend7(`_b[${show6(i)}]`, restArgs));
})(listArmBinds(ctx, elems, i + 1))).exhaustive());
var genListArm = _curry17(3, (ctx, p, body) => match16(p).with({ _tag: "PList" }, ({ elems, rest }) => ((n) => ((guards) => ((head) => ((cond) => (([params0, args0]) => (([params, args]) => `  if (${cond}) return ((${_Str_join5(", ", params)}) => ${genLambdaBody(ctx, body)})(${_Str_join5(", ", args)});`)(match16(rest).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "PBind";
}, ({ value: { name } }) => _tuple9(_Array_append11(name, params0), _Array_append11(listTail(n), args0))).otherwise(() => _tuple9(params0, args0))))(listArmBinds(ctx, elems, 0)))(_Str_join5(" && ", _Array_prepend7(head, guards))))(_Option_isSome3(rest) ? `_pull(${show6(n)})` : `!_pull(${show6(n + 1)}) && _b.length === ${show6(n)}`))(listArmGuards(ctx, elems, 0)))(length12(elems))).otherwise(() => ""));
var listMatchLoop = _curry17(3, (ctx, arms, i) => match16(_Array_get13(i, arms)).with({ _tag: "None" }, () => _tuple9([], '(() => { throw new Error("non-exhaustive lazy-list switch"); })()')).with({ _tag: "Some" }, ({ value: a }) => and11(isPList2(a.pattern), not9(isCatchAll2(a.pattern))) ? (([restLines, fallback]) => _tuple9(_Array_prepend7(genListArm(ctx, a.pattern, a.body), restLines), fallback))(listMatchLoop(ctx, arms, i + 1)) : isCatchAll2(a.pattern) ? ((restName) => ((fallback) => _tuple9([], fallback))(match16(restName).with({ _tag: "Some" }, ({ value: name }) => `((${name}) => ${genLambdaBody(ctx, a.body)})(${listTail(0)})`).with({ _tag: "None" }, () => genExpr(ctx, a.body)).exhaustive()))(match16(a.pattern).with((_v) => {
  const _g = _v;
...
var genMatch = _curry17(3, (ctx, scrutinee, arms) => isListMatch(arms) ? genListMatch(ctx, scrutinee, arms) : ((base) => (([armLines, catchAll]) => {
  const tail = match16(catchAll).with((_v) => {
    const _g = _v;
    return _g._tag === "Some";
  }, ({ value: [p, body] }) => `  .otherwise(${catchAllParam(ctx, p)} => ${genLambdaBody(ctx, body)})`).with({ _tag: "None" }, () => and11(_Option_isSome3(ctx.guardBaseType), hasArrArm(arms)) ? '  .otherwise(() => { throw new Error("non-exhaustive match"); })' : "  .exhaustive()").exhaustive();
  return _Str_join5(`
...
var tupleSlotBase = _curry17(2, (base, i) => `(${base})[${show6(i)}]`);
...
var tupleRefines = _curry17(4, (ctx, elems, base, i) => match16(_Array_get13(i, elems)).with({ _tag: "None" }, () => false).with({ _tag: "Some" }, ({ value: el }) => or8(_Option_isSome3(fieldRefine(ctx, el, tupleSlotBase(base, i))), tupleRefines(ctx, elems, base, i + 1))).exhaustive());
...
var arrRefines = _curry17(4, (ctx, elems, elemBase, i) => match16(_Array_get13(i, elems)).with({ _tag: "None" }, () => false).with({ _tag: "Some" }, ({ value: el }) => or8(_Option_isSome3(fieldRefine(ctx, el, elemBase)), arrRefines(ctx, elems, elemBase, i + 1))).exhaustive());
var patTarget = _curry17(3, (ctx, p, base) => match16(p).with({ _tag: "PAs" }, ({ pat }) => patTarget(ctx, pat, base)).with({ _tag: "PCtor" }, ({ ctor, args }) => ((member) => ((keys) => ((refines) => eq15(length12(refines), 0) ? member : `${member} & { ${_Str_join5("; ", refines)} }`)(ctorRefines(ctx, args, keys, member, 0)))(_Option_unwrapOr8([], _Map_get7(ctor, ctx.keys))))(`Extract<${base}, { _tag: ${jsStringLit(ctor)} }>`)).with({ _tag: "PRecord" }, ({ fields }) => ((refines) => eq15(length12(refines), 0) ? base : `${base} & { ${_Str_join5("; ", refines)} }`)(recordRefines(ctx, fields, base, 0))).with({ _tag: "PTuple" }, ({ elems }) => not9(tupleRefines(ctx, elems, base, 0)) ? base : `[${_Str_join5(", ", tupleTargets(ctx, elems, base, 0))}]`).with({ _tag: "PArr" }, ({ elems, rest: restOpt }) => ((elemBase) => not9(arrRefines(ctx, elems, elemBase, 0)) ? base : ((heads) => match16(restOpt).with({ _tag: "Some" }, () => `[${heads}, ...${base}]`).with({ _tag: "None" }, () => `[${heads}]`).exhaustive())(_Str_join5(", ", arrTargets(ctx, elems, elemBase, 0))))(`(${base})[number]`)).otherwise(() => base));
var genGuardArm = _curry17(5, (ctx, p, body, guardOpt, base) => {
  ...
  const test = eq15(length12(conds), 0) ? "true" : _Str_join5(" && ", conds);
...
var genCtor = _curry17(2, (c, ts) => {
  ...
  return eq15(length12(c.fields), 0) ? match16(ts).with({ _tag: "Some" }, ({ value: t }) => `const ${c.name}: ${t.retMono} = { _tag: ${tag} };`).with({ _tag: "None" }, () => `const ${c.name} = { _tag: ${tag} };`).exhaustive() : ((keys) => ((params) => ((impl) => length12(c.fields) >= 2 ? ((curried) => match16(ts).with({ _tag: "Some" }, ({ value: t }) => `const ${c.name} = ${curried} as ${t.generics}(${_Str_join5(", ", typedCtorParams(keys, t.paramTypes, 0))}) => ${t.ret};`).with({ _tag: "None" }, () => `const ${c.name} = ${curried};`).exhaustive())(`_curry(${show6(length12(c.fields))}, ${impl})`) : match16(ts).with({ _tag: "Some" }, ({ value: t }) => `const ${c.name} = ${t.generics}(${_Str_join5(", ", typedCtorParams(keys, t.paramTypes, 0))}): ${t.ret} => ({ _tag: ${tag}, ${params} });`).with({ _tag: "None" }, () => `const ${c.name} = ${impl};`).exhaustive())(`(${params}) => ({ _tag: ${tag}, ${params} })`))(_Str_join5(", ", keys)))(keysOf(c.fields));
});
...
var genType = _curry17(2, (ctx, s) => match16(s).with({ _tag: "SType" }, ({ ctors, exported }) => _Str_join5(`
...
var externArgs = (n) => {
  ...
  while (true) {
    if (i >= n) {
      ...
      [i, acc] = [i + 1, eq15(acc, "") ? `$a${show6(i)}` : `${acc}, $a${show6(i)}`];
      continue;
    }
  }
};
...
var genImport = _curry17(2, (s, ext) => match16(s).with({ _tag: "SImport" }, ({ names, from }) => ((nameList) => ((path) => `import { ${nameList} } from ${jsStringLit(path)};`)(rewriteImportPath(from, ext)))(_Str_join5(", ", map9((n) => n.name, names)))).with({ _tag: "SImportNs" }, ({ alias, from }) => ((path) => `import * as ${alias.name} from ${jsStringLit(path)};`)(rewriteImportPath(from, ext))).otherwise(() => ""));
...
`, doc)))).exhaustive();
var genStmt = _curry17(2, (ctx, s) => match16(s).with({ _tag: "SError" }, ({ span: sp }) => `throw new Error("codegen invariant: error node reached codegen at ${show6(sp.start)}");`).with({ _tag: "SImport" }, () => genImport(s, ctx.moduleExt)).with({ _tag: "SImportNs" }, () => genImport(s, ctx.moduleExt)).with({ _tag: "SType" }, ({ exported }) => ((decls) => eq15(decls, "") ? "" : exported ? _Str_join5(`
...
var boundNamesFrom = _curry17(3, (stmts, i, acc) => match16(_Array_get13(i, stmts)).with({ _tag: "None" }, () => acc).with({ _tag: "Some" }, ({ value: s }) => boundNamesFrom(stmts, i + 1, match16(s).with({ _tag: "SLet" }, ({ name }) => _Set_add6(name, acc)).with({ _tag: "SExtern" }, ({ name }) => _Set_add6(name, acc)).with({ _tag: "SType" }, ({ ctors }) => _Set_union(acc, _Set_fromArray6(map9((c) => c.name, ctors)))).with({ _tag: "SImport" }, ({ names }) => _Set_union(acc, _Set_fromArray6(map9((n) => n.name, names)))).with({ _tag: "SImportNs" }, ({ alias }) => _Set_add6(alias.name, acc)).with({ _tag: "SError" }, () => acc).with({ _tag: "SExpr" }, () => acc).exhaustive())).exhaustive());
var boundNames = (stmts) => boundNamesFrom(stmts, 0, _Set_fromArray6([]));
...
var runtimeRefNames = _curry17(4, (ctx, stmts, jsDefs, runtimeDeps) => {
  ...
  return filter4((n) => and11(_Set_has5(n, refs), not9(_Set_has5(n, bound))), _Map_keys6(jsDefs));
});
var preludePreamble = _curry17(4, (ctx, stmts, jsDefs, runtimeDeps) => {
  ...
  return eq15(length12(defs), 0) ? "" : `${_Str_join5(`
`, defs)}
...
import { None as None18, Some as Some18, _Array_append as _Array_append13, _Array_concat as _Array_concat7, _Array_contains as _Array_contains4, _Array_dedupeBy, _Array_drop as _Array_drop4, _Array_get as _Array_get15, _Array_prepend as _Array_prepend9, _Array_reverse as _Array_reverse2, _Array_sort as _Array_sort2, _Array_sortBy, _Array_take as _Array_take3, _Map_delete as _Map_delete2, _Map_get as _Map_get9, _Map_keys as _Map_keys7, _Map_set as _Map_set8, _Map_size as _Map_size2, _Map_values as _Map_values2, _Option_flatMap as _Option_flatMap2, _Option_isSome as _Option_isSome4, _Option_map as _Option_map3, _Option_unwrapOr as _Option_unwrapOr10, _Set_add as _Set_add7, _Set_fromArray as _Set_fromArray7, _Set_has as _Set_has6, _Str_contains as _Str_contains2, _Str_fromCode as _Str_fromCode3, _Str_join as _Str_join7, _Str_split as _Str_split4, _Str_startsWith as _Str_startsWith5, _curry as _curry19, _tuple as _tuple11, and as and12, concat as concat2, eq as eq17, filter as filter5, length as length14, map as map11, not as not11, or as or9, reduce as reduce4, show as show8 } from "@mochi/compiler/runtime";
import { match as match18 } from "@onrails/pattern";

import { None as None17, Some as Some17, _Array_append as _Array_append12, _Array_concat as _Array_concat6, _Array_get as _Array_get14, _Array_prepend as _Array_prepend8, _Array_sort, _Map_get as _Map_get8, _Map_set as _Map_set7, _Map_size, _Option_flatMap, _Option_map as _Option_map2, _Option_unwrapOr as _Option_unwrapOr9, _Str_fromCode as _Str_fromCode2, _Str_get as _Str_get4, _Str_join as _Str_join6, _curry as _curry18, _tuple as _tuple10, eq as eq16, length as length13, map as map10, not as not10, show as show7 } from "@mochi/compiler/runtime";
...
var letterAt = (i) => _Option_unwrapOr9(`T${show7(i)}`, _Str_get4(i, letters));
...
var shapeFieldsFrom = _curry18(2, (row, vars) => match17(row).with({ _tag: "RowEmpty" }, () => Some17([])).with({ _tag: "RowVar" }, () => None17).with({ _tag: "RowExtend" }, ({ label, fieldType, optional, rest }) => _Option_map2((fs) => _Array_prepend8(`${label}${optional ? "?" : ""}: ${tsOf(fieldType, plainEnv(vars))}`, fs), shapeFieldsFrom(rest, vars))).exhaustive());
var rowShapeKey = _curry18(2, (row, vars) => _Option_map2((fs) => _Str_join6("; ", _Array_sort(fs)), shapeFieldsFrom(row, vars)));
var aliasNameFor = _curry18(2, (row, env) => eq16(_Map_size(env.recs), 0) ? None17 : _Option_flatMap((k) => _Map_get8(k, env.recs), rowShapeKey(row, env.vars)));
var tsRow = _curry18(2, (row, env) => match17(aliasNameFor(row, env)).with({ _tag: "Some" }, ({ value: alias }) => alias).with({ _tag: "None" }, () => (([fields, tail]) => {
  const body = eq16(length13(fields), 0) ? "{}" : `{ ${_Str_join6("; ", fields)} }`;
...
var tsArrowParams = _curry18(5, (fromT, toT, env, i, params) => {
  ...
  return match17(toT).with((_v) => {
    const _g = _v;
    return _g._tag === "TyFn" && (({ from: nextFrom, to: nextTo }) => not10(isUnit(nextFrom)))(_g);
...
var genericHead = _curry19(3, (params, i, acc) => match18(_Array_get15(i, params)).with({ _tag: "None" }, () => eq17(length14(acc), 0) ? "" : `<${_Str_join7(", ", acc)}>`).with({ _tag: "Some" }, () => genericHead(params, i + 1, _Array_append13(letterAt(i), acc))).exhaustive());
var fieldTs = _curry19(4, (te, params, aliases, recs) => {
  const vars = paramVarsFrom(params, 0);
  const names = paramNamesFrom(params, 0);
  return (([t, _vars, _st]) => tsOf(t, tsEnv(names, recs)))(typeExprToType(te, vars, mkSt(length14(params)), aliases, _Set_fromArray7([])));
});
var ctorFieldsFrom = _curry19(6, (fields, keys, params, aliases, recs, i) => match18(_Array_get15(i, fields)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: fld }) => _Array_prepend9(`${_Option_unwrapOr10(`_${show8(i)}`, _Array_get15(i, keys))}: ${fieldTs(fld.fieldType, params, aliases, recs)}`, ctorFieldsFrom(fields, keys, params, aliases, recs, i + 1))).exhaustive());
var ctorVariant = _curry19(4, (c, params, aliases, recs) => {
  ...
  return eq17(length14(fields), 0) ? `{ _tag: "${c.name}" }` : `{ _tag: "${c.name}"; ${_Str_join7("; ", fields)} }`;
});
...
var recordAliasDecl = _curry19(5, (name, params, fields, aliases, recs) => {
  ...
  return eq17(length14(body), 0) ? `export type ${head} = {};` : `export type ${head} = { ${_Str_join7("; ", body)} };`;
});
...
var unionNamesFrom = _curry19(3, (schemes, i, acc) => match18(_Array_get15(i, schemes)).with({ _tag: "None" }, () => acc).with({ _tag: "Some" }, ({ value: sc }) => ((names) => unionNamesFrom(schemes, i + 1, mergeInto(_Map_keys7(names), names, acc, 0)))(genericNames(sc))).exhaustive());
var unionGenericNames = (schemes) => unionNamesFrom(schemes, 0, new Map);
var allVarsIn = _curry19(2, (t, names) => match18(t).with({ _tag: "TyVar" }, ({ id }) => _Option_isSome4(_Map_get9(id, names))).with({ _tag: "TyCon" }, ({ args }) => allVarsInAll(args, names, 0)).with({ _tag: "TyFn" }, ({ from: fromT, to: toT }) => and12(allVarsIn(fromT, names), allVarsIn(toT, names))).with({ _tag: "TyRecord" }, ({ row }) => allVarsInRow(row, names)).with({ _tag: "TySingleton" }, () => true).with({ _tag: "TyOneOf" }, ({ members }) => allVarsInAll(members, names, 0)).exhaustive());
var allVarsInAll = _curry19(3, (ts, names, i) => match18(_Array_get15(i, ts)).with({ _tag: "None" }, () => true).with({ _tag: "Some" }, ({ value: t }) => and12(allVarsIn(t, names), allVarsInAll(ts, names, i + 1))).exhaustive());
var allVarsInRow = _curry19(2, (row, names) => match18(row).with({ _tag: "RowEmpty" }, () => true).with({ _tag: "RowVar" }, ({ id }) => _Option_isSome4(_Map_get9(id, names))).with({ _tag: "RowExtend" }, ({ fieldType, rest }) => and12(allVarsIn(fieldType, names), allVarsInRow(rest, names))).exhaustive());
var isConcrete2 = (t) => allVarsIn(t, new Map([]));
var emptyCollTs = _curry19(2, (t, env) => allVarsIn(t, env.vars) ? Some18(tsOf(t, env)) : None18);
var ctorCallTs = _curry19(2, (t, recs) => match18(t).with({ _tag: "TyCon" }, ({ args }) => or9(eq17(length14(args), 0), not11(isConcrete2(t))) ? None18 : Some18(tsOf(t, recsEnv(recs)))).otherwise(() => None18));
...
var genericLambdaParams = _curry19(3, (sc, arity, recs) => {
  const names = genericNames(sc);
  const env = tsEnv(names, recs);
  return eq17(_Map_size2(names), 0) ? None18 : Some18({ generics: `<${_Str_join7(", ", _Map_values2(names))}>`, params: genericParamsFrom(sc.ty, arity, env, 0) });
});
...
var ctorFactoryTs = _curry19(5, (typeName, params, c, aliases, recs) => {
  ...
  return { generics: head, paramTypes: ctorParamTypes(c.fields, params, aliases, recs, 0), ret: `${typeName}${head}`, retMono: eq17(length14(monos), 0) ? typeName : `${typeName}<${_Str_join7(", ", monos)}>` };
});
var paramDeclName = _curry19(2, (p, i) => match18(p).with({ _tag: "LPSpanned" }, ({ param: inner }) => paramDeclName(inner, i)).with({ _tag: "LPName" }, ({ name }) => name).with({ _tag: "LPLabeled" }, () => "$lab").otherwise(() => `_${show8(i)}`));
var compositions = (n) => eq17(n, 0) ? [[]] : compositionsFrom(n, 1);
var compositionsFrom = _curry19(2, (n, k) => k > n ? [] : _Array_concat7(map11(_Array_prepend9(k), compositions(n - k)), compositionsFrom(n, k + 1)));
var sliceGroups = _curry19(4, (params, groups, i, at) => match18(_Array_get15(i, groups)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: g }) => _Array_prepend9(_Array_take3(g, _Array_drop4(at, params)), sliceGroups(params, groups, i + 1, at + g))).exhaustive());
var curriedTail = _curry19(3, (slices, i, acc) => i < 1 ? acc : curriedTail(slices, i - 1, `(${_Str_join7(", ", _Option_unwrapOr10([], _Array_get15(i, slices)))}) => ${acc}`));
var overloadSig = _curry19(4, (head, params, ret, groups) => {
  ...
  return `${head}(${_Str_join7(", ", _Option_unwrapOr10([], _Array_get15(0, slices)))}): ${tail};`;
});
var curriedOverloads = _curry19(3, (head, params, ret) => length14(params) <= 1 ? `${head}(${_Str_join7(", ", params)}) => ${ret}` : `{ ${_Str_join7(" ", map11(overloadSig(head, params, ret), _Array_sortBy((g) => 0 - length14(g), compositions(length14(params)))))} }`);
var curriedFnType = _curry19(2, (params, ret) => length14(params) <= 1 ? `(${_Str_join7(", ", params)}) => ${ret}` : `_Curry<[${_Str_join7(", ", params)}], ${ret}>`);
...
var bindingTsType = _curry19(3, (sc, value, recs) => {
  const names = genericNames(sc);
  const env = tsEnv(names, recs);
  const head = eq17(_Map_size2(names), 0) ? "" : `<${_Str_join7(", ", _Map_values2(names))}>`;
  return match18(value).with({ _tag: "ELambda" }, () => eq17(head, "") ? (([params, ret]) => curriedFnType(params, ret))(flatParamsFrom(sc.ty, value, env, 0, [])) : `${head}${declType(sc.ty, value, env)}`).otherwise(() => tsOf(sc.ty, recsEnv(recs)));
});
...
var declaredTypeNames = _curry19(3, (stmts, i, acc) => match18(_Array_get15(i, stmts)).with({ _tag: "None" }, () => acc).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SType";
}, ({ value: { name } }) => declaredTypeNames(stmts, i + 1, _Set_add7(name, acc))).with({ _tag: "Some" }, () => declaredTypeNames(stmts, i + 1, acc)).exhaustive());
var referencedCons = _curry19(4, (stmts, env, i, acc) => match18(_Array_get15(i, stmts)).with({ _tag: "None" }, () => acc).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SLet";
}, ({ value: { name } }) => referencedCons(stmts, env, i + 1, _Str_startsWith5("$", name) ? acc : match18(_Map_get9(name, env)).with({ _tag: "Some" }, ({ value: sc }) => consInTy(sc.ty, acc)).with({ _tag: "None" }, () => acc).exhaustive())).with({ _tag: "Some" }, () => referencedCons(stmts, env, i + 1, acc)).exhaustive());
var builtinTypeNamesFor = _curry19(4, (declared, wanted, body, i) => match18(_Array_get15(i, builtinTypeDecls)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: bt }) => ((rest) => and12(not11(_Set_has6(bt.name, declared)), or9(_Set_has6(bt.name, wanted), _Str_contains2(bt.name, body))) ? _Array_prepend9(bt.name, rest) : rest)(builtinTypeNamesFor(declared, wanted, body, i + 1))).exhaustive());
var aliasRowOf = _curry19(3, (fields, aliases, i) => match18(_Array_get15(i, fields)).with({ _tag: "None" }, () => RowEmpty).with({ _tag: "Some" }, ({ value: f }) => (([t, _vars, _st]) => RowExtend(f.name, t, f.optional, aliasRowOf(fields, aliases, i + 1)))(typeExprToType(f.fieldType, new Map, mkSt(0), aliases, _Set_fromArray7([])))).exhaustive());
...
var indexAlias = _curry19(4, (key, name, aliases, acc) => match18(_Map_get9(key, aliases)).with({ _tag: "None" }, () => acc).with({ _tag: "Some" }, ({ value: info }) => match18(info.expr).with({ _tag: "Some" }, () => acc).with({ _tag: "None" }, () => or9(not11(eq17(length14(info.params), 0)), eq17(length14(info.fields), 0)) ? acc : match18(aliasShapeKey(info.fields, aliases)).with({ _tag: "Some" }, ({ value: k }) => _Map_set8(k, name, acc)).with({ _tag: "None" }, () => acc).exhaustive()).exhaustive()).exhaustive());
...
var recordAliasIndex = (aliases) => recordAliasIndexFrom(_Array_sort2(_Map_keys7(aliases)), aliases, 0, new Map);
var withoutOwnShape = _curry19(4, (fields, params, aliases, recs) => match18(_Array_get15(0, params)).with({ _tag: "Some" }, () => recs).with({ _tag: "None" }, () => match18(aliasShapeKey(fields, aliases)).with({ _tag: "Some" }, ({ value: k }) => _Map_delete2(k, recs)).with({ _tag: "None" }, () => recs).exhaustive()).exhaustive());
...
var genericLambdasFrom = _curry19(4, (stmts, env, i, acc) => match18(_Array_get15(i, stmts)).with({ _tag: "None" }, () => acc).with((_v) => {
  ...
  const _g = _v;
  return _g._tag === "ELambda" && (({ span: sp }) => not11(_Str_startsWith5("$", name)))(_g);
}, ({ span: sp }) => match18(_Map_get9(name, env)).with({ _tag: "Some" }, ({ value: sc }) => or9(length14(sc.vars) > 0, length14(sc.rvars) > 0) ? _Map_set8(spanKey(sp), sc, acc) : acc).with({ _tag: "None" }, () => acc).exhaustive()).otherwise(() => acc))).with({ _tag: "Some" }, () => genericLambdasFrom(stmts, env, i + 1, acc)).exhaustive());
var scopedSpans = (e) => match18(e).with({ _tag: "ELambda" }, ({ body, span: sp }) => _Array_prepend9(sp, scopedSpans(body))).with({ _tag: "ECall" }, ({ fn, args }) => _Array_concat7(scopedSpans(fn), scopedSpansAt(args, 0))).with({ _tag: "ELetIn" }, ({ value, body }) => _Array_concat7(scopedSpans(value), scopedSpans(body))).with({ _tag: "ELetBind" }, ({ value, body }) => _Array_concat7(scopedSpans(value), scopedSpans(body))).with({ _tag: "EPipe" }, ({ left, right }) => _Array_concat7(scopedSpans(left), scopedSpans(right))).with({ _tag: "EDo" }, ({ exprs }) => scopedSpansAt(exprs, 0)).with({ _tag: "ETernary" }, ({ cond, thenE, elseE }) => _Array_concat7(scopedSpans(cond), _Array_concat7(scopedSpans(thenE), scopedSpans(elseE)))).with({ _tag: "EMatch" }, ({ scrutinee, arms }) => _Array_concat7(scopedSpans(scrutinee), scopedSpansInArms(arms, 0))).with({ _tag: "ERecord" }, ({ fields, spread }) => _Array_concat7(scopedSpansInFields(fields, 0), match18(spread).with({ _tag: "Some" }, ({ value: s }) => scopedSpans(s)).with({ _tag: "None" }, () => []).exhaustive())).with({ _tag: "EField" }, ({ target, name, span: sp }) => ((rest) => and12(eq17(name, "empty"), isRefExpr(target)) ? _Array_prepend9(sp, rest) : rest)(scopedSpans(target))).with({ _tag: "ETuple" }, ({ elements }) => scopedSpansAt(elements, 0)).with({ _tag: "EArr" }, ({ elements, span: sp }) => scopedSpansInSeq(elements, sp)).with({ _tag: "EList" }, ({ elements, span: sp }) => scopedSpansInSeq(elements, sp)).with({ _tag: "ESet" }, ({ elements, span: sp }) => scopedSpansInSeq(elements, sp)).with({ _tag: "EMap" }, ({ entries, span: sp }) => ((inner) => eq17(length14(entries), 0) ? _Array_prepend9(sp, inner) : inner)(scopedSpansInEntries(entries, 0))).with({ _tag: "ELoop" }, ({ params, body }) => _Array_concat7(scopedSpansInLoop(params, 0), scopedSpans(body))).with({ _tag: "ERecur" }, ({ args }) => scopedSpansAt(args, 0)).with({ _tag: "EInterp" }, ({ parts }) => scopedSpansInParts(parts, 0)).otherwise(() => []);
var isRefExpr = (e) => match18(e).with({ _tag: "ERef" }, () => true).otherwise(() => false);
var scopedSpansAt = _curry19(2, (exprs, i) => match18(_Array_get15(i, exprs)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: e }) => _Array_concat7(scopedSpans(e), scopedSpansAt(exprs, i + 1))).exhaustive());
var scopedSpansInArms = _curry19(2, (arms, i) => match18(_Array_get15(i, arms)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: a }) => _Array_concat7(match18(a.guard).with({ _tag: "Some" }, ({ value: g }) => scopedSpans(g)).with({ _tag: "None" }, () => []).exhaustive(), _Array_concat7(scopedSpans(a.body), scopedSpansInArms(arms, i + 1)))).exhaustive());
var scopedSpansInFields = _curry19(2, (fields, i) => match18(_Array_get15(i, fields)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: f }) => _Array_concat7(scopedSpans(f.value), scopedSpansInFields(fields, i + 1))).exhaustive());
var scopedSpansInEntries = _curry19(2, (entries, i) => match18(_Array_get15(i, entries)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: en }) => _Array_concat7(scopedSpans(en.key), _Array_concat7(scopedSpans(en.value), scopedSpansInEntries(entries, i + 1)))).exhaustive());
...
var scopedSpansInLoop = _curry19(2, (params, i) => match18(_Array_get15(i, params)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: p }) => _Array_concat7(scopedSpans(p.init), scopedSpansInLoop(params, i + 1))).exhaustive());
...
var scopedNamesFrom = _curry19(4, (stmts, env, i, acc) => match18(_Array_get15(i, stmts)).with({ _tag: "None" }, () => acc).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SLet";
}, ({ value: { name, value } }) => scopedNamesFrom(stmts, env, i + 1, match18(value).with((_v) => {
  const _g = _v;
  return _g._tag === "ELambda" && not11(_Str_startsWith5("$", name));
}, () => match18(_Map_get9(name, env)).with({ _tag: "Some" }, ({ value: sc }) => or9(length14(sc.vars) > 0, length14(sc.rvars) > 0) ? scopedNamesAt(scopedSpans(value), 0, unionGenericNames([sc]), acc) : acc).with({ _tag: "None" }, () => acc).exhaustive()).otherwise(() => acc))).with({ _tag: "Some" }, () => scopedNamesFrom(stmts, env, i + 1, acc)).exhaustive());
var tsGenOpts = _curry19(5, (stmts, env, types, letParams, aliases) => {
...
var anyOf = _curry19(2, (f, xs) => reduce4(_curry19(2, (acc, x) => or9(acc, f(x))), false, xs));
var hasJsxExpr = (e) => match18(e).with((_v) => {
  const _g = _v;
  return _g._tag === "ECall" && _g.origin._tag === "Some" && _g.origin.value === "jsx";
}, () => true).with({ _tag: "ECall" }, ({ fn, args }) => or9(hasJsxExpr(fn), anyOf(hasJsxExpr, args))).with({ _tag: "ELambda" }, ({ body }) => hasJsxExpr(body)).with({ _tag: "ELetIn" }, ({ value, body }) => or9(hasJsxExpr(value), hasJsxExpr(body))).with({ _tag: "ELetBind" }, ({ value, body }) => or9(hasJsxExpr(value), hasJsxExpr(body))).with({ _tag: "EPipe" }, ({ left, right }) => or9(hasJsxExpr(left), hasJsxExpr(right))).with({ _tag: "EDo" }, ({ exprs }) => anyOf(hasJsxExpr, exprs)).with({ _tag: "ETernary" }, ({ cond, thenE, elseE }) => or9(or9(hasJsxExpr(cond), hasJsxExpr(thenE)), hasJsxExpr(elseE))).with({ _tag: "EMatch" }, ({ scrutinee, arms }) => or9(hasJsxExpr(scrutinee), anyOf((a) => or9(match18(a.guard).with({ _tag: "Some" }, ({ value: g }) => hasJsxExpr(g)).with({ _tag: "None" }, () => false).exhaustive(), hasJsxExpr(a.body)), arms))).with({ _tag: "ERecord" }, ({ fields, spread }) => or9(anyOf((f) => hasJsxExpr(f.value), fields), match18(spread).with({ _tag: "Some" }, ({ value }) => hasJsxExpr(value)).with({ _tag: "None" }, () => false).exhaustive())).with({ _tag: "EField" }, ({ target }) => hasJsxExpr(target)).with({ _tag: "ETuple" }, ({ elements }) => anyOf(hasJsxExpr, elements)).with({ _tag: "EArr" }, ({ elements }) => anyOf((el) => match18(el).with({ _tag: "SEExpr" }, ({ expr: value }) => hasJsxExpr(value)).with({ _tag: "SESpread" }, ({ expr: value }) => hasJsxExpr(value)).exhaustive(), elements)).with({ _tag: "EList" }, ({ elements }) => anyOf((el) => match18(el).with({ _tag: "SEExpr" }, ({ expr: value }) => hasJsxExpr(value)).with({ _tag: "SESpread" }, ({ expr: value }) => hasJsxExpr(value)).exhaustive(), elements)).with({ _tag: "ESet" }, ({ elements }) => anyOf((el) => match18(el).with({ _tag: "SEExpr" }, ({ expr: value }) => hasJsxExpr(value)).with({ _tag: "SESpread" }, ({ expr: value }) => hasJsxExpr(value)).exhaustive(), elements)).with({ _tag: "EMap" }, ({ entries }) => anyOf((entry) => or9(hasJsxExpr(entry.key), hasJsxExpr(entry.value)), entries)).with({ _tag: "ELoop" }, ({ params, body }) => or9(anyOf((p) => hasJsxExpr(p.init), params), hasJsxExpr(body))).with({ _tag: "ERecur" }, ({ args }) => anyOf(hasJsxExpr, args)).with({ _tag: "EInterp" }, ({ parts }) => anyOf((part) => match18(part).with({ _tag: "IPLit" }, () => false).with({ _tag: "IPExpr" }, ({ expr: value }) => hasJsxExpr(value)).exhaustive(), parts)).otherwise(() => false);
...
`, filter5((part) => not11(eq17(part, "")), [_Str_join7(`
`, header), _Str_join7(`
...
`, header)}
${body}`) ? ["_Curry"] : [], builtinTypeNamesFor(declared, wanted, body, 0))))(typeHeader))(eq17(length14(deps), 0) ? "" : `import { ${_Str_join7(", ", _Array_sort2(deps))} } from "${runtimeImport}";`))(filter5((d) => or9(and12(and12(and12(and12(and12(and12(and12(not11(eq17(d, "add")), not11(eq17(d, "sub"))), not11(eq17(d, "mul"))), not11(eq17(d, "div"))), not11(eq17(d, "lt"))), not11(eq17(d, "lte"))), not11(eq17(d, "gt"))), not11(eq17(d, "gte"))), _Str_contains2(d, body)), deps));
});
...
var genericHeadOf = _curry19(2, (ids, names) => eq17(length14(ids), 0) ? "" : `<${_Str_join7(", ", _Map_values2(names))}>`);
...
var externDecl = (e) => {
  ...
  return and12(n >= 1, e.curried) ? `export declare const ${e.imported}: ${curriedHostType(t, n)};` : eq17(n, 0) ? `export declare const ${e.imported}: ${tsOf(t, plainEnv(anyFor(freeIdsIn(t, []))))};` : `export declare const ${e.imported}: ${flatHostType(t, n)};`;
};
var externModuleDts = _curry19(2, (externs, aliases) => {
  const wanted = reduce4(_curry19(2, (acc, e) => consInTy(e.scheme.ty, acc)), _Set_fromArray7([]), externs);
...
import { _Array_append as _Array_append14, _Array_concat as _Array_concat8, _Array_get as _Array_get16, _Array_prepend as _Array_prepend10, _Map_get as _Map_get10, _Map_set as _Map_set9, _curry as _curry20, _tuple as _tuple12 } from "@mochi/compiler/runtime";
import { match as match19 } from "@onrails/pattern";
var def = _curry20(2, (name, span) => ({ name, defStart: span.start, defEnd: span.end, start: span.start, end: span.end, role: "def" }));
var use = _curry20(3, (name, span, env) => match19(_Map_get10(name, env)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: binding }) => [{ name, defStart: binding.start, defEnd: binding.end, start: span.start, end: span.end, role: "use" }]).exhaustive());
var bind = _curry20(3, (name, span, env) => _Map_set9(name, { name, start: span.start, end: span.end }, env));
var bindSpannedNames = _curry20(4, (names, spans, env, i) => match19(_tuple12(_Array_get16(i, names), _Array_get16(i, spans))).with((_v) => {
  const _g = _v;
  return _g[0]._tag === "Some" && _g[1]._tag === "Some";
...
var bindParam2 = _curry20(2, (param, env) => match19(param).with((_v) => {
  const _g = _v;
...
var bindParams = _curry20(3, (params, env, i) => match19(_Array_get16(i, params)).with({ _tag: "None" }, () => ({ env, occurrences: [] })).with({ _tag: "Some" }, ({ value: param }) => ((head) => ((tail) => ({ env: tail.env, occurrences: _Array_concat8(head.occurrences, tail.occurrences) }))(bindParams(params, head.env, i + 1)))(bindParam2(param, env))).exhaustive());
var walkExprs = _curry20(3, (exprs, env, i) => match19(_Array_get16(i, exprs)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: expr }) => _Array_concat8(walkExpr(expr, env), walkExprs(exprs, env, i + 1))).exhaustive());
var walkSeqs = _curry20(3, (elems, env, i) => match19(_Array_get16(i, elems)).with({ _tag: "None" }, () => []).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SEExpr";
...
var walkPattern = _curry20(2, (pat, env) => match19(pat).with({ _tag: "PBind" }, ({ name, span }) => ({ env: bind(name, span, env), occurrences: [def(name, span)] })).with({ _tag: "PAs" }, ({ pat: inner, name, nameSpan }) => ((innerResult) => ({ env: bind(name, nameSpan, innerResult.env), occurrences: _Array_append14(def(name, nameSpan), innerResult.occurrences) }))(walkPattern(inner, env))).with({ _tag: "PTuple" }, ({ elems }) => walkPatterns(elems, env, 0)).with({ _tag: "PRecord" }, ({ fields }) => walkPatFields(fields, env, 0)).with({ _tag: "PCtor" }, ({ args }) => walkPatterns(args, env, 0)).with({ _tag: "PArr" }, ({ elems, rest }) => ((result) => match19(rest).with({ _tag: "None" }, () => result).with({ _tag: "Some" }, ({ value: tail }) => ((tailResult) => ({ env: tailResult.env, occurrences: _Array_concat8(result.occurrences, tailResult.occurrences) }))(walkPattern(tail, result.env))).exhaustive())(walkPatterns(elems, env, 0))).with({ _tag: "PList" }, ({ elems, rest }) => ((result) => match19(rest).with({ _tag: "None" }, () => result).with({ _tag: "Some" }, ({ value: tail }) => ((tailResult) => ({ env: tailResult.env, occurrences: _Array_concat8(result.occurrences, tailResult.occurrences) }))(walkPattern(tail, result.env))).exhaustive())(walkPatterns(elems, env, 0))).with((_v) => {
  const _g = _v;
  return _g._tag === "POr" && _g.alts.length >= 1;
}, ({ alts: [first] }) => walkPattern(first, env)).otherwise(() => ({ env, occurrences: [] })));
var walkPatterns = _curry20(3, (patterns, env, i) => match19(_Array_get16(i, patterns)).with({ _tag: "None" }, () => ({ env, occurrences: [] })).with({ _tag: "Some" }, ({ value: pat }) => ((head) => ((tail) => ({ env: tail.env, occurrences: _Array_concat8(head.occurrences, tail.occurrences) }))(walkPatterns(patterns, head.env, i + 1)))(walkPattern(pat, env))).exhaustive());
var walkPatFields = _curry20(3, (fields, env, i) => match19(_Array_get16(i, fields)).with({ _tag: "None" }, () => ({ env, occurrences: [] })).with({ _tag: "Some" }, ({ value: field }) => ((head) => ((tail) => ({ env: tail.env, occurrences: _Array_concat8(head.occurrences, tail.occurrences) }))(walkPatFields(fields, head.env, i + 1)))(walkPattern(field.pat, env))).exhaustive());
var walkArms = _curry20(3, (arms, env, i) => match19(_Array_get16(i, arms)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: arm }) => ((pat) => ((guard) => _Array_concat8(pat.occurrences, _Array_concat8(guard, _Array_concat8(walkExpr(arm.body, pat.env), walkArms(arms, env, i + 1)))))(match19(arm.guard).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: expr }) => walkExpr(expr, pat.env)).exhaustive()))(walkPattern(arm.pattern, env))).exhaustive());
var walkFields = _curry20(3, (fields, env, i) => match19(_Array_get16(i, fields)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: field }) => _Array_concat8(walkExpr(field.value, env), walkFields(fields, env, i + 1))).exhaustive());
var walkEntries = _curry20(3, (entries, env, i) => match19(_Array_get16(i, entries)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: entry }) => _Array_concat8(walkExpr(entry.key, env), _Array_concat8(walkExpr(entry.value, env), walkEntries(entries, env, i + 1)))).exhaustive());
var walkLoopParams = _curry20(3, (params, env, i) => match19(_Array_get16(i, params)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: param }) => _Array_concat8(walkExpr(param.init, env), walkLoopParams(params, env, i + 1))).exhaustive());
var loopEnv = _curry20(3, (params, env, i) => match19(_Array_get16(i, params)).with({ _tag: "None" }, () => env).with({ _tag: "Some" }, ({ value: param }) => loopEnv(params, bind(param.name, param.nameSpan, env), i + 1)).exhaustive());
var loopDefs = _curry20(2, (params, i) => match19(_Array_get16(i, params)).with({ _tag: "None" }, () => []).with({ _tag: "Some" }, ({ value: param }) => _Array_concat8([def(param.name, param.nameSpan)], loopDefs(params, i + 1))).exhaustive());
var walkExpr = _curry20(2, (expr, env) => match19(expr).with({ _tag: "ERef" }, ({ name, span }) => use(name, span, env)).with({ _tag: "ECall" }, ({ fn, args }) => _Array_concat8(walkExpr(fn, env), walkExprs(args, env, 0))).with({ _tag: "ELambda" }, ({ params, body }) => ((bound) => _Array_concat8(bound.occurrences, walkExpr(body, bound.env)))(bindParams(params, env, 0))).with({ _tag: "ELetIn" }, ({ name, nameSpan, value, body }) => ((recursive) => ((bodyEnv) => recursive ? _Array_concat8([def(name, nameSpan)], _Array_concat8(walkExpr(value, bodyEnv), walkExpr(body, bodyEnv))) : _Array_concat8(walkExpr(value, env), _Array_concat8([def(name, nameSpan)], walkExpr(body, bodyEnv))))(bind(name, nameSpan, env)))(match19(value).with({ _tag: "ELambda" }, () => true).otherwise(() => false))).with({ _tag: "ELetBind" }, ({ value, body }) => _Array_concat8(walkExpr(value, env), walkExpr(body, env))).with({ _tag: "EPipe" }, ({ left, right }) => _Array_concat8(walkExpr(left, env), walkExpr(right, env))).with({ _tag: "EDo" }, ({ exprs }) => walkExprs(exprs, env, 0)).with({ _tag: "ETernary" }, ({ cond, thenE, elseE }) => _Array_concat8(walkExpr(cond, env), _Array_concat8(walkExpr(thenE, env), walkExpr(elseE, env)))).with({ _tag: "EMatch" }, ({ scrutinee, arms }) => _Array_concat8(walkExpr(scrutinee, env), walkArms(arms, env, 0))).with({ _tag: "ERecord" }, ({ fields, spread }) => match19(spread).with({ _tag: "None" }, () => walkFields(fields, env, 0)).with({ _tag: "Some" }, ({ value: base }) => _Array_concat8(walkExpr(base, env), walkFields(fields, env, 0))).exhaustive()).with({ _tag: "EField" }, ({ target }) => walkExpr(target, env)).with({ _tag: "ETuple" }, ({ elements }) => walkExprs(elements, env, 0)).with({ _tag: "EArr" }, ({ elements }) => walkSeqs(elements, env, 0)).with({ _tag: "EList" }, ({ elements }) => walkSeqs(elements, env, 0)).with({ _tag: "ESet" }, ({ elements }) => walkSeqs(elements, env, 0)).with({ _tag: "EMap" }, ({ entries }) => walkEntries(entries, env, 0)).with({ _tag: "ELoop" }, ({ params, body }) => ((scoped) => _Array_concat8(walkLoopParams(params, env, 0), _Array_concat8(loopDefs(params, 0), walkExpr(body, scoped))))(loopEnv(params, env, 0))).with({ _tag: "ERecur" }, ({ args }) => walkExprs(args, env, 0)).with({ _tag: "EInterp" }, ({ parts }) => walkInterp(parts, env, 0)).otherwise(() => []));
var walkInterp = _curry20(3, (parts, env, i) => match19(_Array_get16(i, parts)).with({ _tag: "None" }, () => []).with((_v) => {
  const _g = _v;
...
var topEnv = _curry20(3, (stmts, env, i) => match19(_Array_get16(i, stmts)).with({ _tag: "None" }, () => env).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SLet";
...
var topDefs = _curry20(2, (stmts, i) => match19(_Array_get16(i, stmts)).with({ _tag: "None" }, () => []).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SLet";
...
var walkStmts = _curry20(3, (stmts, env, i) => match19(_Array_get16(i, stmts)).with({ _tag: "None" }, () => []).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SLet";
...
import { _Array_concat as _Array_concat9, _Array_contains as _Array_contains5, _Array_get as _Array_get17, _Array_prepend as _Array_prepend11, _Map_get as _Map_get11, _Map_getOr as _Map_getOr7, _Map_has as _Map_has5, _Map_keys as _Map_keys8, _Map_set as _Map_set10, _Result_map as _Result_map8, _Set_add as _Set_add8, _Set_fromArray as _Set_fromArray8, _Set_has as _Set_has7, _Set_toArray as _Set_toArray4, _Str_contains as _Str_contains3, _Str_endsWith as _Str_endsWith3, _Str_join as _Str_join8, _Str_length as _Str_length6, _Str_slice as _Str_slice4, _Str_startsWith as _Str_startsWith7, _curry as _curry22, eq as eq18, length as length15, map as map13, not as not12, or as or11 } from "@mochi/compiler/runtime";
import { match as match21 } from "@onrails/pattern";

import { Err as Err9, None as None20, _Result_flatMap as _Result_flatMap8, _Result_map as _Result_map7, _Result_mapErr, _Str_get as _Str_get5, _Str_startsWith as _Str_startsWith6, _Str_trim, _curry as _curry21, _tuple as _tuple13, and as and13, map as map12, or as or10 } from "@mochi/compiler/runtime";
...
var openDirective = (src) => {
  ...
  return and13(_Str_startsWith6('"use open"', t), match20(afterBlanks(t, 10)).with({ _tag: "None" }, () => true).with({ _tag: "Some", value: `
` }, () => true).with({ _tag: "Some", value: "r" }, () => true).otherwise(() => false));
};
var openMode = _curry21(2, (src, requested) => or10(requested, openDirective(src)));
var noSuggestions2 = [];
...
var typecheckWith = _curry21(2, (prog, open) => _Result_mapErr((e) => [stampType(e)], _Result_map7((_) => prog, inferProgram(prog, builtins, namespaces, open))));
var frontend = (src) => match20(lex(src)).with({ _tag: "Err" }, ({ error: e }) => Err9([stampStage("lex", e)])).with({ _tag: "Ok" }, ({ value: tokens }) => ((parsed) => match20(parsed.diagnostics).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => _Result_mapErr((es) => map12((e) => stampStage("check", e), es), checkAll(parsed.stmts))).otherwise((ds) => Err9(map12((e) => stampStage("parse", e), ds))))(parseRecovering(tokens, None20))).exhaustive();
var pipelineWith = _curry21(2, (src, open) => _Result_flatMap8((stmts) => typecheckWith(stmts, open), frontend(src)));
var typedProgramWith = _curry21(2, (src, opts) => _Result_flatMap8((stmts) => _Result_mapErr((e) => [stampType(e)], _Result_map7((r) => _tuple13(stmts, r), inferProgramTypes(stmts, builtins, namespaces, openMode(src, opts.open)))), frontend(src)));
...
var compileWith = _curry21(2, (src, opts) => _Result_map7((prog) => codegenWith(prog, new Map, opts.runtime, namespaceRuntime, preludeJsDefs, runtimeDeps, { ...jsGenOpts, docs: opts.docs, moduleExt: opts.moduleExt }), pipelineWith(src, openMode(src, opts.open))));
...
var writtenQualsIn = _curry22(3, (te, local, acc) => match21(te).with({ _tag: "TyName" }, () => acc).with({ _tag: "TyLit" }, () => acc).with({ _tag: "TyArrow" }, ({ from, to }) => writtenQualsIn(to, local, writtenQualsIn(from, local, acc))).with({ _tag: "TyApp" }, ({ args }) => writtenQualsInAll(args, local, acc, 0)).with({ _tag: "TyTuple" }, ({ elems }) => writtenQualsInAll(elems, local, acc, 0)).with({ _tag: "TyList" }, ({ elem }) => writtenQualsIn(elem, local, acc)).with({ _tag: "TyUnion" }, ({ members }) => writtenQualsInAll(members, local, acc, 0)).with({ _tag: "TyQual" }, ({ alias, name, args }) => ((acc1) => writtenQualsInAll(args, local, acc1, 0))(or11(_Set_has7(name, local), _Map_has5(name, acc)) ? acc : _Map_set10(name, `${alias}.${name}`, acc))).exhaustive());
var writtenQualsInAll = _curry22(4, (tes, local, acc, i) => match21(_Array_get17(i, tes)).with({ _tag: "None" }, () => acc).with({ _tag: "Some" }, ({ value: te }) => writtenQualsInAll(tes, local, writtenQualsIn(te, local, acc), i + 1)).exhaustive());
var ctorQualsFrom = _curry22(4, (ctors, local, acc, i) => match21(_Array_get17(i, ctors)).with({ _tag: "None" }, () => acc).with({ _tag: "Some" }, ({ value: c }) => ctorQualsFrom(ctors, local, writtenQualsInAll(map13((f) => f.fieldType, c.fields), local, acc, 0), i + 1)).exhaustive());
var writtenQualsFrom = _curry22(4, (stmts, local, acc, i) => match21(_Array_get17(i, stmts)).with({ _tag: "None" }, () => acc).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SExtern";
}, ({ value: { typeExpr: te } }) => writtenQualsFrom(stmts, local, writtenQualsIn(te, local, acc), i + 1)).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SLet";
}, ({ value: { annot } }) => writtenQualsFrom(stmts, local, match21(annot).with({ _tag: "None" }, () => acc).with({ _tag: "Some" }, ({ value: te }) => writtenQualsIn(te, local, acc)).exhaustive(), i + 1)).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SType";
}, ({ value: { ctors, alias, aliasType } }) => ((acc1) => ((acc2) => ((acc3) => writtenQualsFrom(stmts, local, acc3, i + 1))(match21(aliasType).with({ _tag: "None" }, () => acc2).with({ _tag: "Some" }, ({ value: te }) => writtenQualsIn(te, local, acc2)).exhaustive()))(match21(alias).with({ _tag: "None" }, () => acc1).with({ _tag: "Some" }, ({ value: fields }) => writtenQualsInAll(map13((f) => f.fieldType, fields), local, acc1, 0)).exhaustive()))(ctorQualsFrom(ctors, local, acc, 0))).with({ _tag: "Some" }, () => writtenQualsFrom(stmts, local, acc, i + 1)).exhaustive());
var qualifyRow = _curry22(2, (row, qualify) => match21(row).with({ _tag: "RowEmpty" }, () => RowEmpty).with({ _tag: "RowVar" }, ({ id }) => RowVar(id)).with({ _tag: "RowExtend" }, ({ label, fieldType, optional, rest }) => RowExtend(label, qualifyTy(fieldType, qualify), optional, qualifyRow(rest, qualify))).exhaustive());
var qualifyTy = _curry22(2, (t, qualify) => match21(t).with({ _tag: "TyVar" }, ({ id }) => TyVar(id)).with({ _tag: "TyCon" }, ({ name, args }) => TyCon(_Map_getOr7(name, name, qualify), map13((a) => qualifyTy(a, qualify), args))).with({ _tag: "TyFn" }, ({ from, to }) => TyFn(qualifyTy(from, qualify), qualifyTy(to, qualify))).with({ _tag: "TyRecord" }, ({ row }) => TyRecord(qualifyRow(row, qualify))).with({ _tag: "TySingleton" }, ({ base, value }) => TySingleton(base, value)).with({ _tag: "TyOneOf" }, ({ members }) => TyOneOf(map13((m) => qualifyTy(m, qualify), members))).exhaustive());
var qualifyTe2 = _curry22(2, (te, qualify) => match21(te).with({ _tag: "TyName" }, ({ name, span }) => TyName(_Map_getOr7(name, name, qualify), span)).with({ _tag: "TyArrow" }, ({ from, to, span }) => TyArrow(qualifyTe2(from, qualify), qualifyTe2(to, qualify), span)).with({ _tag: "TyApp" }, ({ ctor, args, span }) => TyApp(_Map_getOr7(ctor, ctor, qualify), map13((a) => qualifyTe2(a, qualify), args), span)).with({ _tag: "TyTuple" }, ({ elems, span }) => TyTuple(map13((e) => qualifyTe2(e, qualify), elems), span)).with({ _tag: "TyList" }, ({ elem, span }) => TyList(qualifyTe2(elem, qualify), span)).with({ _tag: "TyQual" }, ({ alias, name, nameSpan, args, span }) => TyQual(alias, name, nameSpan, map13((a) => qualifyTe2(a, qualify), args), span)).with({ _tag: "TyLit" }, ({ value, span }) => TyLit(value, span)).with({ _tag: "TyUnion" }, ({ members, span }) => TyUnion(map13((m) => qualifyTe2(m, qualify), members), span)).exhaustive());
var qualifyField2 = _curry22(2, (f, qualify) => ({ name: f.name, fieldType: qualifyTe2(f.fieldType, qualify) }));
var qualifyCtor = _curry22(2, (c, qualify) => ({ name: c.name, fields: map13((f) => qualifyField2(f, qualify), c.fields), span: c.span }));
var qualifyAliasField = _curry22(2, (f, qualify) => ({ name: f.name, fieldType: qualifyTe2(f.fieldType, qualify), optional: f.optional }));
var typeDeclsFrom = _curry22(6, (stmts, aliases, recs, qualify, docs, i) => match21(_Array_get17(i, stmts)).with({ _tag: "None" }, () => []).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SType";
...
var mochiDtsSpec = (from) => {
  const bare = _Str_endsWith3(".mochi", from) ? _Str_slice4(0, _Str_length6(from) - 6, from) : from;
  return or11(_Str_startsWith7("./", bare), _Str_startsWith7("../", bare)) ? `${bare}.mochi` : from;
};
var nsTypeImportsFrom = _curry22(4, (stmts, body, seen, i) => match21(_Array_get17(i, stmts)).with({ _tag: "None" }, () => []).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SImportNs";
}, ({ value: { alias, from } }) => or11(_Set_has7(alias.name, seen), not12(_Str_contains3(`${alias.name}.`, body))) ? nsTypeImportsFrom(stmts, body, seen, i + 1) : _Array_prepend11(`import type * as ${alias.name} from "${mochiDtsSpec(from)}";`, nsTypeImportsFrom(stmts, body, _Set_add8(alias.name, seen), i + 1))).with({ _tag: "Some" }, () => nsTypeImportsFrom(stmts, body, seen, i + 1)).exhaustive());
var emitDtsFromTypedWith = _curry22(6, (stmts, env, aliases, qualify, runtimeImport, docs) => {
  const recs = recordAliasIndex(aliases);
  const local = declaredTypeNames(stmts, 0, _Set_fromArray8([]));
...
`;
  ...
  const imports = _Array_concat9(curry, nsTypeImportsFrom(stmts, body, _Set_fromArray8([]), 0));
  return eq18(length15(imports), 0) ? body : `${_Str_join8(`
`, imports)}
${body}`;
});
var addQuals = _curry22(5, (alias, names, local, acc, i) => match21(_Array_get17(i, names)).with({ _tag: "None" }, () => acc).with({ _tag: "Some" }, ({ value: name }) => addQuals(alias, names, local, or11(_Set_has7(name, local), _Map_has5(name, acc)) ? acc : _Map_set10(name, `${alias}.${name}`, acc), i + 1)).exhaustive());
...
var qualifierMapOf = _curry22(2, (quals, local) => qualsFromAliases(_Map_keys8(quals), quals, local, new Map, 0));
...
var emitDtsText = _curry22(2, (src, runtimeImport) => emitDtsTextWith(src, runtimeImport, { open: false, runtime: true, docs: true, moduleExt: ".js", strictEntry: false }));

import { readFileSync, writeFileSync } from "fs";
import { createRequire } from "module";
import { dirname, relative, resolve as resolve2 } from "path";
var Ok12 = (value) => ({ _tag: "Ok", value });
var Err10 = (error) => ({ _tag: "Err", error });
...
var emitDts = _curry23(2, (src, runtimeImport) => emitDtsText(src, runtimeImport));
var symbolOccurrences = (stmts) => index(stmts);
var defaultOpts2 = { open: false, runtime: true, docs: true, moduleExt: ".js", strictEntry: false };
var addCtorOrigins = _curry23(3, (ctors, typeSpan, origins) => reduce5(_curry23(2, (acc, ctor) => _Map_set11(ctor.name, typeSpan, acc)), origins, ctors));
var exportedOriginsFrom = _curry23(3, (stmts, i, origins) => match22(_Array_get18(i, stmts)).with({ _tag: "None" }, () => origins).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SLet" && _g.value.exported === true;
...
var resolveImport2 = _curry23(2, resolveImport);
var mErr = (message) => ({ message, start: 0, end: 0 });
var recoveryScheme = { vars: [0], rvars: [], ty: tVar(0) };
var atPath = _curry23(2, (path, e) => ({ message: `module '${path}': ${e.message}`, start: e.start, end: e.end }));
var parseModule = ($x) => _Result_flatMap9(parse)(lex($x));
var importFromsFrom = _curry23(3, (stmts, i, acc) => match22(_Array_get18(i, stmts)).with({ _tag: "None" }, () => acc).with({ _tag: "Some" }, ({ value: s }) => match22(s).with({ _tag: "SImport" }, ({ from }) => importFromsFrom(stmts, i + 1, _Array_append15(from, acc))).with({ _tag: "SImportNs" }, ({ from }) => importFromsFrom(stmts, i + 1, _Array_append15(from, acc))).otherwise(() => importFromsFrom(stmts, i + 1, acc))).exhaustive());
var importFroms = (stmts) => importFromsFrom(stmts, 0, []);
var visit = _curry23(2, (path, acc) => match22(_Map_get12(path, acc.state)).with({ _tag: "Some", value: "done" }, () => Ok13(acc)).with({ _tag: "Some", value: "loading" }, () => Err11(mErr(`import cycle through '${path}'`))).otherwise(() => ((acc1) => match22(readFile(path)).with({ _tag: "Err" }, () => Err11(mErr(`cannot read module '${path}'`))).with({ _tag: "Ok" }, ({ value: src }) => match22(parseModule(src)).with({ _tag: "Err" }, ({ error: e }) => Err11(e)).with({ _tag: "Ok" }, ({ value: stmts }) => match22(visitAll(importFroms(stmts), path, acc1)).with({ _tag: "Err" }, ({ error: e }) => Err11(e)).with({ _tag: "Ok" }, ({ value: acc2 }) => Ok13({ state: _Map_set11(path, "done", acc2.state), order: _Array_append15({ path, src, stmts }, acc2.order) })).exhaustive()).exhaustive()).exhaustive())({ state: _Map_set11(path, "loading", acc.state), order: acc.order })));
var visitAll = _curry23(3, (froms, importer, acc) => match22(froms).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => Ok13(acc)).with((_v) => {
  const _g = _v;
  return _g.length >= 1;
}, ([from, ...rest]) => match22(visit(resolveImport2(importer, from), acc)).with({ _tag: "Err" }, ({ error: e }) => Err11(e)).with({ _tag: "Ok" }, ({ value: acc1 }) => visitAll(rest, importer, acc1)).exhaustive()).otherwise(() => {
  throw new Error("non-exhaustive match");
}));
var loadGraph = (entry) => _Result_flatMap9((acc) => Ok13(acc.order), visit(absPath(entry), { state: new Map, order: [] }));
var emptyReg = { ctors: new Map, types: new Map };
var mergeInto2 = _curry23(3, (keys, from, into) => match22(keys).with((_v) => _v.length === 0, () => into).with((_v) => _v.length >= 1, ([k, ...rest]) => mergeInto2(rest, from, match22(_Map_get12(k, from)).with({ _tag: "Some" }, ({ value: v }) => _Map_set11(k, v, into)).with({ _tag: "None" }, () => into).exhaustive())).otherwise(() => {
  throw new Error("non-exhaustive match");
}));
var mergeMap = _curry23(2, (from, into) => mergeInto2(_Map_keys9(from), from, into));
var exportedTypeNames = (stmts) => _Set_fromArray9(_Array_flatMap4((s) => match22(s).with({ _tag: "SType", exported: true }, ({ name }) => [name]).otherwise(() => []), stmts));
var aliasesOf = (stmts) => reduce5(_curry23(2, (acc, s) => match22(s).with((_v) => {
  const _g = _v;
  return _g._tag === "SType" && _g.alias._tag === "Some";
}, ({ name, params, alias: { value: fields } }) => _Map_set11(name, { params, fields, expr: None22 }, acc)).with((_v) => {
  const _g = _v;
  return _g._tag === "SType" && _g.aliasType._tag === "Some";
}, ({ name, params, aliasType: { value: te } }) => _Map_set11(name, { params, fields: [], expr: Some22(te) }, acc)).otherwise(() => acc)), new Map, stmts);
var qualScopeOf = (stmts) => ({ types: exportedTypeNames(stmts), aliases: aliasesOf(stmts) });
var withNamedCtor = _curry23(5, (name, info, depReg, depKeys, res) => ({ imports: res.imports, nsImports: res.nsImports, reg: { ctors: _Map_set11(name, info, res.reg.ctors), types: match22(_Map_get12(info.owner, depReg.types)).with({ _tag: "Some" }, ({ value: cs }) => _Map_set11(info.owner, cs, res.reg.types)).with({ _tag: "None" }, () => res.reg.types).exhaustive() }, keys: match22(_Map_get12(name, depKeys)).with({ _tag: "Some" }, ({ value: ks }) => _Map_set11(name, ks, res.keys)).with({ _tag: "None" }, () => res.keys).exhaustive(), quals: res.quals }));
var takeNamedCtor = _curry23(5, (name, span, depReg, depKeys, res) => match22(_Map_get12(name, depReg.ctors)).with({ _tag: "None" }, () => Ok13(res)).with({ _tag: "Some" }, ({ value: info }) => match22(_Map_get12(name, res.reg.ctors)).with({ _tag: "Some" }, ({ value: prior }) => not13(eq19(prior.owner, info.owner)) ? Err11({ message: `duplicate constructor '${name}'`, start: span.start, end: span.end }) : Ok13(withNamedCtor(name, info, depReg, depKeys, res))).with({ _tag: "None" }, () => Ok13(withNamedCtor(name, info, depReg, depKeys, res))).exhaustive()).exhaustive());
var prefixCtorsInto = _curry23(4, (keys, alias, from, into) => match22(keys).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => into).with((_v) => {
  const _g = _v;
  return _g.length >= 1;
}, ([k, ...rest]) => prefixCtorsInto(rest, alias, from, match22(_Map_get12(k, from)).with({ _tag: "Some" }, ({ value: v }) => _Map_set11(`${alias}.${k}`, v, into)).with({ _tag: "None" }, () => into).exhaustive())).otherwise(() => {
  throw new Error("non-exhaustive match");
}));
var resolveNames = _curry23(7, (names, from, depExports, depReg, depKeys, res, recovering) => match22(names).with((_v) => _v.length === 0, () => Ok13(res)).with((_v) => _v.length >= 1, ([n, ...rest]) => match22(_Map_get12(n.name, depExports)).with({ _tag: "None" }, () => recovering ? resolveNames(rest, from, depExports, depReg, depKeys, { imports: _Map_set11(n.name, recoveryScheme, res.imports), nsImports: res.nsImports, reg: res.reg, keys: res.keys, quals: res.quals }, recovering) : Err11({ message: `'${from}' has no export '${n.name}'`, start: n.span.start, end: n.span.end })).with({ _tag: "Some" }, ({ value: sc }) => match22(takeNamedCtor(n.name, n.span, depReg, depKeys, { imports: _Map_set11(n.name, sc, res.imports), nsImports: res.nsImports, reg: res.reg, keys: res.keys, quals: res.quals })).with({ _tag: "Err" }, ({ error: e }) => Err11(e)).with({ _tag: "Ok" }, ({ value: res1 }) => resolveNames(rest, from, depExports, depReg, depKeys, res1, recovering)).exhaustive()).exhaustive()).otherwise(() => {
  throw new Error("non-exhaustive match");
}));
var resolveImportsFrom = _curry23(6, (ctx, stmts, i, path, res, recovering) => match22(_Array_get18(i, stmts)).with({ _tag: "None" }, () => Ok13(res)).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SImport";
}, ({ value: { names, from } }) => ((dp) => ((depExports) => ((depReg) => ((depKeys) => match22(resolveNames(names, from, depExports, depReg, depKeys, res, recovering)).with({ _tag: "Err" }, ({ error: e }) => Err11(e)).with({ _tag: "Ok" }, ({ value: res1 }) => resolveImportsFrom(ctx, stmts, i + 1, path, res1, recovering)).exhaustive())(_Map_getOr8(new Map, dp, ctx.keysByPath)))(_Map_getOr8(emptyReg, dp, ctx.regByPath)))(_Map_getOr8(new Map, dp, ctx.exportsByPath)))(resolveImport2(path, from))).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SImportNs";
}, ({ value: { alias, from } }) => ((dp) => ((depExports) => ((depReg) => ((depKeys) => resolveImportsFrom(ctx, stmts, i + 1, path, { imports: res.imports, nsImports: _Map_set11(alias.name, depExports, res.nsImports), reg: { ctors: prefixCtorsInto(_Map_keys9(depReg.ctors), alias.name, depReg.ctors, res.reg.ctors), types: mergeMap(depReg.types, res.reg.types) }, keys: mergeMap(depKeys, res.keys), quals: match22(_Map_get12(dp, ctx.qualsByPath)).with({ _tag: "Some" }, ({ value: q }) => _Map_set11(alias.name, q, res.quals)).with({ _tag: "None" }, () => res.quals).exhaustive() }, recovering))(_Map_getOr8(new Map, dp, ctx.keysByPath)))(_Map_getOr8(emptyReg, dp, ctx.regByPath)))(_Map_getOr8(new Map, dp, ctx.exportsByPath)))(resolveImport2(path, from))).with({ _tag: "Some" }, () => resolveImportsFrom(ctx, stmts, i + 1, path, res, recovering)).exhaustive());
var openFor = _curry23(3, (loaded, isEntry, opts) => and14(isEntry, opts.strictEntry) ? opts.open : openMode(loaded.src, opts.open));
var compileOne = _curry23(5, (ctx, loaded, recovering, isEntry, opts) => match22(resolveImportsFrom(ctx, loaded.stmts, 0, loaded.path, { imports: new Map, nsImports: new Map, reg: emptyReg, keys: new Map, quals: new Map }, recovering)).with({ _tag: "Err" }, ({ error: e }) => Err11(atPath(loaded.path, e))).with({ _tag: "Ok" }, ({ value: res }) => match22(checkWith(loaded.stmts, res.reg, res.quals)).with({ _tag: "Err" }, ({ error: e }) => Err11(atPath(loaded.path, e))).with({ _tag: "Ok" }, () => match22(inferProgramImports(loaded.stmts, builtins, namespaces, openFor(loaded, isEntry, opts), res.imports, res.nsImports, res.quals, None22)).with({ _tag: "Err" }, ({ error: e }) => Err11(atPath(loaded.path, e))).with({ _tag: "Ok" }, ({ value: env }) => ((js) => Ok13({ exportsByPath: _Map_set11(loaded.path, exportedSchemes(loaded.stmts, env), ctx.exportsByPath), regByPath: _Map_set11(loaded.path, exportedRegistry(loaded.stmts), ctx.regByPath), keysByPath: _Map_set11(loaded.path, exportedCtorKeys(loaded.stmts), ctx.keysByPath), qualsByPath: _Map_set11(loaded.path, qualScopeOf(loaded.stmts), ctx.qualsByPath), outputs: [...ctx.outputs, { path: loaded.path, js }] }))(codegenWith(loaded.stmts, res.keys, opts.runtime, namespaceRuntime, preludeJsDefs, runtimeDeps, { ...jsGenOpts, docs: opts.docs, moduleExt: opts.moduleExt }))).exhaustive()).exhaustive()).exhaustive());
var compileAll = _curry23(3, (ctx, graph, opts) => match22(graph).with((_v) => {
  const _g = _v;
  return _g.length === 0;
}, () => Ok13(ctx.outputs)).with((_v) => {
  const _g = _v;
  return _g.length >= 1;
}, ([m, ...rest]) => match22(compileOne(ctx, m, false, eq19(length16(rest), 0), opts)).with({ _tag: "Err" }, ({ error: e }) => Err11(e)).with({ _tag: "Ok" }, ({ value: ctx1 }) => compileAll(ctx1, rest, opts)).exhaustive()).otherwise(() => {
  throw new Error("non-exhaustive match");
}));
var compileGraphWith = _curry23(2, (graph, opts) => compileAll({ exportsByPath: new Map, regByPath: new Map, keysByPath: new Map, qualsByPath: new Map, outputs: [] }, graph, opts));
var compileGraph = (graph) => compileGraphWith(graph, defaultOpts2);
var depsPublished = _curry23(4, (ctx, stmts, i, path) => match22(_Array_get18(i, stmts)).with({ _tag: "None" }, () => true).with((_v) => {
  const _g = _v;
  return _g._tag === "Some" && _g.value._tag === "SImport";
}, ({ value: { from } }) => and14(_Map_has6(resolveImport2(path, from), ctx.exportsByPath), depsPublished(ctx, stmts, i + 1, path))).with({ _tag: "Some" }, () => depsPublished(ctx, stmts, i + 1, path)).exhaustive());
var checkErrorsRecovering = _curry23(2, (ctx, loaded) => {
  const importErrors = depsPublished(ctx, loaded.stmts, 0, loaded.path) ? match22(resolveImportsFrom(ctx, loaded.stmts, 0, loaded.path, { imports: new Map, nsImports: new Map, reg: emptyReg, keys: new Map, quals: new Map }, false)).with({ _tag: "Err" }, ({ error: e }) => [atPath(loaded.path, e)]).with({ _tag: "Ok" }, () => []).exhaustive() : [];
  return match22(resolveImportsFrom(ctx, loaded.stmts, 0, loaded.path, { imports: new Map, nsImports: new Map, reg: emptyReg, keys: new Map, quals: new Map }, true)).with({ _tag: "Err" }, ({ error: e }) => [atPath(loaded.path, e)]).with({ _tag: "Ok" }, ({ value: res }) => match22(checkAllWith(loaded.stmts, res.reg, res.quals)).with({ _tag: "Err" }, ({ error: es }) => _Array_concat10(importErrors, map14((e) => atPath(loaded.path, e), es))).with({ _tag: "Ok" }, () => importErrors).exhaustive()).exhaustive();
});
var sameErr = _curry23(2, (a, b) => and14(and14(eq19(a.message, b.message), eq19(a.start, b.start)), eq19(a.end, b.end)));
var mergeRecovered = _curry23(2, (e, checks) => length16(filter6((c) => sameErr(c, e), checks)) > 0 ? checks : _Array_concat10(checks, [e]));
var compileAllRecovering = _curry23(4, (ctx, graph, errors, opts) => match22(graph).with((_v) => {
  ...
  const _g = _v;
  return _g.length >= 1;
}, ([m, ...rest]) => match22(compileOne(ctx, m, true, eq19(length16(rest), 0), opts)).with({ _tag: "Err" }, ({ error: e }) => ((checks) => compileAllRecovering(ctx, rest, _Array_concat10(errors, mergeRecovered(e, checks)), opts))(checkErrorsRecovering(ctx, m))).with({ _tag: "Ok" }, ({ value: ctx1 }) => compileAllRecovering(ctx1, rest, errors, opts)).exhaustive()).otherwise(() => {
  throw new Error("non-exhaustive match");
}));
...
var inferOne = _curry23(3, (ctx, loaded, opts) => match22(resolveImportsFrom(ctx, loaded.stmts, 0, loaded.path, { imports: new Map, nsImports: new Map, reg: emptyReg, keys: new Map, quals: new Map }, false)).with({ _tag: "Err" }, ({ error: e }) => Err11(atPath(loaded.path, e))).with({ _tag: "Ok" }, ({ value: res }) => match22(checkWith(loaded.stmts, res.reg, res.quals)).with({ _tag: "Err" }, ({ error: e }) => Err11(atPath(loaded.path, e))).with({ _tag: "Ok" }, () => match22(inferProgramImportsTypes(loaded.stmts, builtins, namespaces, openMode(loaded.src, opts.open), res.imports, res.nsImports, res.quals, None22)).with({ _tag: "Err" }, ({ error: e }) => Err11(atPath(loaded.path, e))).with({ _tag: "Ok" }, ({ value: r }) => Ok13({ exportsByPath: _Map_set11(loaded.path, exportedSchemes(loaded.stmts, r.env), ctx.exportsByPath), regByPath: _Map_set11(loaded.path, exportedRegistry(loaded.stmts), ctx.regByPath), keysByPath: _Map_set11(loaded.path, exportedCtorKeys(loaded.stmts), ctx.keysByPath), qualsByPath: _Map_set11(loaded.path, qualScopeOf(loaded.stmts), ctx.qualsByPath), aliases: mergeMap(r.aliases, ctx.aliases), outputs: [...ctx.outputs, { path: loaded.path, types: map14((hit) => ({ span: hit.span, ty: hit.ty, display: showType(widenLits(hit.ty)) }), r.types), aliases: mergeMap(r.aliases, ctx.aliases) }] })).exhaustive()).exhaustive()).exhaustive());
var inferAll = _curry23(3, (ctx, graph, opts) => match22(graph).with((_v) => _v.length === 0, () => Ok13(ctx)).with((_v) => _v.length >= 1, ([m, ...rest]) => match22(inferOne(ctx, m, opts)).with({ _tag: "Err" }, ({ error: e }) => Err11(e)).with({ _tag: "Ok" }, ({ value: ctx1 }) => inferAll(ctx1, rest, opts)).exhaustive()).otherwise(() => {
  throw new Error("non-exhaustive match");
}));
...
var buildModulesWith = _curry23(2, (entry, opts) => match22(loadGraph(entry)).with({ _tag: "Err" }, ({ error: e }) => Err11([e])).with({ _tag: "Ok" }, ({ value: graph }) => ((recovered) => eq19(length16(recovered.errors), 0) ? _Result_mapErr2((e) => [e], compileGraphWith(graph, opts)) : Err11(recovered.errors))(compileGraphRecoveringWith(graph, opts))).exhaustive());
...
var isIdentChar = (c) => match22(_Str_codeAt8(0, c)).with({ _tag: "None" }, () => false).with({ _tag: "Some" }, ({ value: n }) => or12(or12(or12(or12(and14(n >= 48, n <= 57), and14(n >= 65, n <= 90)), and14(n >= 97, n <= 122)), eq19(n, 95)), eq19(n, 36))).exhaustive();
var endsAtBoundary = (part) => eq19(_Str_length7(part), 0) ? true : not13(isIdentChar(_Option_unwrapOr11("", _Str_get6(_Str_length7(part) - 1, part))));
var startsAtBoundary = (part) => eq19(_Str_length7(part), 0) ? true : not13(isIdentChar(_Option_unwrapOr11("", _Str_get6(0, part))));
var occursAsWordFrom = _curry23(2, (parts, i) => match22(_Array_get18(i, parts)).with({ _tag: "None" }, () => false).with({ _tag: "Some" }, ({ value: after }) => and14(_Option_mapOr(false, endsAtBoundary, _Array_get18(i - 1, parts)), startsAtBoundary(after)) ? true : occursAsWordFrom(parts, i + 1)).exhaustive());
...
var importedBinding = (spec) => {
  ...
  return _Str_trim2(_Option_unwrapOr11(spec, _Array_get18(length16(parts) - 1, parts)));
};
var bindingsInLine = _curry23(2, (line, acc) => match22(_Array_get18(1, _Str_split5("{", line))).with({ _tag: "None" }, () => acc).with({ _tag: "Some" }, ({ value: rest }) => match22(_Array_get18(0, _Str_split5("}", rest))).with({ _tag: "None" }, () => acc).with({ _tag: "Some" }, ({ value: names }) => reduce5(_curry23(2, (a, n) => _Set_add9(importedBinding(n), a)), acc, _Str_split5(",", names))).exhaustive()).exhaustive());
var valueImported = (ts) => reduce5(_curry23(2, (acc, line) => bindingsInLine(line, acc)), _Set_fromArray9([]), filter6(_Str_startsWith8("import {"), _Str_split5(`
`, ts)));
var ownTypesInto = _curry23(3, (stmts, path, acc) => reduce5(_curry23(2, (a, s) => match22(s).with({ _tag: "SType" }, ({ name }) => _Map_set11(name, path, a)).otherwise(() => a)), acc, stmts));
var typeOwnerOf = (graph) => reduce5(_curry23(2, (acc, m) => ownTypesInto(m.stmts, m.path, acc)), new Map, graph);
var localTypeNames = (stmts) => _Set_fromArray9(_Array_flatMap4((s) => match22(s).with({ _tag: "SType" }, ({ name }) => [name]).otherwise(() => []), stmts));
var groupByOwner = _curry23(2, (names, ctx) => reduce5(_curry23(2, (acc, name) => {
  const owner = _Map_getOr8("", name, ctx.typeOwner);
  return or12(or12(or12(eq19(owner, ctx.importer), _Set_has8(name, ctx.localTypes)), _Set_has8(name, ctx.bound)), not13(occursAsWord(name, ctx.ts))) ? acc : ((spec) => _Map_set11(spec, _Array_append15(name, _Map_getOr8([], spec, acc)), acc))(relSpec2(ctx.importer, owner));
}), new Map, names));
var crossModuleTypeImports = _curry23(4, (ts, importer, localTypes, typeOwner) => {
  const byOwner = groupByOwner(_Map_keys9(typeOwner), { ts, importer, localTypes, typeOwner, bound: valueImported(ts) });
  return map14((spec) => `import type { ${_Str_join9(", ", _Array_sort3(_Map_getOr8([], spec, byOwner)))} } from "${spec}";`, _Map_keys9(byOwner));
});
var externBindingsInto = _curry23(4, (stmts, path, env, acc) => reduce5(_curry23(2, (a, s) => match22(s).with({ _tag: "SExtern" }, ({ name, module: hostModule, imported, curried }) => _Str_startsWith8("mochi:", hostModule) ? a : match22(_Map_get12(name, env)).with({ _tag: "None" }, () => a).with({ _tag: "Some" }, ({ value: sc }) => ((dp) => _Map_set11(dp, _Array_append15({ imported, scheme: sc, curried }, _Map_getOr8([], dp, a)), a))(externDtsPath2(path, hostModule))).exhaustive()).otherwise(() => a)), acc, stmts));
var compileOneTs = _curry23(3, (ctx, loaded, opts) => match22(resolveImportsFrom(ctx, loaded.stmts, 0, loaded.path, { imports: new Map, nsImports: new Map, reg: emptyReg, keys: new Map, quals: new Map }, false)).with({ _tag: "Err" }, ({ error: e }) => Err11(atPath(loaded.path, e))).with({ _tag: "Ok" }, ({ value: res }) => match22(checkWith(loaded.stmts, res.reg, res.quals)).with({ _tag: "Err" }, ({ error: e }) => Err11(atPath(loaded.path, e))).with({ _tag: "Ok" }, () => match22(inferProgramImportsTypes(loaded.stmts, builtins, namespaces, openMode(loaded.src, opts.open), res.imports, res.nsImports, res.quals, None22)).with({ _tag: "Err" }, ({ error: e }) => Err11(atPath(loaded.path, e))).with({ _tag: "Ok" }, ({ value: r }) => ((body) => ((lines) => ((ts) => Ok13({ exportsByPath: _Map_set11(loaded.path, exportedSchemes(loaded.stmts, r.env), ctx.exportsByPath), regByPath: _Map_set11(loaded.path, exportedRegistry(loaded.stmts), ctx.regByPath), keysByPath: _Map_set11(loaded.path, exportedCtorKeys(loaded.stmts), ctx.keysByPath), qualsByPath: _Map_set11(loaded.path, qualScopeOf(loaded.stmts), ctx.qualsByPath), aliases: mergeMap(r.aliases, ctx.aliases), typeOwner: ctx.typeOwner, runtimeImport: ctx.runtimeImport, externs: externBindingsInto(loaded.stmts, loaded.path, r.env, ctx.externs), outputs: [...ctx.outputs, { path: loaded.path, js: ts }] }))(eq19(length16(lines), 0) ? body : `${_Str_join9(`
`, lines)}
...
var externOutputs = (externs) => map14((dp) => ({ path: dp, js: externModuleDts(_Map_getOr8([], dp, externs), noAliases) }), _Map_keys9(externs));
var compileAllTs = _curry23(3, (ctx, graph, opts) => match22(graph).with((_v) => _v.length === 0, () => Ok13(_Array_concat10(ctx.outputs, externOutputs(ctx.externs)))).with((_v) => _v.length >= 1, ([m, ...rest]) => match22(compileOneTs(ctx, m, opts)).with({ _tag: "Err" }, ({ error: e }) => Err11(e)).with({ _tag: "Ok" }, ({ value: ctx1 }) => compileAllTs(ctx1, rest, opts)).exhaustive()).otherwise(() => {
  throw new Error("non-exhaustive match");
}));
var compileGraphTsWith = _curry23(3, (graph, runtimeImport, opts) => compileAllTs({ exportsByPath: new Map, regByPath: new Map, keysByPath: new Map, qualsByPath: new Map, aliases: new Map, typeOwner: typeOwnerOf(graph), runtimeImport, externs: new Map, outputs: [] }, graph, opts));
...
var emitDtsForFileWith = _curry23(3, (entry, runtimeImport, opts) => _Result_flatMap9((graph) => dtsAll({ exportsByPath: new Map, regByPath: new Map, keysByPath: new Map, qualsByPath: new Map, aliases: new Map, runtimeImport, target: absPath(entry), dts: "" }, graph, opts), loadGraph(entry)));
var emitDtsForFile = _curry23(2, (entry, runtimeImport) => emitDtsForFileWith(entry, runtimeImport, defaultOpts2));
var buildModulesTsWith = _curry23(3, (entry, runtimeImport, opts) => match22(loadGraph(entry)).with({ _tag: "Err" }, ({ error: e }) => Err11([e])).with({ _tag: "Ok" }, ({ value: graph }) => ((recovered) => eq19(length16(recovered.errors), 0) ? _Result_mapErr2((e) => [e], compileGraphTsWith(graph, runtimeImport, opts)) : Err11(recovered.errors))(compileGraphRecoveringWith(graph, { ...opts, strictEntry: false }))).exhaustive());
var buildModulesTs = _curry23(2, (entry, runtimeImport) => buildModulesTsWith(entry, runtimeImport, defaultOpts2));
export {
  buildModules,
  buildModulesTs,
  buildModulesTsWith,
