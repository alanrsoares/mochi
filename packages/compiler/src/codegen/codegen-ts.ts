 ...
 * (`prelude/runtime.ts`, hand-written source of truth — ADR 0075) instead of inlined — so
...
import type { AliasDef } from "../ast/types";
...
import type { BindingTypeHook } from "../extensions/extensions";
