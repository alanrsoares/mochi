...
import { ctorTableOf, keysOf } from "../ast/ctors";
import type { Span } from "../ast/span";
import { namespaceRuntime, preludeJsDefs, runtimeDeps } from "../prelude/prelude";
 ...
 */
const loopNeedsStep = (e: Expr): boolean => {
  switch (e.kind) {
    case "ternary":
...
const genLoopBlock = (l: LoopExpr, ctx: GenCtx): string => {
