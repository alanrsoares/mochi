...
| # | Title | Ticket | Type | Blocked by | Status |
|---|---|---|---|---|---|
| 3 | Type-name imports — qualified `TypeExpr` (`Alias.T`) parser → infer → dts/hover, TS + bootstrap parity | [C5](tickets/c05-type-name-imports.md) | AFK | — | parse+format done (ADR 0046) |
