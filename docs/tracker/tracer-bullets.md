...
|---|---|---|---|---|---|
| 0 | Parser error recovery — slices a–f (ADR → parser multi-error → no-cascade check/infer → formatter passthrough → LSP → bootstrap parity) | [C9](tickets/c09-parser-error-recovery.md) | HITL→AFK | — | done (ADR 0045, a–f) |
